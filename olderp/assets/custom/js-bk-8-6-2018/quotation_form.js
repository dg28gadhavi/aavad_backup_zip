...
function pa_billaddrs_call(id,type,suffix,encid)
{
   ...
   $.ajax({
      url: base_url+'Ajax_add_more_quotation_quotation/party_billaddr_more/'+id+''+urlprms,
      cache: false,
      type: "POST",
...
function pa_shipaddrs_call(id,type,suffix,encid)
{
   ...
   $.ajax({
      url: base_url+'Ajax_add_more_quotation/party_shipaddr_more/'+id+''+urlprms,
      cache: false,
      type: "POST",
      data: {'mtype' : type,'id' : 1 , 'suffix' : suffix , 'inqid' : encid},
      dataType: "json",
...
function pa_contact_add(id,type,suffix,encid)
{
   ...
   $.ajax({
      url: base_url+'Ajax_add_more_quotation/party_contact_add_more/'+id+''+urlprms,
      cache: false,
      type: "POST",
      data: {'mtype' : type,'id' : 1 , 'suffix' : suffix , 'inqid' : encid},
      dataType: "json",
        ...
        $(document).on('change', '.country', function() {
          if($(this).attr('id') != '' && $(this).attr('id') != undefined)
          {
            ...
            $.ajax({
                        type:'POST',
                        datatype: 'HTML',
                        url:base_url+"Ajax_add_more_quotation/get_state",
        ...
        $(document).on('change', '.state', function() {
          if($(this).attr('id') != '' && $(this).attr('id') != undefined)
          {
            ...
            $.ajax({
                        type:'POST',
                        datatype: 'HTML',
                        url:base_url+"Ajax_add_more_quotation/get_city",
        ...
        $(document).on('change', '.city', function() {
          if($(this).attr('id') != '' && $(this).attr('id') != undefined)
          {
            ...
            $.ajax({
                        type:'POST',
                        datatype: 'HTML',
                        url:base_url+"Ajax_add_more_quotation/get_area",
        ...
        $(document).on('change', '.area', function() {
          if($(this).attr('id') != '' && $(this).attr('id') != undefined)
          {
            ...
            $.ajax({
                        type:'POST',
                        datatype: 'HTML',
                        url:base_url+"Ajax_add_more_quotation/get_pincode",
...
function fu_call(id,type,suffix,encid)
{
   ...
   $.ajax({
      url: base_url+'Ajax_add_more_quotation/sales_enq_add_more/'+id+''+urlprms,
      cache: false,
      type: "POST",
...
function quot_call(id,type,suffix,encid)
{
   ...
   $.ajax({
      url: base_url+'Ajax_add_more_quotation/sales_quote_add_more/'+id+''+urlprms,
      cache: false,
      type: "POST",
