			...
			$.ajax({
		      ...
		      success:function(result, textStatus, jqXHR){
					...
					$.each(result, function(key,value) {
 					 ...
 					 i++;
 					 $("#event_box").append('<hr/>');
 					 $("#event_box").append('<h4>Task '+i+'</h4>');
 					 $("#event_box").append('<hr/>');
 					 $("#event_box").append('<div class="row">');
 					 $("#event_box").append('<div class="col-md-12">');
 					 	$("#event_box").append('<label class="col-md-5 text-left"><b>Start Date:</b></label>');
 					 	$("#event_box").append('<label class="col-md-7 text-left">'+value.wt_startdate+'</label>');
 					 $("#event_box").append('</div>');
 					 $("#event_box").append('<div class="col-md-12">');
 					 	$("#event_box").append('<label class="col-md-5 text-left"><b>End Date:</b></label>');
 					 	$("#event_box").append('<label class="col-md-7 text-left">'+value.wt_enddate+'</label>');
 					 $("#event_box").append('</div>');
 					 $("#event_box").append('<div class="col-md-12">');
 					 	$("#event_box").append('<label class="col-md-5 text-left"><b>Assign To:</b></label>');
 					 	$("#event_box").append('<label class="col-md-7 text-left">'+value.wt_assignto+'</label>');
 					 $("#event_box").append('</div>');
 					 $("#event_box").append('<div class="col-md-12">');
 					 	$("#event_box").append('<label class="col-md-5 text-left"><b>Assign By:</b></label>');
 					 	$("#event_box").append('<label class="col-md-7 text-left">'+value.wt_assignby+'</label>');
 					 $("#event_box").append('</div>');
 					 $("#event_box").append('<div class="col-md-12">');
 					 	$("#event_box").append('<label class="col-md-5 text-left"><b>Priority:</b></label>');
 					 	$("#event_box").append('<label class="col-md-7 text-left">'+value.wt_priority+'</label>');
 					 $("#event_box").append('</div>');
 					 $("#event_box").append('<div class="col-md-12">');
 					 	$("#event_box").append('<label class="col-md-5 text-left"><b>Task Type:</b></label>');
 					 	$("#event_box").append('<label class="col-md-7 text-left">'+value.wt_task_type+'</label>');
 					 $("#event_box").append('</div>');
 					 $("#event_box").append('<div class="col-md-12">');
 					 	$("#event_box").append('<label class="col-md-5 text-left"><b>Place:</b></label>');
 					 	$("#event_box").append('<label class="col-md-7 text-left">'+value.wt_task_type+'</label>');
 					 $("#event_box").append('</div>');
 					 $("#event_box").append('<div class="col-md-12">');
 					 	$("#event_box").append('<label class="col-md-5 text-left"><b>Accomplished By Date:</b></label>');
 					 	$("#event_box").append('<label class="col-md-7 text-left">'+value.wt_acc_date+'</label>');
 					 $("#event_box").append('</div>');
 					 $("#event_box").append('<div class="col-md-12">');
 					 	$("#event_box").append('<label class="col-md-5 text-left"><b>Customer Name:</b></label>');
 					 	$("#event_box").append('<label class="col-md-7 text-left">'+value.wt_customer+'</label>');
 					 $("#event_box").append('</div>');
 					 $("#event_box").append('<div class="col-md-12">');
 					 	$("#event_box").append('<label class="col-md-5 text-left"><b>Task Description:</b></label>');
 					 	$("#event_box").append('<label class="col-md-7 text-left">'+value.wt_description+'</label>');
 					 $("#event_box").append('</div>');
 					 $("#event_box").append('<div class="col-md-12">');
 					 	$("#event_box").append('<label class="col-md-5 text-left"><b>Remark:</b></label>');
 					 	$("#event_box").append('<label class="col-md-7 text-left">'+value.wt_remark+'</label>');
 					 $("#event_box").append('</div>');
 					 $("#event_box").append('<div class="col-md-12">');
 					 	$("#event_box").append('<label class="col-md-5 text-left"><b>Expense:</b></label>');
 					 	$("#event_box").append('<label class="col-md-7 text-left">'+value.wt_expense+'</label>');
 					 $("#event_box").append('</div>');
 					 $("#event_box").append('<div class="col-md-12">');
 					 	$("#event_box").append('<label class="col-md-5 text-left"><b>Followup Date:</b></label>');
 					 	$("#event_box").append('<label class="col-md-7 text-left">'+value.wt_follow_date+'</label>');
 					 $("#event_box").append('</div>');
 					 $("#event_box").append('<div class="col-md-12">');
 					 	$("#event_box").append('<label class="col-md-5 text-left"><b>Completed:</b></label>');
 					 	$("#event_box").append('<label class="col-md-7 text-left">'+value.wt_completed+'</label>');
 					 $("#event_box").append('</div>');
 					 $("#event_box").append('</div>');
					}); 
					//console.log(result);
...
//$('#calendar').fullCalendar.formatDate(event.start, "Y-MM-DD HH:mm:ss");
	...
	function doSubmit() {
	    ...
	    var wt_acc_date = moment.utc($('#wt_acc_date').val()).format('YYYY-MM-DD');
	    var wt_city = $('#wt_city').val();
	    var wt_remark = $('#wt_remark').val();
	    var wt_follow_date = moment.utc($('#wt_follow_date').val()).format('YYYY-MM-DD');
		...
		$.post(base_url+"Calendar/check_updation", {
			...
			function(result) {
				...
				if (assinged_flag == 1) {
					...
					moment.utc($('#wt_assigndate').val(objh.wt_assigndate)).format('YYYY-MM-DD');
				    ...
				    moment.utc($('#wt_acc_date').val(objh.wt_acc_date)).format('YYYY-MM-DD');
				    $('#wt_city').val(objh.wt_city);
				    $('#wt_remark').val(objh.wt_remark);
				    moment.utc($('#wt_follow_date').val(objh.wt_follow_date)).format('YYYY-MM-DD');
