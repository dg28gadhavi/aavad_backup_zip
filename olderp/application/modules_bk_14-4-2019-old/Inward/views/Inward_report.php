...
<?php //echo '<pre>'; print_r($report_result['totaldata']); die;?>
...
<!-- BEGIN BREADCRUMBS -->
            <div class="breadcrumbs bread-title">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="<?php echo base_url(); ?>Inward/Inward_report">Inward Report</a></li>
                    <li><a href="<?php echo base_url(); ?>Inward/add">Inward Add</a></li>
                </ol>
...
<div class="page-content-container">
        <!-- BEGIN CONTENT -->
         <?php echo form_open(base_url().'Inward/Inward_report', array('method'=>'get','class' => 'form-horizontal')); ?>
</div>
<!-- END BREADCRUMBS -->
    <!-- BEGIN CONTENT -->
      <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat blue">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc">No of Inward</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat blue">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc">No of Item in Inward</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat purple">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc">Total No of stock inward </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                            ...
                                            <thead>
                                                <tr role="row" class="heading">
                                                    <th width="5%"> No.</th>
                                                    <th width="2%"> Vendor Name</th>
                                                    <th width="2%"> Transporter Name </th>
                                                ...
                                                <tr role="row" class="filter">
                                                    <td>
                                                    <input type="text" class="form-control form-filter input-sm" name="inw_no"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="inw_suppiler"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="inw_transport_name"> </td>
                                                     <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="inw_remark"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="inw_billno"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="inw_billdate"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="inw_billdate"> </td>
                                                    <td>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/inward_report.js" type="text/javascript"></script>
