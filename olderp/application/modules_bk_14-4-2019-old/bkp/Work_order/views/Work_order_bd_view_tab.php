                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                             <div class="col-md-2">
                                                                 <input type="text" tabindex="25" class="form-control" placeholder="Chargeble Title" name="charge[<?php echo $i; ?>][title]" maxlength="200" value="<?php echo isset($value->title) ? $value->title : ''; ?>">
                                                            </div>     
                                                            <div class="col-md-2">
                                                                 <input type="text" tabindex="26" class="form-control" placeholder="Taxable Amount" name="charge[<?php echo $i; ?>][amount]" maxlength="200" value="<?php echo isset($value->amount) ? $value->amount : ''; ?>">
                                                            </div>
                                                             <div class="col-md-2">
                                                                 <input type="text" tabindex="27" class="form-control" placeholder="GST %" name="charge[<?php echo $i; ?>][gst]" maxlength="200" value="<?php echo isset($value->gst) ? $value->gst : ''; ?>">
                                                            </div>
                                                            <div class="col-md-2">
                                                                 <input type="text" tabindex="28" class="form-control" placeholder="Tax Amt" name="charge[<?php echo $i; ?>][taxamt]" maxlength="200" value="<?php echo isset($value->taxamt) ? $value->taxamt : ''; ?>">
                                                            </div>
                                                            <div class="col-md-2">
                                                                 <input type="text" tabindex="29" class="form-control" placeholder="grandtotal" name="charge[<?php echo $i; ?>][ftotal]" maxlength="200" value="<?php echo isset($value->ftotal) ? $value->ftotal : ''; ?>">
                                                            </div>                                                           
                                                        </div>
                                                    </div>
...
<div class="modal-footer pull-left">
  <input type="submit" class="btn btn-success btn-space" name="submit" value="Save" tabindex="30" />
</div>
<?php echo form_close(); ?> 