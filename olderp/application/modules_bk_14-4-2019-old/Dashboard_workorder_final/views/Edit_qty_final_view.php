...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        <h1>Edit Workorder Qty</h1>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="#">Edit Workorder Qty</a>
                            </li>
                        </ol>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3"><h3>Original Qty</h3></label>
                                            <label class="control-label col-md-2 text-right"><h3><?php echo $items['woi_qty']; ?></h3></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Approve Qty</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="Approve Qty" name="approve_qty" maxlength="200" id="approve_qty" value="<?php echo isset($items['woi_qty']) ? $items['woi_qty'] : ""; ?>" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
