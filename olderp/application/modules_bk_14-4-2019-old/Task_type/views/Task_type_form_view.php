                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Task_type Name" name="task_name" maxlength="200" id="task_name" value="<?php echo isset($list[0]['task_name']) ? $list[0]['task_name'] : ""; ?>" >
                                            </div>
                                        </div>
                                    </div>
                                    </div>
