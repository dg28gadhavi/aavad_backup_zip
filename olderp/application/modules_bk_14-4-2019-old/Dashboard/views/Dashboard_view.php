                         ...
                         <div class="portlet light bordered">
                                ...
                                <div class="portlet-title tabbable-line">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green-sharp bold uppercase"> Task Reminder(TASK TO DO) </span>
                                    </div>
                                </div>
                            </div>
                                                    ...
                                                    <div class="portlet-body">
                                                                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><?php echo $row['attand_fname']. ' '.$row['attand_lname'] ;?></td>
                                                                            <td><?php echo $row['support_fname']. ' '.$row['support_lname'];?></td>
                                                                            <td><?php echo $row['task_due_date'];?></td>                                      
                                                                            <td><a class="btn btn-sm btn-outline green" href="<?php echo base_url()."Task/edit/".encrypt_decrypt('encrypt',$row['task_id']); ?>" target="_blank" title="Click To here to Update Reminder"><i class="fa fa-check" ></i></a>  
                                                                            </td>
                                                                        </tr>
                                                                               <?php } ?>
                                                                            </tbody>
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="portlet light bordered">
                                ...
                                <div class="portlet-title tabbable-line">
                                    <div class="caption">
                                        <i class="icon-globe font-green-sharp"></i>
                                        <span class="caption-subject font-green-sharp bold uppercase"> Task Reminder(TASK DONE) </span>
                                    </div>
                                </div>
                            </div>
                                <div class="portlet-body">
