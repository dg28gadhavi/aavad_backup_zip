...
<!-- BEGIN BREADCRUMBS -->
        <div class="breadcrumbs">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="<?php echo base_url(); ?>City">City List</a></li>
                <li><a href="<?php echo base_url(); ?>City/add">City Add</a></li>
            </ol>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/city.js" type="text/javascript"></script>
