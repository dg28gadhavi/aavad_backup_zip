                                                        ...
                                                        <li>
                                                            <div class="col1">
                                                                <div class="cont">
                                                                    ...
                                                                    <div class="cont-col2">
                                                                        <div class="desc" style="text-transformation:uppercase; font-weight:bold;"> <?php echo ''.$sub['status'].' - Total : '.$sub['count'].'<a href="'.base_url().'Sale_quotation/sales_qoute_report?status='.$sub['status'].'&inq_start_date='.$_SESSION['start_date'].'&inq_end_date='.$_SESSION['end_date'].'" class="btn" target="_blank"> View Record File</a>'; ?></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col2">
                                                        ...
                                                        <li>
                                                            <div class="col1">
                                                                <div class="cont">
                                                                    ...
                                                                    <div class="cont-col2">
                                                                        <div class="desc" style="text-transformation:uppercase; font-weight:bold;"> <?php echo ''.$sub['name'].' - Total : '.$sub['count'].'<a href="'.base_url().'Sale_quotation/sales_qoute_report?sq_brand='.$sub['status'].'&inq_start_date='.$_SESSION['start_date'].'&inq_end_date='.$_SESSION['end_date'].'" class="btn" target="_blank"> View Record File</a>'; ?></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col2">
                                                ...
                                                <li>
                                                    <div class="col1">
                                                        <div class="cont">
                                                            ...
                                                            <div class="cont-col2">
                                                                <div class="desc" style="text-transformation:uppercase; font-weight:bold;"> <?php echo ''.$sub['name'].' - Total : '.$sub['count'].'<a href="'.base_url().'Sale_quotation/sales_qoute_report?sq_source_cat='.$sub['status'].'&inq_start_date='.$_SESSION['start_date'].'&inq_end_date='.$_SESSION['end_date'].'" class="btn" target="_blank"> View Record File</a>'; ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col2">
                                                ...
                                                <li>
                                                    <div class="col1">
                                                        <div class="cont">
                                                            ...
                                                            <div class="cont-col2">
                                                                <div class="desc" style="text-transformation:uppercase; font-weight:bold;"> <?php echo ''.$sub['name'].' - Total : '.$sub['count'].'<a href="'.base_url().'Sale_quotation/sales_qoute_report?sq_subsource_cat='.$sub['status'].'&inq_start_date='.$_SESSION['start_date'].'&inq_end_date='.$_SESSION['end_date'].'" class="btn" target="_blank"> View Record File</a>'; ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col2">
                                                ...
                                                <li>
                                                    <div class="col1">
                                                        <div class="cont">
                                                            ...
                                                            <div class="cont-col2">
                                                                <div class="desc" style="text-transformation:uppercase; font-weight:bold;"> <?php echo ''.$sub['fname'].' - Total : '.$sub['count'].'<a href="'.base_url().'Sale_quotation/sales_qoute_report?sq_end_st='.$sub['status'].'&inq_start_date='.$_SESSION['start_date'].'&inq_end_date='.$_SESSION['end_date'].'" class="btn" target="_blank"> View Record File</a>'; ?></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col2">
