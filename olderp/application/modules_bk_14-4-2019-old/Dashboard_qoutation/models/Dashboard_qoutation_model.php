...
// ahi sudhi kryu 6e **********************
        $this->db->select('SUM(sai_itm_price) as count');
...
/****************************************************************/
        ...
        /***********************************************************/
        //echo "<pre>"; print_r($query->result_array()); die;
        $this->db->select('sab_brand as status,brand_name as name,count((sab_brand)) as count');
        $this->db->from('tbl_sale_quotation');
...
/****************************************************************/
        ...
        /***********************************************************/
        //echo "<pre>"; print_r($query->result_array()); die;
        $this->db->select('source_cat_name as name,sa_source_cat as status,count((sa_source_cat)) as count');
        $this->db->from('tbl_sale_quotation');
       ...
       $this->db->where('sa_source_cat', 0);
        ...
        /***********************************************************/
        //echo "<pre>"; print_r($query->result_array()); die;
        $this->db->select('source_cat_name as name,sa_subsource_cat as status,count((sa_subsource_cat)) as count');
        $this->db->from('tbl_sale_quotation');
...
/****************************************************************/
        ...
        /***********************************************************/
        //echo "<pre>"; print_r($query->result_array()); die;
        $this->db->select('au_fname as fname,au_lname as lname,sa_inq_by as  status,count((sa_inq_by)) as count');
        $this->db->from('tbl_sale_quotation');
