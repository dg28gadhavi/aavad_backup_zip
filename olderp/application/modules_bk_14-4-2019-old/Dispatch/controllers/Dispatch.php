...
class Dispatch extends CI_Controller {
	...
	public function ajax_salesinq_report()
	{
		...
		if($right_status == false)
		{
			...
			$viewpdfstr = '<a title="View PDF" href="'.base_url().'pdf/enq/enq'.$idenc.'.pdf" class="btn btn-sm btn-outline blue"><i class="fa fa-eye"></i></a>';
		}
		if($right_status == false )
		{
			$emailsend = '';
	...
	public function mail()
	{
		...
		if(isset($lists['inv']['au_gmail_email']) && ($lists['inv']['au_gmail_email'] != ''))
		{
			$this->email->cc($lists['inv']['au_gmail_email'].','.$mailerdata['au_pre_cc'].','."sales@miconindia.com".','."sales1@miconindia.com".','."inst@miconindia.com".','."automation@miconindia.com".','."sales3@miconindia.com".','."comm@miconindia.com".','."parag@miconindia.com".','."niket@miconindia.com");// change it to yours
		}
		$message=$this->load->view('dispatch_email_form_view',$lists,true);
		//echo $lists['inv']['dis_no'];die;
		$this->email->subject("Micon Dispatch Detail : #".$lists['inv']['dis_no']);
