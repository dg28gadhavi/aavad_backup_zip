...
class Dashboard_workorder extends CI_Controller {

	 function __construct() {
            parent::__construct();
            $this->load->model('Dashboard_workorder_model');
	...
	public function index()
	{
		...
		$data['action_ds'] = "Dashboard_workorder/".$this->uri->segment(3);
		$data['workorder_stats'] = $this->Dashboard_workorder_model->get_workorder_data();
		$data['main_content'] = 'Dashboard_workorder_view';
