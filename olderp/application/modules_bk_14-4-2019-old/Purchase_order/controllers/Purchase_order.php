...
class Purchase_order extends CI_Controller {
	...
	public function ajax_salesinq_report()
	{
		...
		if($right_status == false)
		{
			...
			$viewpdfstr = '<a title="View PDF" href="'.base_url().'pdf/po/po'.$idenc.'.pdf" class="btn btn-sm btn-outline blue" target="_blank"><i class="fa fa-eye"></i></a>';
		}
		if($right_status == false)
		{
			$complet_po = '';
		...
		$records["data"][] = array(
				...
				''.$complet,
				//''.$user[$i]['sq_ref_by'],
			  ''.$editstr.''.$deletestr.''.$viewpdfstr.''.$complet_po,
		);
		}
...
//echo '<pre>';print_r($finalar);die;
	...
	public function mail()
	{
		...
		$this->email->to($lists[0]['master_party_email_address']);// change it to yours
		$this->email->cc($mailerdata['au_gmail_email'].','."parag@miconindia.com".','."niket@miconindia.com");// change it to yours
		$this->email->subject("Micon Purchase Order Detail : #".$lists[0]['po_no']);
