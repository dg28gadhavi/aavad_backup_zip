    ...
    <table style="width: 18cm; border-collapse:collapse;background: #f8f8f8;" autosize="0">                 
                   ...
                   <?php  $itm_discount = 0;
                    ...
                    <tr>
                        ...
                        <td valign="top" style="border-left: 1px solid #e41f26;border-bottom:1px solid #e41f26;font-size:12px; float:left; letter-spacing: 1px; text-align:center;border-right:1px solid #e41f26;"><?php echo isset($item['poi_price']) ?  number_format($item['poi_price']) : 0; ?></td>
                        <?php if(isset($inv['po_currency']) && $inv['po_currency']== 1){ ?>
                    ...
                    <tr>
                        ...
                        echo getIndianCurrency(round($finaltotal)); ?></strong></td>
                        <?php } ?>                  
                        <td valign="middle" height="35" colspan="2" style="border-left: 1px solid #e41f26; border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;font-size:12px;text-align: right;"><strong>Total Amount USD:</strong></td>                         
                        <td valign="middle" height="35" colspan="2" style="border-left: 1px solid #e41f26; border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;border-right:1px solid #e41f26;text-align: center;font-size:12px;"><strong><?php echo number_format($finaltotal); ?></strong>
                        </td>
                    </tr>
        </table>
