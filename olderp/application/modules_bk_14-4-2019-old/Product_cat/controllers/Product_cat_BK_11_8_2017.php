...
class product_cat extends CI_Controller {
	...
	public function ajax()
	{
		...
		$records["data"][] = array(
			  ...
			  '<a href="'.base_url().'Product_cat/edit/'.$idenc.'" class="btn btn-sm btn-outline green"><i class="fa fa-search"></i> Edit</a>
			  <a href="'.base_url().'Product_cat/delete/'.$idenc.'"onclick="return confirm('."'Are you sure you want to Delete this record?'".')" class="btn btn-sm btn-outline red"><i class=""></i> Delete</a>',
		);
		}
