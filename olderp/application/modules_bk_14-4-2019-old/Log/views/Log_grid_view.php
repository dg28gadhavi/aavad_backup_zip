...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Log">Log</a>
                            </li>
                    ...
                    <?php
                     if($this->session->userdata('miconlogin') && is_array($this->session->userdata['miconlogin']) && !empty($this->session->userdata['miconlogin']) && isset($this->session->userdata['miconlogin']['typeid']) && (encrypt_decrypt('decrypt',$this->session->userdata['miconlogin']['typeid']) == 3) &&  isset($this->session->userdata['miconlogin']['userid']) && ($this->session->userdata['miconlogin']['userid'] != ''))
                   { ?>
                    <div class="col-md-12 col-xs-12">
                        <span class="pull-right">
                          <div class="view-btn">
                            <a class="btn red" href="<?php echo base_url(); ?>Log/clearall" role="button">Clear All</a>
                          </div>
                      </span>
                </div>
                <?php } ?>
                                        ...
                                        <?php /* $crud->display_as('master_party_code','Party Code')->display_as('master_party_name','Party Name')->display_as('master_party_state','State')->display_as('master_party_department','Admin type')->display_as('master_party_area','Area')->display_as('master_party_pincode','Pincode')->display_as('master_party_category','Category')->display_as('master_party_contact_person','Contact Person')->display_as('master_party_contact_no','Contact No')->display_as('master_party_created_date','Created Date')->display_as('master_party_updated_date','Updated Date')->display_as('master_party_email_address','Email Address')->display_as('master_party_fax','Fax')->display_as('master_party_phone','Office Number')->display_as('master_party_webpage','Website'); */ ?>
                                            <thead>
                                                ...
                                                <tr role="row" class="filter">
                                                   <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="me_name"> </td>
                                                            <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="me_ip"> </td>
                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="me_name"> </td> 
                                                     <td>
                                                        ...
                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="login"> </td>
                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="module"> </td> 
                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="file"> </td> 
                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="add"> </td> 
                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="edit"> </td>
                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="delete"> </td>
                                                    <td>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/admin_log.js" type="text/javascript"></script>
