                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                               <input type="text" class="form-control" tabindex="1" name="sa_no" maxlength="200" id="sa_no" value="<?php echo !$this->uri->segment(3) && isset($sa_code) ? $sa_code : ''; ?><?php echo isset($list[0]['sa_no']) ? $list[0]['sa_no'] : ""; ?>" autofocus>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                 <input type="text" class="form-control form-control-inline input-medium date-picker" tabindex="2" placeholder="Quotation Date" name="sa_enq_date" maxlength="200" id="sa_enq_date" value="<?php echo isset($list[0]['sa_enq_date']) ? date("d-m-Y", strtotime($list[0]['sa_enq_date'])) : ""; ?>">
                            </div>
                        </div>
                    </div>
                </div>
