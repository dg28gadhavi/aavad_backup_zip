            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                         <textarea class="form-control" tabindex="46" placeholder="Payment Term" name="pi_payment_term" id="pi_payment_term" rows="3"><?php echo isset($list[0]['pi_payment_term']) ? $list[0]['pi_payment_term'] : ""; ?><?php if(isset($list[0]['pi_payment_term']) && $list[0]['pi_payment_term'] == '') { ?>Payment 100% advance by cheque OR RTGS<?php } ?></textarea>   
                        </div>
                    </div>
                </div>
            </div>
