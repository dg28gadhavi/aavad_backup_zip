...
<!-- BEGIN BREADCRUMBS -->
    <div class="breadcrumbs">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="<?php echo base_url(); ?>Oa">OA Report</a></li>
            <li><a href="<?php echo base_url(); ?>Oa/add">OA Add</a></li>
        </ol>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                             <input type="text" tabindex="2" class="form-control form-control-inline input-medium date-picker" placeholder="Quotation Date" name="oa_enq_date" maxlength="200" id="oa_enq_date" value="<?php echo isset($list[0]['oa_enq_date']) ? date("d-m-Y", strtotime($list[0]['oa_enq_date'])) : date('d-m-Y'); ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-2">
                                                            <a class="btn red" href="<?php echo base_url(); ?>Oa/add">RESET</a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select name="oa_country" tabindex="5" id="country_change" class="bs-select form-control country_change" data-live-search="true" data-size="8">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select name="oa_state" tabindex="6" id="state_change" class="bs-select form-control state_change" data-live-search="true" data-size="8">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" id="master_party_taxgr">
                                                        ...
                                                        <div class="col-md-9">
                                                           <select name="oa_city" tabindex="7" id="city_change" class="bs-select form-control city_change" data-live-search="true" data-size="8">
                                            ...
                                            <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-9">
                                                               <input type="text" tabindex="9" class="form-control" placeholder="Contact Person" name="oa_con_person" maxlength="100" id="oa_con_person" value="<?php echo isset($list[0]['oa_cont_per']) ? $list[0]['oa_cont_per'] : ""; ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="row">
                                                            <div class="col-md-offset-3 col-md-9">
                                                              <input type="submit" tabindex="15" class="btn btn-success btn-space" name="start" value="Start"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
function sub_cat(i)
{
	var data = { 'id': i.value};
		$.ajax({
		type: "POST",
		url: "<?php echo base_url(); ?>Oa/getsub_category",
		data: data,
		dataType:"json",
		  success: function(json)
		  {
			 ...
			 $('#oa_subsource_cat').empty();
			 $('#oa_subsource_cat').append(data);
