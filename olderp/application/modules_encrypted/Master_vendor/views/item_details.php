...
<!-- <h4>Some Input</h4> -->
        <?php if(isset($edit_items) && !empty($edit_items)){ ?>
            ...
            <div class="col-md-6" style="text-align:right;"><a class="btn green" style="text-align:right;" href="<?php echo base_url(); ?>Master_vendor/quatation_tab/<?php echo $this->uri->segment(3); ?>" >New Details Add</a></div>
            </div>
        <?php }else{ ?>
        ...
        <div class="portlet-body">
            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                ...
                <tr>
                    ...
                    <td><a href="<?php echo base_url(); ?>Master_vendor/delete_itms/<?php echo $aid; ?>/<?php echo $this->uri->segment(3); ?>" class="btn btn-sm btn-outline delete" class="btn btn-sm btn-outline delete" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>

                    <a href="<?php echo base_url(); ?>Master_vendor/quatation_tab/<?php echo $this->uri->segment(3); ?>?itemid=<?php echo $row['contact_id']; ?>&acttype=edit" class="btn btn-sm btn-outline delete" onclick="return confirm('Are you sure you want to edit this item?');">Edit</a>
                    </td>
                </tr>
