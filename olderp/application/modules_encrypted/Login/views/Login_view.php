...
?>
        ...
        <div class="logo">
            <a href="<?php echo base_url(); ?>login">
                <img src="<?php echo base_url(); ?>skin/images/logo_signeture.png"  width="300" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <!-- <form class="login-form" action="index.html" method="post"> -->
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="password" required/> </div>
                     ...
                     <div class="security-code" style="display:none">
            <label for="user_code">Security Code:</label>
            
            <input type="text" class="input log-secure" palceholder="Enter Captch" size="12
            n" id="security_code" name="security_code" value="<?php echo $word; ?>" />
        ...
        <div class="copyright"> <?php echo date('Y'); ?> © Aavad Instrument Erp </div>
        <!--[if lt IE 9]>
