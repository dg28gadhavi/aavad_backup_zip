...
<!-- BEGIN BREADCRUMBS -->
    <div class="breadcrumbs">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                <a href="<?php echo base_url(); ?>Team_type">Team Type List</a>
            </li>
            <li>
                <a href="<?php echo base_url(); ?>Team_type/add">Team Type Add</a>
            </li>
        </ol>
                ...
                <div class="page-content-row">
                    ...
                    <div class="row">
                        ...
                        <div class="portlet box">
                            ...
                            <div class="form-body">
                                <h3 class="form-section">Team Type Name</h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Team Type Name</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="Team Type Name" name="ag_teamname" maxlength="200" id="ag_teamname" value="<?php echo isset($list[0]['ag_teamname']) ? $list[0]['ag_teamname'] : ""; ?>" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                     <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Select Admin User</label>
                                                    <div class="col-md-9">
                                                <select id="group_id" name="group_id[]" class="mt-multiselect btn btn-default" multiple="multiple" tabindex="" data-label="left" data-width="100%" data-filter="true" required>
                                                    ...
                                                    <option value="<?php echo $admin_user['au_id'];?>"
                                                    <?php if($this->uri->segment(2)=='edit'){  
                                                        foreach($list as $userid)
                                                    {
                                                        //echo "<pre>";print_r($userid['agi_id']);die;
                                                     if($userid['agi_adminid'] == $admin_user['au_id'])
                                                        { ?> selected="selected" <?php } }}?> ><?php echo $admin_user['au_fname'].''.$admin_user['au_lname'];?></option>
                                                  <?php } ?>  
                                            </select>  
                                        </div>
                                    </div>
...
function ValidateDetails()
{
    var fields;
    fields = "";
    document.getElementById('Team_type_name').className = 'form-control';
    $('#Team_type_name').parent().parent().removeClass('has-error');
    
    if (DoTrim(document.getElementById('Team_type_name').value).length == 0) {
        if(fields != 1){
        document.getElementById("Team_type_name").focus();
        }
        fields = '1';
        document.getElementById('Team_type_name').className = 'form-control error';
        if($('#Team_type_name').parent().parent().attr('class') == 'form-group')
        {
            $('#Team_type_name').parent().parent().addClass('has-error');
        }
        //return false;
    }
