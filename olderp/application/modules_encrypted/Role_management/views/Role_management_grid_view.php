...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Role_management">Role management List</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>Role_management/add">Role management Add</a>
                            </li>
                        </ol>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/role_manage.js" type="text/javascript"></script>
