                           ...
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label class="control-label col-md-3">Date of Birth:</label>
                                   <div class="col-md-9">
                                    <input type="text" tabindex="5" class="form-control form-control-inline input-medium date-picker" id="au_dob" name="au_dob"  value="<?php echo isset($list['users'][0]['au_dob']) ? $list['users'][0]['au_dob'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                            </div>
                             <div class="row">
                              ...
                              <div class="form-group">
                                 <label class="control-label col-md-3">Com Mobile No.</label>
                                   <div class="col-md-9">
                                    <input type="text" class="form-control" id="au_mo_no" name="au_mo_no" tabindex="6" maxlength="15" value="<?php echo isset($list['users'][0]['au_mo_no']) ? $list['users'][0]['au_mo_no'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label class="control-label col-md-3">Personal Mobile No.</label>
                                   <div class="col-md-9">
                                    <input type="text" class="form-control" id="au_per_mobil_no" name="au_per_mobil_no" tabindex="7" maxlength="15" value="<?php echo isset($list['users'][0]['au_per_mobil_no']) ? $list['users'][0]['au_per_mobil_no'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label class="control-label col-md-3">Extra Mobile No.</label>
                                   <div class="col-md-9">
                                    <input type="text" class="form-control" id="au_extra_no" name="au_extra_no" tabindex="8" maxlength="15" value="<?php echo isset($list['users'][0]['au_extra_no']) ? $list['users'][0]['au_extra_no'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                           </div>
                           <div class="row">
                                  ...
                                  <div class="form-group">
                                     <label class="control-label col-md-4">Country</label>
                                       <div class="col-md-8">
                                        <select id="au_country" name="au_country" class="bs-select form-control" data-placeholder="Choose a Category" tabindex="9" data-live-search="true" data-size="8">
                              ...
                              <div class="form-group">
                                 <label class="control-label col-md-3">State</label>
                                   <div class="col-md-9">
                                    <select id="au_state" name="au_state"  class="bs-select form-control" data-placeholder="Choose a Category" tabindex="10" data-live-search="true" data-size="8">
                             ...
                             <div class="col-md-3">
                              <div class="form-group">
                                 <label class="control-label col-md-3">City</label>
                                   <div class="col-md-9">
                                    <select id="au_city" name="au_city"  class="bs-select form-control" data-placeholder="Choose a Category" tabindex="11" data-live-search="true" data-size="8">
                             ...
                             <div class="col-md-3">
                              <div class="form-group">
                                 <label class="control-label col-md-3">Area</label>
                                   <div class="col-md-9">
                                    <select id="au_area" name="au_area"  class="bs-select form-control" data-placeholder="Choose a Category" tabindex="12" data-live-search="true" data-size="8">
                                       <option value="0">Select Area</option>
                                       <?php if($this->uri->segment(2) == 'edit') { ?>
                                       <option value="<?php echo $list['areas'][0]['area_id'];?>" selected><?php echo $list['areas'][0]['area_name'];?></option>
                                       <?php } ?>
                                    </select>
                                   </div>
                             </div>
                           ...
                           <div class="row">
                              ...
                              <div class="form-group">
                                 <label class="control-label col-md-3">Department</label>
                                   <div class="col-md-9">
                                      <select id="au_dep_id" name="au_dep_id" class="form-control" data-placeholder="Choose a Category" tabindex="13" required="required">
                              ...
                              <div class="form-group">
                                 <label class="control-label col-md-3">Select Rights<span class="required" aria-required="true"> * </span></label>
                                   <div class="col-md-9">
                                    <select id="au_rights_id" name="au_rights_id" class="form-control" data-placeholder="Choose a Category" tabindex="14" required="required">
                           ...
                           <div class="col-md-4" <?php
                              ...
                              <div class="form-group">
                                 <label class="control-label col-md-3">Admin Type<span class="required" aria-required="true"> * </span></label>
                                   <div class="col-md-9">
                                     <select id="au_adt_id" name="au_adt_id" class="form-control" data-placeholder="Select Admin type" tabindex="15" required="required">
                           ...
                           <div class="col-md-3">
                                           ...
                                           <?php } ?> </div>
                                            ...
                                            <div>
                                                <span class="btn default btn-file">
                                                    ...
                                                    <input type="file" name="au_photo" id="au_photo" tabindex="16"> 
                        		...
                        		<div class="col-md-5">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                        	<textarea class="form-control" rows="7" id="au_remark" name="au_remark" tabindex="17"><?php echo isset($list['users'][0]['au_remark']) ? $list['users'][0]['au_remark'] : ""; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                              <div class="form-group">
                                 <label class="control-label col-md-3">Your Admin<span class="required" aria-required="true"> * </span></label>
                                   ...
                                   <?php
                                                    if($this->session->userdata('miconlogin') && is_array($this->session->userdata['miconlogin']) && !empty($this->session->userdata['miconlogin']) && isset($this->session->userdata['miconlogin']['typeid']) && (encrypt_decrypt('decrypt',$this->session->userdata['miconlogin']['typeid']) == 3))
                                                    { ?> <select id="au_parent_id" name="au_parent_id" class="form-control" data-placeholder="Select Admin type" tabindex="15">
                                      ...
                                      <select id="dfhdfhdfh" name="dfdfhdfh" class="form-control" disabled tabindex="15">
                                      <option value="0">No Parent</option>
                                      <?php foreach($admin as $admin_user) { ?>
                                       <option value="<?php echo $admin_user['au_id'];?>"<?php if(isset($list) && $list['users'][0]['au_parent_id'] == $admin_user['au_id']){ ?> selected="selected" <?php } ?>><?php echo $admin_user['au_fname'].''.$admin_user['au_lname'];?></option>
                                       <?php } ?>
                                    </select>
                                      <select id="au_parent_id" name="au_parent_id" class="form-control" style="display:none;" tabindex="15">
                                      <option value="0">No Parent</option>
                                      <?php foreach($admin as $admin_user) { ?>
                                       <option value="<?php echo $admin_user['au_id'];?>"<?php if(isset($list) && $list['users'][0]['au_parent_id'] == $admin_user['au_id']){ ?> selected="selected" <?php } ?>><?php echo $admin_user['au_fname'].''.$admin_user['au_lname'];?></option>
                                       <?php } ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group" id="mcna_namegr">
                                    ...
                                    <div class="col-md-11">
                                    <textarea class="form-control" name="au_signature" placeholder="Body" id="summernote_1" rows="3"><?php
                              ...
                              <div class="col-md-6">
                                    <div class="form-group" id="mcna_namegr">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                              <input type="text" id="hue-demo" name="aus_color" class="form-control demo" data-control="hue" value="<?php echo isset($list['users'][0]['au_colorcode']) ? $list['users'][0]['au_colorcode'] : '#d2b68e'; ?>"> </div>
                                            </div>
                                        </div>
                                    </div>
                              </div>
                        ...
                        <div class="row">
                              ...
                              <div class="form-group">
                                 <label class="control-label col-md-3">Birth Date:</label>
                                   <div class="col-md-9">
                                     <input class="form-control form-control-inline date-picker" size="16" type="text"  id="au_birth_date" name="au_birth_date" value="<?php echo isset($list['users'][0]['au_birth_date']) ? date("d-m-Y", strtotime($list['users'][0]['au_birth_date'])) : ""; ?>" tabindex="18">
                                   </div>
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label class="control-label col-md-3">Anniversary Date: </label>
                                   <div class="col-md-9">
                                     <input class="form-control form-control-inline date-picker" size="16" type="text"  id="au_anni_date" name="au_anni_date" value="<?php echo isset($list['users'][0]['au_anni_date']) ? date("d-m-Y", strtotime($list['users'][0]['au_anni_date'])) : ""; ?>" tabindex="19">
                                   </div>
                              </div>
                           </div>
                           <div class="col-md-4">
                              <div class="form-group">
                                 <label class="control-label col-md-3">Joining Date:</label>
                                   <div class="col-md-9">
                                    <input class="form-control form-control-inline date-picker" size="16" type="text"  id="au_join_date" name="au_join_date" value="<?php echo isset($list['users'][0]['au_join_date']) ? date("d-m-Y", strtotime($list['users'][0]['au_join_date'])) : ""; ?>" tabindex="20">
                                   </div>
                              </div>
                           </div>
                           </div>
                          <h3 class="form-section">Salary Details :</h3>
                          <div class="salary_hidden">
                          <div class="row">
                            <div class="col-md-4" >
                              <div class="form-group">
                                 <label class="control-label col-md-6">Salary Calculate Yes ? no</label>
                                   <div class="col-md-6">
                                      <label>
                                        <input type="radio" name="au_eligible_sal" tabindex="17" class="icheck" value="1" <?php if(isset($list['users'][0]['au_eligible_sal']) && $list['users'][0]['au_eligible_sal'] == 1){ echo "checked"; } ?>> Yes </label>
                                         <label>
                                           <input type="radio" name="au_eligible_sal" class="icheck" value="0" <?php if(isset($list['users'][0]['au_eligible_sal']) && $list['users'][0]['au_eligible_sal'] == 0){ echo "checked"; } if($this->uri->segment(2) == "add") { echo "checked"; } ?>> No </label>
                                   </div>
                              </div>
                           </div>
                         </div>
                          ...
                          <div class="col-md-4">
                              <div class="form-group">
                                 <label class="control-label col-md-3">Basic Salary </label>
                                   <div class="col-md-9">
                                    <input type="text" class="form-control" id="au_basic_sal" name="au_basic_sal" tabindex="21" maxlength="15" value="<?php echo isset($list['users'][0]['au_basic_sal']) ? $list['users'][0]['au_basic_sal'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                           <div class="col-md-4" >
                              <div class="form-group">
                                 <label class="control-label col-md-3">Salary Breakup </label>
                                   <div class="col-md-9">
                                    <input type="text" class="form-control" id="au_sal_brkup_main" name="au_sal_brkup_main" tabindex="23" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_brkup_main']) ? $list['users'][0]['au_sal_brkup_main'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                         </div>
                           ...
                           <div class="col-md-4" >
                              <div class="form-group">
                                 <label class="control-label col-md-3">Basic</label>
                                   <div class="col-md-4">
                                    <input type="text" class="form-control" id="au_sal_basic_percent" name="au_sal_basic_percent" tabindex="23" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_basic_percent']) ? $list['users'][0]['au_sal_basic_percent'] : ""; ?>">
                                   </div>
                                   <div class="col-md-4">
                                    <input type="text" class="form-control" id="au_sal_basic_res" name="au_sal_basic_res" tabindex="23" maxlength="15" value="<?php   
                           ...
                           <div class="col-md-4" >
                              <div class="form-group">
                                 <label class="control-label col-md-3">HRA</label>
                                   <div class="col-md-4">
                                    <input type="text" class="form-control" id="au_sal_hra_percent" name="au_sal_hra_percent" tabindex="23" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_hra_percent']) ? $list['users'][0]['au_sal_hra_percent'] : ""; ?>">
                                   </div>
                                   <div class="col-md-4">
                                    <input type="text" class="form-control" id="au_sal_hra_res" name="au_sal_hra_res" tabindex="23" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_hra_res']) ? $list['users'][0]['au_sal_hra_res'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                         </div>
                           ...
                           <div class="col-md-4" >
                              <div class="form-group">
                                 <label class="control-label col-md-3">Wash</label>
                                   <div class="col-md-4">
                                    <input type="text" class="form-control" id="au_sal_wash_percent" name="au_sal_wash_percent" tabindex="23" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_wash_percent']) ? $list['users'][0]['au_sal_wash_percent'] : ""; ?>">
                                   </div>
                                   <div class="col-md-4">
                                    <input type="text" class="form-control" id="au_sal_wash_res" name="au_sal_wash_res" tabindex="23" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_wash_res']) ? $list['users'][0]['au_sal_wash_res'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                         </div>
                           ...
                           <div class="col-md-4" >
                              <div class="form-group">
                                 <label class="control-label col-md-3">Bonus</label>
                                   <div class="col-md-4">
                                    <input type="text" class="form-control" id="au_sal_bonus_percent" name="au_sal_bonus_percent" tabindex="23" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_bonus_percent']) ? $list['users'][0]['au_sal_bonus_percent'] : ""; ?>">
                                   </div>
                                   <div class="col-md-4">
                                    <input type="text" class="form-control" id="au_sal_bonus_res" name="au_sal_bonus_res" tabindex="23" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_bonus_res']) ? $list['users'][0]['au_sal_bonus_res'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                         </div>
                           ...
                           <div class="col-md-4" >
                              <div class="form-group">
                                 <label class="control-label col-md-3">ESIC</label>
                                   <div class="col-md-9">
                                    <input type="text" class="form-control" id="au_sal_esic" name="au_sal_esic" tabindex="22" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_esic']) ? $list['users'][0]['au_sal_esic'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                         </div>
                           ...
                           <div class="col-md-4" >
                              <div class="form-group">
                                 <label class="control-label col-md-3">PF</label>
                                   <div class="col-md-9">
                                    <input type="text" class="form-control" id="au_sal_pf" name="au_sal_pf" tabindex="22" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_pf']) ? $list['users'][0]['au_sal_pf'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                         </div>
                           ...
                           <div class="col-md-4" >
                              <div class="form-group">
                                 <label class="control-label col-md-3">Professional Tax Standard</label>
                                   <div class="col-md-9">
                                    <input type="text" class="form-control" id="au_sal_proffesional_tax" name="au_sal_proffesional_tax" tabindex="22" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_proffesional_tax']) ? $list['users'][0]['au_sal_proffesional_tax'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                           </div>
                           ...
                           <div class="col-md-4" >
                              <div class="form-group">
                                 <label class="control-label col-md-3">Add Performance Bonus</label>
                                   <div class="col-md-9">
                                    <input type="text" class="form-control" id="au_sal_add_perform" name="au_sal_add_perform" tabindex="22" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_add_perform']) ? $list['users'][0]['au_sal_add_perform'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                         </div>
                           ...
                           <div class="col-md-4" >
                              <div class="form-group">
                                 <label class="control-label col-md-3">12 Leaves</label>
                                   <div class="col-md-9">
                                    <input type="text" class="form-control" id="au_sal_12_leaves" name="au_sal_12_leaves" tabindex="22" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_12_leaves']) ? $list['users'][0]['au_sal_12_leaves'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                         </div>
                         <div class="row">
                           <div class="col-md-4" >
                              <div class="form-group">
                                 <label class="control-label col-md-3">CTC PM</label>
                                   <div class="col-md-9">
                                    <input type="text" class="form-control" id="au_sal_ctc_pm" name="au_sal_ctc_pm" tabindex="22" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_ctc_pm']) ? $list['users'][0]['au_sal_ctc_pm'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                           <div class="col-md-4" >
                              <div class="form-group">
                                 <label class="control-label col-md-3">CTC PY</label>
                                   <div class="col-md-9">
                                    <input type="text" class="form-control" id="au_sal_ctc_py" name="au_sal_ctc_py" tabindex="22" maxlength="15" value="<?php echo isset($list['users'][0]['au_sal_ctc_py']) ? $list['users'][0]['au_sal_ctc_py'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                           </div>
                            ...
                            <div class="col-md-4" style="display: none;">
                              <div class="form-group">
                                 <label class="control-label col-md-3">Total Leave</label>
                                   <div class="col-md-9">
                                    <input type="text" class="form-control" id="au_total_leave" name="au_total_leave" tabindex="23" maxlength="15" value="<?php echo isset($list['users'][0]['au_total_leave']) ? $list['users'][0]['au_total_leave'] : ""; ?>">
                                   </div>
                              </div>
                           </div>
                         </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Email ID<span class="required" aria-required="true"> * </span></label>
                                        <div class="col-md-8">
                                          ...
                                          <input id="au_gmail_email" name="au_gmail_email" value="<?php echo isset($list['users'][0]['au_gmail_email']) ? $list['users'][0]['au_gmail_email'] : ""; ?>" type="email" class="form-control" placeholder="Email Address" required="required" tabindex="18" maxlength="100"> </div>
                                        </div>
                                </div>
                             </div>
                              <div class="col-md-4">
                                  ...
                                  <label class="col-md-4 control-label">Password<span class="required" aria-required="true">  </span></label>
                                        <div class="col-md-8">
                                            <div class="input-group">
                                              ...
                                              <input id="au_gmail_password" name="au_gmail_password"  value="<?php echo isset($list['users'][0]['au_gmail_password']) ? $list['users'][0]['au_gmail_password'] : ""; ?>" type="password" class="form-control" placeholder="Password" tabindex="19" maxlength="50">
                                            </div>
                                        </div>
                                </div>
                              </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Email ID<span class="required" aria-required="true"> * </span></label>
                                        <div class="col-md-8">
                                          ...
                                          <input id="au_email" name="au_email" value="<?php echo isset($list['users'][0]['au_email']) ? $list['users'][0]['au_email'] : ""; ?>" type="email" class="form-control" placeholder="Email Address" required="required" tabindex="24"> </div>
                                        </div>
                                </div>
                             </div>
                             </div>
                                	...
                                	<label class="col-md-4 control-label">Password<span class="required" aria-required="true">  </span></label>
                                        <div class="col-md-8">
                                            <div class="input-group">
                                            	...
                                            	<input id="au_password" name="au_password" type="password" class="form-control" placeholder="Password" tabindex="25" >
                                            </div>
                                        </div>
                                </div>
                              </div>
                                	...
                                	<label class="col-md-4 control-label">Confirm Password<span class="required" aria-required="true">  </span></label>
                                        <div class="col-md-8">
                                            <div class="input-group">
                                            	...
                                            	<input id="confirmpwd" name="confirmpwd" type="password" class="form-control" placeholder="Confirm Password" tabindex="26" >
                                            </div>
                                        </div>
                                </div>
                              </div>
                          ...
                          <div class="form-actions" style="display:none">
                                <div class="row">
                                    <div class="col-md-offset-5 col-md-7">
                                        <a href="javascript:;" class="btn default button-previous" style="display: none;" tabindex="21">
