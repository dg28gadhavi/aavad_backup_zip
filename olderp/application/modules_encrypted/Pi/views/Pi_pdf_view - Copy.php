...
<div style="width:98%; margin:0 auto;padding-top:50px; font-family: 'Arial Black', Gadget, sans-serif">
                ...
                <div style="width:98%; margin-top:0;">
                    ...
                    <table style="width:100%;border-collapse:collapse;">
                        <tr>
                            ...
                            <td valign="top" style=" width:255px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"></strong><?php echo $inv['vendor']; ?></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:255px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo nl2br($inv['pi_address']); ?></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:10px; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:255px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo $inv['pi_phone']; ?></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:10px; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:255px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo nl2br($inv['pi_email']); ?></td>
                        </tr>
	...
	<!-- <div style="width:100%;">CH A    :</div></td> -->
            <td valign="top" style="width:5cm;border-top:1px solid #e9494f; border-bottom:1px solid #e9494f;border-right:1px solid #e9494f; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;">
                <div style="width:98%; margin-top:0;">
                    <!-- <div style="width:100%; font-size:11px; float:left; letter-spacing: 1px;"> <span style="font-weight:bold;">Invoice No</span> : PI NV111310 </div> -->
                    <table style="width:100%;border-collapse:collapse;">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:10px; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:139px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;">24AAECM7879C1ZB</td>
                        </tr>
                        </table>
                </div>
            </td>
        ...
        <tr>
            <td valign="top" style="width:9cm; border-top:1px solid #e9494f; border-left:1px solid #e9494f; border-bottom:1px solid #e9494f; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;">
                    <div style="width:98%; margin-top:0;">
                        <table style="width:100%;border-collapse:collapse;">
                        <tr>
                            <td valign="top" style=" width:40px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><strong>GST NO.</strong><span style="text-align:right !important;"></span></td>
                            <td valign="top" style=" width:10px; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style=" width:290px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"></strong><?php echo $inv['pi_gst']; ?></td>
                        </tr>
                        <tr>
                            <td valign="top" style="width:40px; font-size:11px; float:left; letter-spacing: 1px; text-align:left; padding-top:5px;"><strong>Kind Att.</strong><span style="text-align:right !important;"></span></td>
                            <td valign="top" style="padding-top:5px; width:10px; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:290px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo $inv['pi_con_person']; ?></td>
                        </tr>
                    </table>
                </div>
    ...
    <table border="0" style="width:18cm; border-collapse:collapse; margin:0; padding:0; background-color:#f8f8f8; border-left:1px solid #e9494f;border-right:1px solid #e9494f; border-bottom:1px solid #e9494f;" autosize="0">
                    ...
                    <tr>
                        ...
                        <td valign="middle" style="width: 1cm; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; font-weight:bold;border-bottom:1px solid #e9494f;background-color:#f7bbbd;">Desc.</td>
                        <td colspan="2" valign="middle" style="width: 2cm; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; font-weight:bold;border-bottom:1px solid #e9494f;background-color:#f7bbbd;">Taxable Amount</td>
                        ...
                        <td colspan="2" valign="middle" style="width: 1cm; border-left: 1px solid #e9494f; border-right: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; font-weight:bold;border-bottom:1px solid #e9494f;background-color:#f7bbbd;">Total</td>
...
<?php //******************not in use end *********** ?>
                    <tr>
                        <td valign="middle" style="border-left: 1px solid #e9494f;font-size:12px; letter-spacing: 1px; text-align:center;"><?php echo $srno; ?></td>
                        <td valign="middle" colspan="2" style="border-left: 1px solid #e9494f;font-size:12px; float:left; letter-spacing: 1px; text-align:left;padding-left: 5px"><strong><u><?php echo $item['master_item_name']; ?></u></strong><br>Part No:<?php echo $item['master_item_part_no']; ?><br/><?php echo nl2br($item['master_item_description']); ?></td>
                        <td valign="middle" style="border-left: 1px solid #e9494f;font-size:12px; float:left; letter-spacing: 1px; text-align:center;"><?php echo $item['hsn_hcode']; ?></td>
                        <td valign="middle" style="border-left: 1px solid #e9494f;font-size:12px; float:left; letter-spacing: 1px; text-align:center;"><?php echo $item['pii_itm_qty']; ?></td>
                        <td valign="middle" style="border-left: 1px solid #e9494f;font-size:12px; letter-spacing: 1px; text-align:center;"><?php echo number_format($item['pii_itm_price']); ?></td>
                        <td valign="middle" style="border-left: 1px solid #e9494f;font-size:12px; letter-spacing: 1px; text-align:center;"><?php echo number_format($item['pii_itm_discount']); ?></td>
                        <td colspan="2" valign="middle" style="border-left: 1px solid #e9494f;font-size:12px; float:left; letter-spacing: 1px; text-align:center;"><?php $subttl = $item['pii_itm_qty'] * number_format($item['pii_itm_price'], 2, '.', '');
                         echo number_format($subttl); ?></td> 
                         <?php $withouttax = $withouttax + number_format($subttl, 2, '.', '');  ?>                        
						<td valign="middle" style="border-left: 1px solid #e9494f;font-size:12px; float:left; letter-spacing: 1px; text-align:center;"><?php echo number_format($item['pii_itm_gst_per']); ?></td>                      
                       
                        <td valign="middle" style="border-left: 1px solid #e9494f;font-size:12px; letter-spacing: 1px; text-align:center;"><?php $disc = (($subttl*$item['pii_itm_discount'])/100);
                        ...
                        <td colspan="2" valign="middle" style="border-left: 1px solid #e9494f;border-right: 1px solid #e9494f;font-size:12px; letter-spacing: 1px; text-align:right;"><?php 
...
<?php //***************************************** BOM start ********************** ?>
                    ...
                    <?php if($srno < 6){
                        for ($i=$srno; $i < 10 ; $i++) {  ?>
                            <tr>
                                <td valign="top" style=" border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; color:#edf2f8;">1</td>
                                <td colspan="2" valign="top" style=" border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:left; color:#edf2f8;">TERMINAL</td>
                                <td valign="top" style=" border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">8.21</td>
                                <td valign="top" style=" border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">1.642</td>
                                <td valign="top" style=" border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">8.21</td>
                                <td valign="top" style=" border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">8.21</td>
                                <td colspan="2" valign="top" style=" border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">8.21</td>
                                <td valign="top" style=" border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">8.21</td>
                                ...
                                <td valign="top" style=" border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">8.21</td>
                                <td colspan="2" valign="top" style="border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing:1px; text-align:right; color:#edf2f8;border-right: 1px solid #e9494f;">64.500000</td>
                            </tr> 
                       <?php }
                        } ?>
                        	<tr>
                            <td valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; color:#edf2f8;">1</td>
                            <td colspan="2" valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:left; color:#edf2f8;">TERMINAL</td>
                            <td valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">8.21</td>
                            <td valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">1.642</td>
                            <td  valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">8.21</td>
                            <td  valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">8.21</td>
                            <td  colspan="2" valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">8.21</td>
                            <td valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">8.21</td>
                            ...
                            <td valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">8.21</td>
                            <td colspan="2" valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f;border-right: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#edf2f8;">64.500000</td>
                    </tr>
                    ...
                    <tr>
                            ...
                            <td colspan="2" valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:left; color:#000;"><strong>P & F</strong></td>
                            <td valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; color:#000;"><?php echo $inv['pi_hsncode'] ?></td>
                            <td colspan="2" valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#000;"></td>
                            ...
                            <td colspan="2" valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; color:#000;"><?php echo number_format($inv['pi_taxbleamount'], 2, '.', ''); ?></td>
                            <?php $withouttax = $withouttax + $inv['pi_taxbleamount']; ?>     
                            <td valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; color:#000;"><?php echo number_format($inv['pi_pfgst'], 2, '.', ''); ?></td>
                            <td valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; color:#000;"><?php echo number_format($inv['pi_taxamount'], 2, '.', ''); ?></td>
                            <?php $onlytax = $onlytax + $inv['pi_taxamount']; ?>
                            <td colspan="2" valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f;border-right: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#000;"><?php echo number_format($inv['pi_grandtotal'], 2, '.', ''); ?></td>
                     ...
                     <tr>
                            ...
                            <td colspan="2" valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; color:#000;"></td>                            
                            <td colspan="2" valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; color:#000;"><?php echo number_format($inv['pi_fright_taxbleamount'], 2, '.', ''); ?></td> 
                            ...
                            <td colspan="2" valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f;border-right: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#000;"><?php echo number_format($inv['pi_fright_grandtotal'], 2, '.', ''); ?></td>
                   ...
                   <!--  <tr>
                    ...
                    <?php  $disc = $finaltotal - (($itm_discount * $finaltotal)/100); } else { $disc = $finaltotal; } */ ?>
                     <tr>
                        ...
                        <td colspan="6" height="25" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:12px; text-align:right;background-color:#fad1d3;"><strong>Total:</strong></td>
                        <td colspan="2" height="25" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:12px; text-align:center;background-color:#fad1d3;"><strong><?php echo number_format($withouttax, 2, '.', ''); ?></strong></td>
                        <td height="25" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:12px; text-align:center;background-color:#fad1d3;"></td>
                        <td height="25" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:12px; text-align:center;background-color:#fad1d3;"><strong><?php echo number_format($onlytax, 2, '.', ''); ?></strong></td>
                        <td height="25" colspan="2" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:12px; text-align:right;background-color:#fad1d3;"><strong><?php echo number_format($gtotal, 2, '.', ''); ?></strong></td>
                        <?php /*?><td style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;"></td><?php */?>
                    </tr>
                    <tr>
                        <?php// $disc = $finaltotal - (($itm_discount * $finaltotal)/100); ?>
                        <td colspan="6" height="25" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:12px; text-align:left;background-color:#fad1d3;"><strong><?php echo getIndianCurrency(number_format($gtotal, 2, '.', '')); ?></strong></td>
                        ...
                        <td colspan="3" height="25" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:13px; text-align:right;background-color:#fad1d3;"><strong><?php echo number_format($gtotal, 2, '.', ''); ?></strong></td>
                        <?php /*?><td style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;"></td><?php */?>
                    </tr>
                    <tr>
    	  ...
    	  <table style="width:100%;border-collapse:collapse; margin:0; padding:0;">
                    ...
                    <tr>
                        <td valign="top" style="text-align:left; border-left:1px solid #e9494f;border-bottom:1px solid #e9494f; font-size:12.5px; height: 70px; width: 65%; padding-right: 1%; padding-left: 1%; padding-top: 1%; padding-bottom: 1%;">
                            <div style="height:70px; color: #e9494f;font-size:13px;">Payment 100% advance by cheque OR RTGS</div>
                            <div style="width:98%;font-size:13px;"><strong>Delivery : Ex Stock</strong></div>
                            <div style="width:98%;font-size:12px;">Subject to ahmedabad jurisdiction only.</div>           
                            <div style="width:98%; font-size:12px;">No allowance for shortage, mistake in any way or</div>
                            <div style="width:98%; font-size:12px;">loss in transit will be entertaine unless notice is</div>
                            <div style="width:98%; font-size:12px;">given within seven days on receipt of goods.</div>
                        </td>                        
                        <td valign="top" style="border-left:1px solid #e9494f;border-bottom:1px solid #e9494f; border-right: 1px solid #e9494f;font-size:13.5px;height: 70px; width: 38%; padding-right: 1%; padding-left: 1%; padding-top: 1%; padding-bottom: 1%; text-align:left;">
                            <div style="width:98%;font-size:13px;"><strong>Prepared By</strong></div>
                            <div style="font-size:12px;color:#e9494f;"><?php echo $inv['au_fname']; ?> <?php echo $inv['au_lname']; ?></div>
                            <div style="font-size:12px;color:#e9494f;">M : <?php echo $inv['au_mo_no']; ?></div>
                            <div style="font-size:12px;color:#e9494f;">Email : <?php echo $inv['au_email']; ?></div>
                            <br>
