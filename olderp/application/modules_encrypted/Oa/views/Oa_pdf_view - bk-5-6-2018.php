            ...
            <td valign="top" colspan="2" style="width:6cm; border-top:1px solid #e9494f; border-left:1px solid #e41f26; border-right:1px solid #e41f26; border-bottom:1px solid #e41f26; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;">
                <table style="width:100%;border-collapse:collapse;">
                    <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:10px; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:560px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php if(isset($inv['oa_con_person']) && $inv['oa_con_person']!=''){echo $inv['oa_con_person'];}else{echo '';} ?></td>
                    </tr>
                    <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:10px; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:560px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php if(isset($inv['oa_subject']) && $inv['oa_subject']!=''){echo $inv['oa_subject'];}else{echo '';} ?></td>
                    </tr>        
                </table>
...
<?php //******************not in use end *********** ?>
                    <tr>
                        ...
                        <td colspan="2" valign="top" style="border-left: 1px solid #e9494f;font-size:12px; float:left; letter-spacing: 1px; text-align:left;"><strong><?php echo $item['master_item_name']; ?><?php echo $item['master_item_part_no']; ?></strong><br/><?php echo nl2br($item['oai_itm_desc']); ?></td>
...
<?php //***************************************** BOM start ********************** ?>
    	...
    	<table style="width:100%;border-collapse:collapse; margin:0; padding:0;">
                    ...
                    <tr>
                        ...
                        <td valign="top" style="border-left:1px solid #e9494f;border-bottom:1px solid #e9494f; border-right: 1px solid #e9494f;font-size:13.5px;font-family: 'Tahoma'; height: 70px; width: 50%; padding-right: 1%;  padding-left: 1%;padding-top: 1%; padding-bottom: 1%; text-align:left;">
