...
<div class="row">
    ...
    <div class="breadcrumbs breadcrumbs-header">
        ...
        <?php $id = $this->uri->segment(3); ?>
            <a class="btn green" href="<?php echo base_url(); ?>Dispatch/mail/<?php echo $id; ?>">Mail Sent</a>            
     </div> 
     </div>      
    <div class="col-md-6 breadcrumbs breadcrumbs-header">
        <ol class="breadcrumb">
            <li>
                ...
                <a class="bread-space" href="<?php echo base_url(); ?>Dispatch/dispatch_report">Dispatch Report</a>
                <a class="bread-space" href="<?php echo base_url(); ?>Dispatch/add">Create New Dispatch</a>
            </li>
        </ol>
    </div>
                    ...
                    <?php //echo '<pre>';print_r($emails);//die; ?>
                        ...
                        <div class="portlet box blue">     
                             <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Dispatch  Process </div>
                                    <div class="tools">
                                ...
                                <?php //$tabono = $this->session->userdata('tabno') ? $this->session->userdata('tabno') : 0; ?>
                                    ...
                                    <li class="<?php if(isset($tabno) && ($tabno == 3)) { ?> active <?php } ?>">
                                        <a href="#tab_2_3" data-toggle="tab" aria-expanded="false">Dispatch Ready Items </a>
                                    </li>
...
<script type="text/javascript">
$(document).on('blur', '.disi_qty,.disi_itm_price,.disi_itm_discount', function() {
        var idd = $(this).attr('id');
        //ert(idd);
        var total =($("#disi_qty").val() * $("#disi_itm_price").val());
        var totaldisc = ((($("#disi_qty").val() * $("#disi_itm_price").val()) * $("#disi_itm_discount").val()) / 100);
        var ftotal = (($("#disi_qty").val() * $("#disi_itm_price").val()) - totaldisc);
        $("#disi_itm_total").val(parseFloat(total).toFixed(2));
        $("#disi_ftotal").val(parseFloat(ftotal).toFixed(2));
        //ert(totaldisc);
