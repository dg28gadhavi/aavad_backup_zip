...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs bread-title">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>Work_order/Work_order_report">Work Order Report</a>
                            </li>
                            <li><a href="<?php echo base_url(); ?>Work_order/add">Work Order Add</a></li>
                        </ol>
        ...
        <div class="page-content-container">
                ...
                <?php $search_task = array('class' => 'form-horizontal','method' => 'get');
                                    echo form_open(base_url().'Work_order/Work_order_report',$search_task); ?>
                <div class="page-content-container">
                    <!-- BEGIN CONTENT BODY -->
                                    ...
                                    <div class="portlet box portlet-quote">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12 text-right">
                                             ...
                                             <div class="col-md-4">
                                            <div class="form-group" id="mcna_namegr">
                                                <label class="control-label col-md-4">Executive Name</label>
                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                            <thead>
                                                <tr role="row" class="heading">
                                                    ...
                                                    <th width="2%">  Customer Address </th>
                                                    <th width="2%">  Total Amount </th>
                                                    <th width="2%"> Prepared By </th>
                                                    <th width="2%"> Created By </th>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="wo_fainaltotal"> </td>

                                                         <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="wo_preparedby"> </td>
                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="wo_created_by"> </td>

                                                         <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="wo_remark"> </td>

                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="wo_udate"> </td>
...
<script src="<?php echo base_url(); ?>assets/custom/js/work_order_report.js" type="text/javascript"></script>
