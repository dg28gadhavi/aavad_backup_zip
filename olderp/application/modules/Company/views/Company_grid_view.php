...
<!-- BEGIN BREADCRUMBS -->
                ...
                <h3><a class="btn btn-default blue" href="<?php echo base_url().'Company/csvimport'; ?>">Import CSV</a></h3>
            </div>
        </div>
<!-- END BREADCRUMBS -->
            <!-- BEGIN CONTENT -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <form method="get" accept-charset="utf-8" action="<?php echo base_url(); ?>Company/delete_all">
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/company.js" type="text/javascript"></script>
