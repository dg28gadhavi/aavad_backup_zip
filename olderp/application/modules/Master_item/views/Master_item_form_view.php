                        ...
                        <div class="portlet box">
                            <div class="portlet-body form">
                                ...
                                <div class="row">
                                    <div class="col-md-6" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" tabindex="2" class="form-control item_supplier" placeholder="Customer Name" name="item_supplier" maxlength="100" id="item_supplier" value="<?php echo isset($list[0]['master_item_make_name']) ? $list[0]['master_item_make_name'] : ""; ?>">
                                                    <input type="hidden" name="item_supplier_id" id="item_supplier_id" value="<?php echo isset($list[0]['master_item_make']) ? $list[0]['master_item_make'] : ""; ?>">
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group required" id="master_party_namegr">
                                            <label class="control-label col-md-3">Item Name</label>
                                            <div class="col-md-9">
                                               <input type="text" tabindex="2" class="form-control" placeholder="Item Name" name="master_item_name" maxlength="200" id="master_item_name" required="required" value="<?php echo isset($list[0]['master_item_name']) ? $list[0]['master_item_name'] : ""; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                     <div class="col-md-6">
                                        <div class="form-group required" id="master_party_namegr">
                                            <label class="control-label col-md-3">Modal Code</label>
                                            <div class="col-md-9">
                                                <input type="text" tabindex="1" class="form-control" placeholder="Modal Code" maxlength="20"  name="master_item_modal_code" id="master_item_modal_code" required="required" value="<?php echo isset($list[0]['master_item_modal_code']) ? $list[0]['master_item_modal_code'] : '';?>">
                                            </div>
                                        </div>
                                    </div>
                                      <div class="col-md-6">
                                        <div class="form-group" id="master_party_namegr">
                                            <label class="control-label col-md-3">KEY WORD</label>
                                            <div class="col-md-9">
                                                <input type="text" tabindex="1" class="form-control" placeholder="KEY WORD" maxlength="200"  name="master_item_keyword" id="master_item_keyword" value="<?php echo isset($list[0]['master_item_keyword']) ? $list[0]['master_item_keyword'] : '';?>">
                                            </div>
                                        </div>
                                    </div>
                                      ...
                                      <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group required" id="master_party_namegr">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input tabindex="3" class="form-control" placeholder="Item Part No" maxlength="100" name="master_item_pno" id="master_item_pno" required="required" value="<?php echo isset($list[0]['master_item_part_no']) ? $list[0]['master_item_part_no'] : ''; ?>" type="text">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                <select tabindex="8" class="bs-select form-control" data-live-search="true" data-size="8" name="master_item_make" id="master_item_make">
                                                    ...
                                                    <option value="<?php echo $vendor['master_vendor_id'];?>" <?php if(isset($list[0]['master_item_make']) && $list[0]['master_item_make'] == $vendor['master_vendor_id']){ echo "selected";}?>><?php echo $vendor['master_vendor_com_name'];?></option>
                                                    <?php } ?>                       
                                                </select>
                                            </div>
                                        </div>
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group required" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                <select tabindex="16" class="bs-select form-control hsn" data-live-search="true" data-size="8" name="master_item_hsn" id="master_item_hsn" required="required">
