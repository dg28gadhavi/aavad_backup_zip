...
<div style="width:98%; margin:0 auto;padding-top:50px; font-family: 'Arial Black', Gadget, sans-serif">
    ...
    <table style="width:100%;border-collapse:collapse;">
        <tr nobr="true">
            <td colspan="2" style="width:98%; color:#4e80bc; padding-top: 10px; padding-bottom:0.3cm; text-align:center;font-size:17px; text-transform: uppercase; font-weight:bold; letter-spacing: 2px;">Order Acceptance</td>
        </tr>
        <tr>
	...
	<!-- <div style="width:100%;">CH A    :</div></td> -->
            <td valign="top" style="width:6cm;border-top:2px solid #4e80bc; border-left:2px solid #4e80bc;border-bottom:2px solid #4e80bc;border-right:2px solid #4e80bc; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;">
                <div style="width:98%; margin-top:0;">
                    ...
                    <table style="width:100%;border-collapse:collapse;">
                        <tr>
                            <td valign="top" style=" width:35.5%; font-size:12px; float:left; letter-spacing: 2px; text-align:left;"><strong>PO No.</strong><span style="text-align:right !important;"></span></td>
                            <td valign="top" style=" width:5%; font-size:12px; float:left; letter-spacing: 2px; text-align:center;">:</td>
                            <td valign="top" style=" width:47.5%; font-size:12px; float:left; letter-spacing: 2px; text-align:left;"><?php echo $inv['oa_no'] ?></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:47.5%; font-size:12px; float:left; letter-spacing: 2px; text-align:left;"><?php echo date("d-m-Y", strtotime($inv['oa_enq_date'])); ?></td>
                        </tr>
                        </table>
                </div>
            </td>
...
<?php //******************not in use end *********** ?>
                    <tr>
                        ...
                        <td valign="top" colspan="2" style="border-left: 2px solid #4e80bc;font-size:12px; float:left; letter-spacing: 1px; text-align:left;"><strong><?php echo $item['master_item_name']; ?><?php echo $item['master_item_part_no']; ?></strong><br/><?php echo nl2br($item['oai_itm_desc']); ?></td>
                        <td valign="top" colspan="2" style="border-left: 2px solid #4e80bc;font-size:12px; float:left; letter-spacing: 1px; text-align:center;"><?php echo $item['oai_itm_qty']; ?></td>
                        <td valign="top" style="border-left: 2px solid #4e80bc;font-size:12px; letter-spacing: 2px; text-align:center;"><?php echo number_format($item['oai_itm_price'], 2, '.', ''); ?></td>
                        <td valign="top" style="border-left: 2px solid #4e80bc;font-size:12px; float:left; letter-spacing: 1px; text-align:center;"><?php $subttl = $item['oai_itm_qty'] * number_format($item['oai_itm_price'], 2, '.', '');
                         echo $subttl; ?></td>
                         <?php if(isset($inv['oa_isdiscount']) && !empty($inv['oa_isdiscount']) && $inv['oa_isdiscount'] == 1) { ?>
						<td valign="top" style="border-left: 2px solid #4e80bc;font-size:12px; float:left; letter-spacing: 1px; text-align:center;"><?php echo number_format($item['oai_itm_discount'], 2, '.', ''); ?></td>
                        <?php } ?>
                        <?php if(isset($inv['oa_isdiscount']) && !empty($inv['oa_isdiscount']) && $inv['oa_isdiscount'] == 2) { ?>
                        <td colspan="2" valign="top" style="border-left: 2px solid #4e80bc;border-right: 2px solid #4e80bc;font-size:12px; letter-spacing: 1px; text-align:right;"><?php $subtotal =  ($subttl - (($subttl*$item['oai_itm_discount'])/100));
                        echo number_format($subtotal, 2, '.', '');
                         $finaltotal = $finaltotal + number_format($subtotal, 2, '.', ''); ?></td>
                        <?php $itm_discount = $itm_discount + $item['oai_itm_discount']; ?>
                        <?php } else { ?>
                        <td valign="top" style="border-left: 2px solid #4e80bc;border-right: 2px solid #4e80bc;font-size:12px; letter-spacing: 1px; text-align:right;"><?php $subtotal =  ($subttl - (($subttl*$item['oai_itm_discount'])/100));
                        echo number_format($subtotal, 2, '.', '');
                         $finaltotal = $finaltotal + number_format($subtotal, 2, '.', ''); ?></td>
                        <?php $itm_discount = $itm_discount + $item['oai_itm_discount']; ?>
                        <?php } ?>                            
...
<?php //***************************************** BOM start ********************** ?>
                   ...
                   <tr>
                        <td colspan="6" style="border-right:2px solid #4e80bc;border-left:2px solid #4e80bc;border-bottom:2px solid #4e80bc;font-family: 'Arial Black', Gadget, sans-serif;font-size:14px; text-align:left;"><?php //echo $inv['oa_grd_ttl_words'] ?></td>
