...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Task">Solution Report</a>
                            </li>
                        </ol>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group" id="mcna_namegr">
                                                ...
                                                <br/><a href="<?php echo base_url(); ?>Task/close_sts/<?php echo $this->uri->segment(3); ?>"onclick="return confirm('."'Are you sure you want to Close this record?'".')" class="btn btn-sm btn-outline red"><h4>Click here to Close Ticket <i class="fa fa-times"></i></h4></a>
                                                <?php }else{
                                                        ...
                                                        <div class="mt-comment-body">
                                                            ...
                                                            <div class="mt-comment-details">
                                                                ...
                                                                <ul class="mt-comment-actions">
                                                                    <li>
                                                                        <a href="<?php echo base_url(); ?>Task/delete_chat/<?php echo $this->uri->segment(3); ?>?chatid=<?php echo $value['stcomm_id']; ?>&acttype=delete_chat" onclick="return confirm('Are you sure you want to edit this item?');">Delete</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
