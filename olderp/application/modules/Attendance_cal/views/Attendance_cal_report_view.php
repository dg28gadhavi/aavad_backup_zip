                                        ...
                                        <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_3">
                                            ...
                                            <tbody>
                                                ...
                                                //echo "<pre>"; print_r($Sal_cals);die;
                                                 ...
                                                 foreach($Sal_cals as $calculation){ 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php
                                                              /*$t_work_day = $t_work_day + $calculation['attend_pa_id'];  
                                                              $t_leave = $t_leave + $calculation['attend_intime'];
                                                              $t_py_without = $t_py_without + $calculation['attend_outtime'];*/
                                                ...
                                                <!-- <tr>
                                                    ...
                                                    <td><?php echo $t_pf;  ?></td>
                                                    <td><strong><?php echo $t_netsal;  ?></strong></td>
                                                    <td></td>
                                                </tr> -->
                                            </tbody>
                                        </table>
