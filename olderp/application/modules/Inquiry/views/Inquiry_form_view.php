...
<?php //********************** Inquiry start ***************************** ?>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-4">Sub Source</label>
                                           ...
                                           <?php foreach ($list['subsource'] as $subsource) { ?>
                                             <option value="<?php echo  $subsource['source_cat_id'];?>" <?php if(isset($list['inquiry'][0]['inq_subsource']) && ($list['inquiry'][0]['inq_subsource'] == $subsource['source_cat_id'])){ ?> selected="selected" <?php } ?> ><?php echo  $subsource['source_cat_name'];?></option>
                                           <?php } ?> 
                                           <?php } ?>
                                            </select>
                                           </div>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-5">
                              <div class="form-group">
                                 <label class="control-label col-md-4">Country Eligible :</label>
                                   <div class="col-md-8">
                           ...
                           <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="mt-radio-inline">
                                                        <label class="mt-radio">
                                                            <input type="radio" name="inquiry_details[hasref]" id="inq_ref" class="category_change"  value="0" <?php  if(isset($list['inquiry'][0]['inq_hasrefrence']) && ($list['inquiry'][0]['inq_hasrefrence'] == '0')){ ?> checked <?php }  ?> tabindex="9" > Yes
                                                            <span></span>
                                                        </label>
                                                        <label class="mt-radio">
                                                            <input  type="radio" name="inquiry_details[hasref]" id="inq_refno"  value="1" <?php  if(isset($list['inquiry'][0]['inq_hasrefrence']) && ($list['inquiry'][0]['inq_hasrefrence'] == '1')){ ?> checked <?php }else{ if($this->uri->segment(2) && ($this->uri->segment(2) == 'add')){ echo 'checked'; } }  ?> tabindex="10"> No
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                </div>
                            ...
                            <?php if(isset($list) && isset($list['inquiry'][0]['inq_hasrefrence']) && ($list['inquiry'][0]['inq_hasrefrence'] == 0 )){ $clsli = "display:block;"; }else{ $clsli = "display:none;"; } ?>
                            <div class="col-md-4" id="reference_name" style="<?php echo $clsli; ?>">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3" id="reference_no" style="<?php echo $clsli; ?>">
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-8">
                                        <select id="inq_au" name="inquiry_details[au]" class="bs-select form-control" data-live-search="true" data-placeholder="Choose Source"  tabindex="4">
                                          <option value="">Select Admin</option>
                                           ...
                                           <option value="<?php echo  $user['au_id'];?>" <?php if(isset($list['inquiry'][0]['inq_au_id']) && ($list['inquiry'][0]['inq_au_id'] == $user['au_id'])){ ?> selected="selected" <?php }else{ 
                                               if(isset($userid) && ($userid == $user['au_id'])){ echo 'selected="selected"'; } 
                                             } ?>><?php echo  $user['au_fname'];?> <?php echo  $user['au_lname'];?></option>
                                           <?php } ?>
                                        </select>
                                       </div>
                                  </div>
