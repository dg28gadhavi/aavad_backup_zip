...
<!-- BEGIN BREADCRUMBS -->
    <div class="breadcrumbs">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="<?php echo base_url(); ?>Country">Country List</a></li>
            <li><a href="<?php echo base_url(); ?>Country/add">Country Add</a></li>
        </ol>
                ...
                <div class="page-content-col">
                    <div class="row">
                        ...
                        <div class="portlet box">
                            ...
                            <div class="form-body">
                                <h3 class="form-section">Country Name</h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Country Name</label>
                                            <div class="col-md-9">
                                                <input type="text" tabindex="1" class="form-control" placeholder="Country Name" name="country_name" maxlength="200" id="country_name" value="<?php echo isset($list[0]['country_name']) ? $list[0]['country_name'] : ""; ?>" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" tabindex="2" class="form-control" placeholder="order" name="order_name" maxlength="200" id="order_name" value="<?php echo isset($list[0]['country_order']) ? $list[0]['country_order'] : ""; ?>" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
