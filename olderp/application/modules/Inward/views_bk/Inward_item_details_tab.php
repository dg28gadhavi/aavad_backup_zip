                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text" tabindex="16" class="form-control" placeholder="Part No" name="sqi_itm_pno" maxlength="200" id="sqi_itm_pno" value="<?php echo isset($edit_items['inwi_part_no']) ? $edit_items['inwi_part_no'] : ""; ?>" autofocus>
                                <input type="hidden" name="sqi_itm_pno_id" id="sqi_itm_pno_id" required="required" value="<?php echo isset($edit_items['inwi_itm_name']) ? $edit_items['inwi_itm_name'] : ""; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text" tabindex="16" class="form-control" placeholder="Item Title" name="sqi_itm_title" maxlength="200" id="sqi_itm_title" value="<?php echo isset($edit_items['inwi_itm_title']) ? $edit_items['inwi_itm_title'] : ""; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text" tabindex="16" class="form-control" placeholder="Item Rating" name="inwi_itm_rating" maxlength="200" id="inwi_itm_rating" value="<?php echo isset($edit_items['inwi_itm_rating']) ? $edit_items['inwi_itm_rating'] : ""; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text" tabindex="16" class="form-control" placeholder="Item Code" name="inwi_itm_code" maxlength="200" id="inwi_itm_code" value="<?php echo isset($edit_items['inwi_itm_code']) ? $edit_items['inwi_itm_code'] : ""; ?>">
                            </div>
                        </div>
                    </div>
                     <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <textarea rows="10" cols="50" tabindex="17" class="form-control sqi_itm_desc" name="inwi_itm_description" id="inwi_itm_description"><?php echo isset($edit_items['inwi_itm_description']) ? $edit_items['inwi_itm_description'] : ""; ?></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text" tabindex="18" class="form-control" placeholder="Stock" name="inwi_stock" maxlength="200" id="inwi_stock" value="<?php echo isset($edit_items['inwi_stock']) ? $edit_items['inwi_stock'] : 0; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text" tabindex="18" class="form-control" placeholder="Sale Price" name="inwi_sale_price" maxlength="200" id="inwi_sale_price" value="<?php echo isset($edit_items['inwi_sale_price']) ? $edit_items['inwi_sale_price'] : 0; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text" tabindex="18" class="form-control" placeholder="Purchase Price" name="inwi_purchase_price" maxlength="200" id="inwi_purchase_price" value="<?php echo isset($edit_items['inwi_purchase_price']) ? $edit_items['inwi_purchase_price'] : 0; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text" tabindex="18" class="form-control" placeholder="Purchase Price Unit" name="inwi_purchase_price_unit" maxlength="200" id="inwi_purchase_price_unit" value="<?php echo isset($edit_items['inwi_purchase_price_unit']) ? $edit_items['inwi_purchase_price_unit'] : 0; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text" tabindex="18" class="form-control inwi_qty" placeholder="Quantity" name="inwi_qty" maxlength="200" id="inwi_qty" value="<?php echo isset($edit_items['inwi_qty']) ? $edit_items['inwi_qty'] : 0; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text" tabindex="18" class="form-control" placeholder="Unit" name="inwi_unit" maxlength="200" id="inwi_unit" value="<?php echo isset($edit_items['inwi_unit']) ? $edit_items['inwi_unit'] : 0; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text" tabindex="18" class="form-control inwi_price" placeholder="Price" name="inwi_price" maxlength="200" id="inwi_price" value="<?php echo isset($edit_items['inwi_price']) ? $edit_items['inwi_price'] : 0; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text" tabindex="18" class="form-control" placeholder="Total" name="inwi_total" maxlength="200" id="inwi_total" value="<?php echo isset($edit_items['inwi_total']) ? $edit_items['inwi_total'] : 0; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text"  tabindex="22" class="form-control inwi_discount" placeholder="Discount" name="inwi_discount" maxlength="200" id="inwi_discount" value="<?php echo isset($edit_items['inwi_discount']) ? $edit_items['inwi_discount'] : 0; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text"  tabindex="23" class="form-control sqi_itm_ftotal" placeholder="Final Total" name="inwi_ftotal" maxlength="200" id="inwi_ftotal" value="<?php echo isset($edit_items['inwi_ftotal']) ? $edit_items['inwi_ftotal'] : 0; ?>">
                            </div>
                        </div>
                    </div>
                </div>
