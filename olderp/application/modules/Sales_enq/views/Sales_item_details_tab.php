                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <textarea rows="10" cols="50" tabindex="17" class="ckeditor form-control sqi_itm_desc" name="sqi_itm_desc" id="sqi_itm_desc"><?php echo isset($edit_items['sqi_itm_desc']) ? $edit_items['sqi_itm_desc'] : ""; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
                            ...
                            <div class="col-md-9">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                            <img src="<?php if(isset($list[0]['master_item_img']) && ($list[0]['master_item_img'] != '')) {?><?php echo base_url();?>uploads/master_item_img/<?php echo $list[0]['master_item_img']; ?><?php } else{ ?>http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image<?php } ?>" alt=""> 
                                        </div>
                                        <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"> </div>
                                        <div>
                                                <span class="btn default btn-file">
...
<div class="portlet-body">
        <?php //echo "<pre>"; print_r($autosearch_items); die;
            $clsar = array('class' => 'form-horizontal','method' => 'GET','autocomplete' => 'off');
            echo form_open_multipart($action_mailvendor,$clsar); ?>
            <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                        ...
                        <tr>
                            <td><input type="checkbox" name="itmid[]" value="<?php echo $row['sqi_id']; ?>"></td>
                            <td><?php echo $id;?></td>
                    ...
                    <div class="modal-footer pull-left">
                              <input type="submit" tabindex="24" class="btn btn-success btn-space" name="submit" value="Send Email to Vendor" tabindex="10" />
                    </div>
                    <?php echo form_close(); ?>
        </div>   