                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" tabindex="2" class="form-control po_supplier" placeholder="Customer Name" name="po_supplier" maxlength="100" id="po_supplier" value="<?php echo isset($list[0]['po_supplier']) ? $list[0]['po_supplier'] : ""; ?>" required="required">
                                                     <input type="hidden" name="vendor_id" id="vendor_id" value="<?php echo isset($list[0]['vendor']) ? $list[0]['vendor'] : ""; ?>">
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="10" class="form-control" placeholder="Contact Person" name="sq_con_person" maxlength="100" id="sq_con_person" value="<?php echo isset($list[0]['po_con_person']) ? $list[0]['po_con_person'] : ""; ?>">
                                            </div>
                                        </div>
                                    </div>
