                                                    ...
                                                    <li>
                                                        <div class="col1">
                                                            <div class="cont">
                                                                ...
                                                                <div class="cont-col2">
                                                                    <div class="desc" style="text-transformation:uppercase; font-weight:bold;"> <?php echo ''.$sub['au_fname'].'  '.$sub['au_lname'].'<a href="'.base_url().'Dashboard?executive='.$id.'" class="btn" target="_blank"> View Record File</a>'; ?></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col2">
