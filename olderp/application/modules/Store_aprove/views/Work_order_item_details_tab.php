<?php if(isset($edit_items) && !empty($edit_items)){ ?>
        ...
        <?php }else{ ?>
            ...
            <?php } ?>
<?php
if($confirm_or_not['wo_confirm_or_not'] == 0)
{
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                <input type="text" tabindex="16" class="form-control" placeholder="Part No" name="sqi_itm_pno" maxlength="200" id="sqi_itm_pno" value="<?php echo isset($edit_items['woi_part_no']) ? $edit_items['woi_part_no'] : ""; ?>" autofocus>
                                <input type="hidden" name="sqi_itm_pno_id" id="sqi_itm_pno_id" value="<?php echo isset($edit_items['woi_item_id']) ? $edit_items['woi_item_id'] : ""; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
...
<div class="modal-footer pull-left">
 <!-- <button type="button" data-dismiss="modal" class="btn dark btn-outline">Close</button> -->
  <input type="submit" tabindex="23" class="btn btn-success btn-space" name="submit" value="Save" tabindex="10" />
</div>
<?php echo form_close(); } ?>
