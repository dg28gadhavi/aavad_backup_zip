...
<div style="width:98%; margin:0 auto;padding-top:50px; font-family: 'Arial Black', Gadget, sans-serif">
    ...
    <table border="0" style="width:18cm; border-collapse:collapse; margin:0; padding:0; border-left:1px solid #e9494f;border-right:1px solid #e9494f; border-bottom:1px solid #e9494f;" autosize="0">
                    ...
                    <tr>
                        ...
                        <td colspan="3" valign="middle" style="width: 2cm; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; font-weight:bold;border-bottom:1px solid #e9494f;background-color:#f7bbbd;">Taxable Amount</td>
                       <?php } else { ?>
...
<?php //******************not in use start *********** ?>
                    <tr>
                        ...
                        <td valign="top" style="border-left: 1px solid #e9494f;border-top:1px solid #e9494f;"></td>
                        <?php if(isset($inv['pi_isdiscount']) && !empty($inv['pi_isdiscount']) && $inv['pi_isdiscount'] == 2) { ?>
                        <td colspan="3" valign="top" style="border-left: 1px solid #e9494f;border-top:1px solid #e9494f;"></td>   
                        <?php } else { ?>  
...
<?php //******************not in use end *********** ?>
                    <tr>
                        ...
                        <?php } ?>
                        <?php if(isset($inv['pi_isdiscount']) && !empty($inv['pi_isdiscount']) && $inv['pi_isdiscount'] == 2) { ?>
                        <td colspan="3" valign="middle" style="border-left: 1px solid #e9494f;font-size:12px; float:left; letter-spacing: 1px; text-align:center;"><?php $subttl = $item['pii_itm_qty'] * number_format($item['pii_itm_price']);
                         echo ($subttl); ?></td> 
                        ...
                        <td valign="middle" style="border-left: 1px solid #e9494f;font-size:12px; letter-spacing: 1px; text-align:center;">
                            <?php $gstrate = 0;
                                $ftotal = 0;
...
<?php //******************not in use start *********** ?>
                    <tr>
                        ...
                        <td style="border-left: 1px solid #e9494f;border-bottom:1px solid #e9494f;"></td>
                        <?php if(isset($inv['pi_isdiscount']) && !empty($inv['pi_isdiscount']) && $inv['pi_isdiscount'] == 2) { ?>
                        <td colspan="3" style="border-left: 1px solid #e9494f;border-bottom:1px solid #e9494f;"></td> 
                        <?php }else{ ?>
                        	<td colspan="2" style="border-left: 1px solid #e9494f;border-bottom:1px solid #e9494f;"></td>
                        <?php } ?>                       
                        <td style="border-left: 1px solid #e9494f;border-bottom:1px solid #e9494f;"></td>
                    ...
                    <?php if($srno < 6){
                        for ($i=$srno; $i < 10 ; $i++) {  ?>
                            <tr>
                                ...
                                <?php } ?>
                                <td valign="top" style=" border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#ffffff;">8.21</td>
                                <!-- <td colspan="2" valign="top" style=" border-left: 1px solid #e9494f; font-size:11px; float:left; letter-spacing: 1px; text-align:right; color:#ffffff;">8.21</td> -->
                                <td valign="top" style=" border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#ffffff;">8.21</td>
                                <td colspan="2" valign="top" style="border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing:1px; text-align:right; color:#ffffff;border-right: 1px solid #e9494f;">64.500000</td>
                            </tr> 
                       <?php }
                        } ?>
                        	<tr>
                            ...
                            <td valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#fffffff;">8.21</td>
                            <!-- <td colspan="2" valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:11px; float:left; letter-spacing: 1px; text-align:right; color:#fffffff;">8.21</td> -->
                            <td valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#fffffff;">8.21</td>
                            <td colspan="2" valign="top" style="border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f;border-right: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#fffffff;">64.500000</td>
                    </tr>
                   ...
                   <!--  <tr>
                    ...
                    <?php  $disc = $finaltotal - (($itm_discount * $finaltotal)/100); } else { $disc = $finaltotal; } */ ?>
                     <tr>
                        ...
                        <td colspan="7" height="25" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:12px; text-align:right;background-color:#fad1d3;"><strong>Total:</strong></td>
                    ...
                    <tr>
                        <?php// $disc = $finaltotal - (($itm_discount * $finaltotal)/100); ?>
                        <td colspan="7" height="25" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:12px; text-align:left;background-color:#fad1d3;"><strong><?php echo getIndianCurrency(number_format($gtotal, 2, '.', '')); ?></strong></td>
    	...
    	<table style="width:18cm;border-collapse:collapse; margin:0; padding:0;">
                    ...
                    <tr>
                        <td valign="top" style="text-align:left; border-left:1px solid #e9494f;border-bottom:1px solid #e9494f; font-size:12.5px; height: 70px; width: 63%; padding-right: 1%; padding-left: 1%; padding-top: 1%; padding-bottom: 1%;">
                            <div style="height:70px; color:#e41f26; font-size:13px;">Payment 100% advance by cheque OR RTGS</div>
                            <div style="font-size:13px;"><strong>Delivery : Ex Stock</strong></div>
                        ...
                        <td valign="top" style="border-left:1px solid #e9494f;border-bottom:1px solid #e9494f; border-right: 1px solid #e9494f;font-size:13.5px;height: 70px; width: 40%; padding-right: 1%; padding-left: 1%; padding-top: 1%; padding-bottom: 1%; text-align:left;">
                            ...
                            <div style="font-size:12px;color:#e41f26;">Email : <?php echo $inv['au_email']; ?></div>
                            <br>
