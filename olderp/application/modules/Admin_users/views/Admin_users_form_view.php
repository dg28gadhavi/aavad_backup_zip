                        ...
                        <div class="form-body form-space">
                         <h3 class="form-section">Person Info</h3>
                           ...
                           <div class="col-md-3">
                                ...
                                <div class="col-md-4">
                              <div class="form-group">
                                 <label class="control-label col-md-3">Your Admin</label>
                                   <div class="col-md-9">
                                   <?php
                                                    if($this->session->userdata('miconlogin') && is_array($this->session->userdata['miconlogin']) && !empty($this->session->userdata['miconlogin']) && isset($this->session->userdata['miconlogin']['typeid']) && (encrypt_decrypt('decrypt',$this->session->userdata['miconlogin']['typeid']) == 3))
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group" id="mcna_namegr">
                                    ...
                                    <div class="col-md-11">
                                    <textarea class="form-control ckeditor" tabindex="20" name="au_signature" placeholder="Body" rows="3"><?php
                                	...
                                	<label class="col-md-4 control-label">Password</label>
                                        <div class="col-md-8">
                                            <div class="input-group">
                                            	...
                                            	<input id="au_password" name="au_password" type="password" class="form-control" placeholder="Password" tabindex="48" required="required">
                                            </div>
                                        </div>
                                </div>
                              </div>
                                	...
                                	<label class="col-md-4 control-label">Confirm Password<span class="required" aria-required="true">  </span></label>
                                        <div class="col-md-8">
                                            <div class="input-group">
                                            	...
                                            	<input id="confirmpwd" name="confirmpwd" type="password" class="form-control" placeholder="Confirm Password" tabindex="49" required="required">
                                            </div>
                                        </div>
                                </div>
                              </div>
