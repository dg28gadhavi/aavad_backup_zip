...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs bread-title">
                        <h1>Outward Serial Key List </h1>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Outward_serial_key_list/Outward_serial_key_list_report">Outward serial key list Report</a>
                            </li>
        ...
        <div class="page-content-container">
                <!-- BEGIN CONTENT -->
                <?php echo form_open(base_url().'Outward_serial_key_list/Outward_serial_key_list_report', array('method'=>'get', 'class' => 'form-horizontal')); ?>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat blue">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc">No of Outward serial key list</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat blue">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc">No of Item in Outward serial key list</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <div class="dashboard-stat purple">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> Outward serial key list </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                            ...
                                            <thead>
                                                ...
                                                <tr role="row" class="filter">
                                                    <td>
                                                    <input type="text" class="form-control form-filter input-sm" name="outward_serial_keyname"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otwi_part_no"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_customer_name"> </td>
                                                     <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_cdate"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_work_ord_no"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_challan_no"> </td>
                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_challan_date"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_remark"> </td>
                                                    <td>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/Outward_serial_key_list_report.js" type="text/javascript"></script>
