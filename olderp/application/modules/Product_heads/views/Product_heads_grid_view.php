...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        <h1>Product_heads List</h1>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Product_heads">Product_heads List</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>Product_heads/add">Product_heads Add</a>
                            </li>
                        </ol>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <form method="get" accept-charset="utf-8" action="<?php echo base_url(); ?>Product_heads/delete_all">
                                    <div class="table-container">
                                        <!-- <div class="table-actions-wrapper">
                                            <span> </span>
                                            <select class="table-group-action-input form-control input-inline input-small input-sm" id="dropdownHolder"  name="Product_heads_isdelete">
                                        ...
                                        <?php /* $crud->display_as('master_party_code','Party Code')->display_as('master_party_name','Party Name')->display_as('master_party_state','State')->display_as('master_party_city','City')->display_as('master_party_area','Area')->display_as('master_party_pincode','Pincode')->display_as('master_party_category','Category')->display_as('master_party_contact_person','Contact Person')->display_as('master_party_contact_no','Contact No')->display_as('master_party_created_date','Created Date')->display_as('master_party_updated_date','Updated Date')->display_as('master_party_email_address','Email Address')->display_as('master_party_fax','Fax')->display_as('master_party_phone','Office Number')->display_as('master_party_webpage','Website'); */ ?>
                                            <thead>
                                                <tr role="row" class="heading">
                                                    ...
                                                    <th width="2%"> Product_heads Name </th>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="Product_heads_name"> </td>
                                                    <td>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/product_heads.js" type="text/javascript"></script>
