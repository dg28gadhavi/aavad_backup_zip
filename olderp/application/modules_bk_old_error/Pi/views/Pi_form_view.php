                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group required">
                                                        ...
                                                        <div class="col-md-7">
                                                           <input type="text" tabindex="5" class="form-control vendor" placeholder="Customer Name" name="vendor" maxlength="100" id="vendor" required="required" value="<?php echo isset($list[0]['vendor']) ? $list[0]['vendor'] : ""; ?>" required="required">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group required" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-9">
                                                        <textarea class="form-control" tabindex="6" name="pi_address" placeholder="Customer Address" id="pi_address" required="required" rows="3"><?php echo isset($list[0]['pi_address']) ? $list[0]['pi_address'] : ""; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group required">
                                                        ...
                                                        <div class="col-md-9">
                                                           <input type="text" tabindex="10" class="form-control" placeholder="Contact Person" name="pi_con_person" maxlength="100" id="pi_con_person" required="required" value="<?php echo isset($list[0]['pi_cont_per']) ? $list[0]['pi_cont_per'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group required" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" tabindex="11" class="form-control" placeholder="Mobile No" name="pi_mobile" maxlength="200" id="pi_mobile" required="required" value="<?php echo isset($list[0]['pi_mobile']) ? $list[0]['pi_mobile'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group required">
                                                        ...
                                                        <div class="col-md-9">
                                                           <input type="text" tabindex="12" class="form-control" placeholder="Email Id" name="pi_email" maxlength="100" id="pi_email" required="required" value="<?php echo isset($list[0]['pi_email']) ? $list[0]['pi_email'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
  ...
  $( function() {
    ...
    $("#pi_con_person").autocomplete({
            ...
            select: function( event, ui )
            {
                ...
                var str = '';
               $("#pi_con_person").val(ui.item.cperson);
               $("#pi_mobile").val(ui.item.contact_mobile);
               $("#pi_email").val(ui.item.contact_email);
               $("#pi_phone").val(ui.item.contact_phone);
               $('#pi_address').val(ui.item.contact_address);
               $('.bs-select').selectpicker('refresh');
            },
            focus: function (a, b)
            {
