...
<div style="width:100%; margin:0 auto;padding-top:50px; font-family: 'Arial Black', Gadget, sans-serif">
        ...
        <tr>
            <td valign="top" colspan="2" rowspan="4" style="width:60%;border-top:1px solid #e9494f; border-left:1px solid #e41f26; border-right:1px solid #e41f26; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;">
                <table style="width:100%;border-collapse:collapse;">
                    ...
                    <tr>
                            <td valign="top" style=" width:20%; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><strong>Dispatch Address:</strong><span style="text-align:right !important;"></span></td>
                            <td valign="top" style=" width:5%; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style=" width:57.5%; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo isset($inv['wo_shipping_address']) ? $inv['wo_shipping_address'] : '' ; ?></td>
                        </tr>                         
                </table>
        ...
        <tr>
            <td valign="top" colspan="2" rowspan="2" style="border-top:1px solid #e9494f; border-left:1px solid #e41f26; border-right:1px solid #e41f26; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;">
                <table style="width:100%;border-collapse:collapse;">
                    ...
                    <tr>
                            <td valign="top" style="font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><strong><?php echo isset($inv['dis_collected_by']) ? $inv['dis_collected_by'] : '' ; ?></strong><span style="text-align:right !important;"></span></td>  
    ...
    <table style="width:18cm; border-collapse:collapse;background: #f8f8f8; margin:0; padding:0;" autosize="0">                 
                   ...
                   <?php $srno = 0;  foreach ($items as $key => $item) { $srno++; ?>
                    <tr style="margin: 0; padding: 0;">
                        ...
                        <td valign="top" colspan="2" style="border-left: 1px solid #e41f26;border-bottom:1px solid #e41f26;font-size:12; letter-spacing: 1px; text-align:center;">
                            <table style="width:100%;border-collapse:collapse;">
                                <tr>
                                    <td valign="top" style=" font-size:12px; float:left; letter-spacing: 1px; text-align:left;"><strong><?php if(isset($item['disi_itm_title']) && $item['disi_itm_title']!=''){echo $item['disi_itm_title'];} ?></strong><br>Part No:<?php if(isset($item['disi_partno']) && $item['disi_partno']!=''){echo $item['disi_partno'];} ?><br><br>Serial No:<?php if(isset($item['disi_partno']) && $item['disi_partno']!=''){echo str_replace(",",", ",$item['serialkey']);} ?><br></td>
                        ...
                        <td valign="top" style="border-left: 1px solid #e41f26;border-bottom:1px solid #e41f26;font-size:12px; float:left; letter-spacing: 1px; text-align:center;border-right:1px solid #e41f26;"></td>
                                                    
                    </tr>
                    <?php } ?>
                     <tr>
                        <td valign="top" height="35" style="border-left:1px solid #e41f26;border-top:1px solid #e41f26;border-bottom:1px solid #e41f26;font-size:11px;"></td>
                        <td valign="top" height="35" colspan="2" style="border-left: 1px solid #e41f26;border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;font-size:12px;"></td>
                        <td valign="top" height="35" style="border-left: 1px solid #e41f26; border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;font-size:11px;"></td>
                        <td valign="top" height="35" style="border-right:1px solid #e41f26;border-left: 1px solid #e41f26; border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;font-size:11px;text-align: center;"></td>                       
