...
.portlet-body .table .wotc {background: #dadada; font-weight: 600; width: 150px; color: #000;}
                    		...
                    		<div class="col-lg-8 col-md-8 col-sm-8">
                        		<div class="panel-body">
                            		<table class="table table-bordered">
										...
										<tr>
										  	<td colspan="8"><strong>Name:  <?php echo $work_order['wo_customer_name']; ?></strong><br><strong>Address: </strong><?php echo $work_order['wo_address']; ?></td>
											...
											?>
											  ...
											  <?php 	
													...
													}else if($dep_id == 11)
													{
														...
														<a href="<?php echo base_url(); ?>Dashboard_workorder_final/assign_user?wo_itemid=<?php echo $items['woi_id']; ?>&itemid=<?php echo $items['woi_item_id']; ?>&wo_id=<?php echo $items['woi_wo_id']; ?>" target="_BLANK" class="btn btn-warning" <?php if($stock <= 0){ ?> onclick="alert('Not Enough Stock'); return false;" <?php } ?>><i class="fa fa-user"></i></a>
									...
									<tr>
										  <td class="wotc"></td>
										  <td colspan="2" class="wotc">Delivery Time / Date: <?php echo $work_order['wo_deliverytime']; ?></td>
										  <td colspan="5" class="wotc">Delivery by: Air / Surface / H.D <?php echo $work_order['wo_deliveryby']; ?></td>
									</tr>
									<tr>
										<td colspan="3"></td>
										<td colspan="4">Courier Name: <?php echo $work_order['wo_couriername']; ?></td>
										<td>Docket No.: <?php echo $work_order['wo_docket_no']; ?></td>
									</tr>
									<tr>
										<td colspan="3" class="wotc"><strong>Prepared by: <?php echo $work_order['au_fname']." ".$work_order['au_lname']; ?></strong></td>
										<td colspan="5" class="wotc"><strong>Remarks: <?php echo $work_order['wo_remark']; ?></strong></td>
									</tr>
								</table>
                        </div>
                    </div>                
