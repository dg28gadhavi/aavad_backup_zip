            ...
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 text-right">
                    <div class="form-group" id="mcna_namegr">
                        <label class="control-label col-md-4">Start Dt.</label>
                        <div class="col-md-8">
                            <input class="form-control form-control-inline input-medium date-picker" tabindex="4" id="inq_start_date" name="inq_start_date" size="16" value="<?php echo ($this->input->get('inq_start_date')) ? date("d-m-Y", strtotime(($this->input->get('inq_start_date')))) : ""; ?>" type="text">
                        </div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 text-right">
                    <div class="form-group" id="mcna_namegr">
                        <label class="control-label col-md-4">End Dt.</label>
                        <div class="col-md-8">
                            <input class="form-control form-control-inline input-medium date-picker" tabindex="4" id="inq_end_date" name="inq_end_date" size="16" value="<?php echo ($this->input->get('inq_end_date')) ? date("d-m-Y", strtotime(($this->input->get('inq_end_date')))) : ""; ?>" tend_dateype="text">
                        </div>
                    </div>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 text-right">
                ...
                <div class="col-lg-1 col-md-1 col-sm-1 col-xs-12 text-left">
                    <div class="col-md-offset-1 col-md-12 text-left">
                                ...
                                <div class="dashboard-stat2 bordered sales-dashbg">
                                    <div class="display">
                                        <div class="number">
                                            ...
                                            <a href="<?php echo base_url(); ?>Work_order_item_list/Work_order_item_list_report?smapproved=2" target="_blank"><small>SM PENDING</small></a>
                                        </div>
                                        <div class="icon">
                                ...
                                <div class="dashboard-stat2 bordered sales-dashbg">
                                    <div class="display">
                                        <div class="number">
                                            ...
                                            <a href="<?php echo base_url(); ?>Work_order_item_list/Work_order_item_list_report?smapproved=1" target="_blank"><small>SM Approved</small></a>
                                        </div>
                                        <div class="icon">
                                            <i class="icon-pie-chart"></i>
                                        </div>
                                ...
                                <div class="dashboard-stat2 bordered admin-dashbg">
                                    <div class="display">
                                        <div class="number">
                                            ...
                                            <a href="<?php echo base_url(); ?>Work_order_item_list/Work_order_item_list_report?adminapproved=2" target="_blank"><small>A Pending</small></a>
                                        </div>
                                        <div class="icon">
                                            <i class="icon-pie-chart"></i>
                                        </div>
                                ...
                                <div class="dashboard-stat2 bordered admin-dashbg">
                                    <div class="display">
                                        <div class="number">
                                            ...
                                            <a href="<?php echo base_url(); ?>Work_order_item_list/Work_order_item_list_report?adminapproved=1" target="_blank"><small>A Approved</small></a>
                                        </div>
                                        <div class="icon">
                                            <i class="icon-pie-chart"></i>
                                        </div>
                                ...
                                <div class="dashboard-stat2 bordered pm-dashbg">
                                    <div class="display">
                                        <div class="number">
                                            ...
                                            <a href="<?php echo base_url(); ?>Work_order_item_list/Work_order_item_list_report?pmapproved=2" target="_blank"><small>PM Pending</small></a>
                                        </div>
                                        <div class="icon">
                                            <i class="icon-pie-chart"></i>
                                        </div>
                                ...
                                <div class="dashboard-stat2 bordered pm-dashbg">
                                    <div class="display">
                                        <div class="number">
                                            ...
                                            <a href="<?php echo base_url(); ?>Work_order_item_list/Work_order_item_list_report?pmapproved=1" target="_blank"><small>PM Approved</small></a>
                                        </div>
                                        <div class="icon">
                                            <i class="icon-pie-chart"></i>
                                        </div>
                    ...
                    <div class="panel-heading headingwo" role="tab" id="headingwo<?php echo $work_order['wo_id']; ?>">
                        <h4 class="panel-title">
                            ...
                            <?php if(isset($work_order['prom_outwardpending']) && ($work_order['prom_outwardpending'] > 0))
                                ...
                                echo $work_order['wo_wo_no'].$oldwono." [ ".$work_order['type_name']." ] [ ".$work_order['wo_customer_name']." ]"."  [ ".$work_order['au_fname']." ".$work_order['au_lname']." ]"." [ Dt.:".date("d-m-Y", strtotime($work_order['wo_wo_date']))." ]"." <span class='badge'>".$woisrno."</span> ";
                        		...
                        		<hr/>
                            		<table class="table table-bordered">
										<tr>
                                            ...
                                            <th class="wotb" style="text-align: center;"><a href="<?php echo base_url(); ?>pdf/wo/wo<?php echo encrypt_decrypt('encrypt',$work_order['wo_id']); ?>.pdf" target="_blank" class="btn btn-success"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a> 
                                            <a href="<?php echo base_url(); ?>Work_order/other_details/<?php echo encrypt_decrypt('encrypt',$work_order['wo_id']); ?>?fromwofinal=1" target="_blank" class="btn btn-danger"><i class="fa fa-plus" aria-hidden="true"></i></a></th>
...
.production-two-lbg{background: #772120; color: #F00000;}
									 		*/
									 		...
									 		?>
									 	<tr class="<?php echo $classclr; ?>" data-toggle="collapse" data-target="#idemo<?php echo $items['woi_id']; ?>">
											  <td><?php echo $counter; ?></td>
											  <td colspan="2"><?php echo $items['woi_part_no']." ".$items['woi_itm_title']."</br>Desc: ".nl2br($items['woi_itm_desc'])."</br>Comment: ".nl2br($items['woi_comment']); ?>
										...
										<tr id="idemo<?php echo $items['woi_id']; ?>" ">
										 	<td colspan="8">
										 		<!-- <span class="boxhover">
									...
									<tr>
										  ...
										  <td colspan="4" class="wotc"><?php echo $work_order['wo_deliveryby']; ?></td>
									</tr>
									<tr>
										<!-- <td colspan="3"></td> -->
