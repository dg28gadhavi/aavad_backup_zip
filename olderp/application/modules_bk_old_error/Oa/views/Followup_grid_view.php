...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        <h1>Sales Qoutation Followup List</h1>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Sale_quotation">Sales Qoutation List</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>Sale_quotation/add">Sales Qoutation Add</a>
                            </li>
                        </ol>
                                             ...
                                             <div class="table-responsive"> 
                                                ...
                                                <tbody>
                                                     ...
                                                     <?php if($sub['followdate'] == '1970-01-01')
                                                        ...
                                                        if(isset($sub['stname']) && $sub['stname'] == 1)
                                                         {
                                                            $sub['stname'] = 'Active';
                                                         }elseif(isset($sub['stname']) && $sub['stname'] == 2){
                                                            $sub['stname'] = 'Pending';
                                                         }elseif(isset($sub['stname']) && $sub['stname'] == 3){
                                                            $sub['stname'] = 'Completed';
                                                         }else{
                                                            $sub['stname'] = '';
                                                         }
                                                    ?>
                                                  <tr style="color:<?php echo  $color;?>;">
                                                   ...
                                                   <?php echo $sub['name']; ?>
                                                    ...
                                                    <td><?php
                                                                echo '<a class="btn" target="_blank" href="'.base_url().'Inquiry/edit/'.encrypt_decrypt('encrypt',$sub['id'])
                                                                ?>
                                                                ">View </a>
                                                               </td>
                                                  </tr>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/sales_qoute_followup.js" type="text/javascript"></script>
        <!-- BEGIN PAGE LEVEL PLUGINS -->
