                        ...
                        <div class="portlet box">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" id="iv_actu_name" name="iv_actu_name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Commited</label>
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" id="iv_comi_name" name="iv_comi_name">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Student Visa (NZ/PLND/SPN)</label>
                                            <label class="control-label col-md-3">Actual</label>
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" id="iv_actu_name" name="iv_actu_name">
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Student Visa Free</label>
                                            <label class="control-label col-md-3">Actual</label>
                                            <div class="col-md-5">
                                                <input type="text" class="form-control" id="iv_actu_name" name="iv_actu_name">
                                            </div>
