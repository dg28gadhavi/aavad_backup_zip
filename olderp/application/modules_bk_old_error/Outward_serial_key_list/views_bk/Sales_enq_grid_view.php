...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        <h1>Sales Inquiry List</h1>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Sales_enq">Sales Inquiry List</a>
                            </li>
                            <li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <form method="get" accept-charset="utf-8" action="<?php echo base_url(); ?>Sales_enq/delete_all">
                                    <div class="table-container">
                                        <div class="table-actions-wrapper">
                                            <span> </span>
                                            <select class="table-group-action-input form-control input-inline input-small input-sm" id="dropdownHolder"  name="sales_enq_isdelete">
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                             <thead>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="vendor_name"> </td>
                                                    <!-- <td>
                                                   ...
                                                   <!--  <td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="phone_no"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="mobile_no"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="inquiry_status"> </td>
                                                    <td>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/sales_enq.js" type="text/javascript"></script>
