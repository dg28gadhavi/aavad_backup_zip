                                      ...
                                      <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-9">
                                                           <input type="text" class="form-control"  name="sqm_to" maxlength="200" id="sqm_to" value="<?php echo isset($lists[0]['sa_email']) ? $lists[0]['sa_email'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
                                ...
                                <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group" id="mcna_namegr">
                                                ...
                                                <div class="col-md-9">
                                                   <input type="text" class="form-control"  name="sqm_sub" maxlength="200" id="sqm_sub" value="<?php echo isset($lists[0]['sale_quotation_sub']) ? $lists[0]['sale_quotation_sub'] : ""; ?>">
                                                </div>
                                            </div>
                                        </div>
                                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-11">
                            <textarea class="form-control ckeditor" name="sqm_body" placeholder="Body" rows="3"><?php echo ($lists[0]['au_signature']); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div id="itmmain1">
                            <div class="col-md-6 col-md-offset-2">
                                <div class="form-group" id="mcna_namegr">
                                    ...
                                    <div class="col-md-9">
                                       <input type="file" class="form-control-file"  name="files[]" maxlength="200" id="sqm_attch" multiple="multiple">

                                    </div>
                                </div>
                            </div>
                        </div>
                     <a class="btn green" href="<?php echo base_url(); ?>Sale_quotation/load_pdf/<?php echo $this->uri->segment(3); ?>.pdf" target="_blank">View PDF</a>
                    </div>
