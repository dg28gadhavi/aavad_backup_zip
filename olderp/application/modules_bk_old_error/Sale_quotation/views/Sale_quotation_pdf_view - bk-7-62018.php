            ...
            <td valign="top" colspan="2" style="width:6cm; border-top:1px solid #e9494f; border-left:1px solid #e41f26; border-right:1px solid #e41f26; border-bottom:1px solid #e41f26; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;">
                <table style="width:100%;border-collapse:collapse;">
                    <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:10px; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:520px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php if(isset($inv['sa_cont_per']) && $inv['sa_cont_per']!=''){echo $inv['sa_cont_per'];}else{echo '';} ?></td>
                    </tr>
                    <tr>
...
<?php //******************not in use start *********** ?>
                    <tr>
                        <td valign="middle" style="border-left: 1px solid #e41f26;border-top:1px solid #e41f26;"></td>
                        <td valign="middle" colspan="2" style="border-left: 1px solid #e41f26;border-top:1px solid #e41f26;"></td>
                        <td valign="middle" colspan="2" style="border-left: 1px solid #e41f26;border-top:1px solid #e41f26;"></td>
                        <td valign="middle" style="border-left: 1px solid #e41f26;border-right: 1px solid #e41f26;border-top:1px solid #e41f26;"></td>
                        <td valign="middle" style="border-left: 1px solid #e41f26;border-top:1px solid #e41f26;"></td>
                        <?php if(isset($inv['sa_isdiscount']) && !empty($inv['sa_isdiscount']) && $inv['sa_isdiscount'] == 1) { ?>
                        <td valign="middle" style="border-left: 1px solid #e41f26;border-top:1px solid #e41f26;"></td>
                        <?php } ?>
                        <?php if(isset($inv['sa_isdiscount']) && !empty($inv['sa_isdiscount']) && $inv['sa_isdiscount'] == 2) { ?>
                        <td colspan="2" valign="middle" style="border-left: 1px solid #e41f26;border-top:1px solid #e41f26;"></td>
                        <?php } else { ?>
                        <td valign="middle" style="border-left: 1px solid #e41f26;border-top:1px solid #e41f26; border-right:1px solid #e41f26;"></td>
                        <?php } ?>
                    </tr>
<?php //******************not in use end *********** ?>
                    <tr>
                        ...
                        <table style="width:18cm;border-collapse:collapse;">
                                <tr>
                                    <td valign="top" style="width:9cm; font-size:13px; float:left; letter-spacing: 1px; text-align:left;"><u><strong><?php if(isset($item['master_item_name']) && $item['master_item_name']!=''){echo wordwrap($item['master_item_name'], 50, "<br />\n");} ?></strong></u><br><strong>Part NO:</strong>&nbsp;<?php if(isset($item['master_item_part_no']) && $item['master_item_part_no']!=''){echo wordwrap($item['master_item_part_no'], 50, "<br />\n");} ?><br><?php if(isset($item['sai_itm_desc']) && $item['sai_itm_desc']!=''){echo nl2br($item['sai_itm_desc']);} ?></td>
                                    <td valign="top" style="padding: 2px; width:3cm;vertical-align: middle; float: left;"> <?php if(isset($item['master_item_img']) && !empty($item['master_item_img'])) { ?><img src="<?php echo base_url(); ?>uploads/master_item_img/<?php echo $item['master_item_img'] ?>" width="100" height="70" alt=""/><?php } ?></td>
                                </tr>
                            </table>
                        </td>
                        <td valign="middle" colspan="2" style="width:1cm;border-left: 1px solid #e41f26;font-size:13px; float:left; letter-spacing: 1px; text-align:center;"><?php echo $item['sai_itm_qty']; ?></td>
                        <td valign="middle" style="width:2cm;border-left: 1px solid #e41f26;font-size:13px; letter-spacing: 1px; text-align:center;"><?php echo number_format($item['sai_itm_price']); ?></td>
                        <td valign="middle" style="border-left: 1px solid #e41f26;font-size:13px; float:left; letter-spacing: 1px; text-align:center;"><?php $subttl = $item['sai_itm_qty'] * number_format($item['sai_itm_price'], 2, '.', '');
                         echo $subttl; ?></td>
                         <?php if(isset($inv['sa_isdiscount']) && !empty($inv['sa_isdiscount']) && $inv['sa_isdiscount'] == 1) { ?>
						<td valign="middle" style="border-left: 1px solid #e41f26;font-size:13px; float:left; letter-spacing: 1px; text-align:center;"><?php echo number_format($item['sai_itm_discount']); ?></td>
                        <?php } ?>
                        <?php if(isset($inv['sa_isdiscount']) && !empty($inv['sa_isdiscount']) && $inv['sa_isdiscount'] == 2) { ?>
                        <td colspan="2" valign="middle" style="border-left: 1px solid #e41f26;border-right: 1px solid #e41f26;font-size:13px; letter-spacing: 1px; text-align:right;"><?php $subtotal =  ($subttl - (($subttl*$item['sai_itm_discount'])/100));
                        echo number_format($subtotal);
                         $finaltotal = $finaltotal + number_format($subtotal, 2, '.', ''); ?></td>
                        <?php $itm_discount = $itm_discount + $item['sai_itm_discount']; ?>
                        <?php } else { ?>
                        <td valign="middle" style="border-left: 1px solid #e41f26;border-right: 1px solid #e41f26;font-size:13px; letter-spacing: 1px; text-align:right;"><?php $subtotal =  ($subttl - (($subttl*$item['sai_itm_discount'])/100));
...
<?php //***************************************** BOM start ********************** ?>
        ...
        <table style="width:100%;border-collapse:collapse; margin:0; padding:0;">
                    ...
                    <tr>
                        <td valign="top" style="text-align:left; border-left:1px solid #e9494f;border-bottom:1px solid #e9494f; font-size:12px;font-family: 'Tahoma'; height: 25px; width: 55%; padding-right: 1%; padding-left: 1%; padding-top: 1%; padding-bottom: 1%; ">
                            <strong style="text-transform: uppercase;">Terms & Conditions:</strong><br>
                            <span style="font-size: 11px;"><?php echo nl2br($inv['sale_quotation_term']); ?></span>
                            
                        </td>
                        <td valign="top" style="border-left:1px solid #e9494f;border-bottom:1px solid #e9494f; border-right: 1px solid #e9494f;font-size:12px;font-family: 'Tahoma'; height: 70px; width: 45%;padding-left: 1%; padding-right: 1%;  padding-top: 1%; padding-bottom: 1%; text-align:LEFT;">
                            <div style="text-transform: uppercase;">GST TIN : 24AAECM7879C1ZB</div><br>
                            ...
                            <div style="color:#e41f26;font-size:13px;">Email : <?php echo $inv['au_email']; ?></div>
