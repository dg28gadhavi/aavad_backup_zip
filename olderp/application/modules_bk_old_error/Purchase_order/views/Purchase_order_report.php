...
<!-- BEGIN BREADCRUMBS -->
    <div class="breadcrumbs bread-title">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="<?php echo base_url(); ?>Purchase_order/Purchase_order_report">Purchase Order Report</a>
            </li>
...
<!-- BEGIN CONTENT -->
<?php echo form_open(base_url().'Purchase_order/Purchase_order_report', array('method'=>'get', 'class' => 'form-horizontal')); ?>           
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                            ...
                                            <thead>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_invoice_no"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="po_completed"> </td>
                                                    <td>
...
<script src="<?php echo base_url(); ?>assets/custom/js/purchase_order_report.js" type="text/javascript"></script>
