...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs bread-title">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="<?php echo base_url(); ?>Work_order_item_list/Work_order_item_list_report">Work Order Report</a>
                            </li>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-offset-3 col-md-9">
                                                            ...
                                                            <a class="btn red" href="<?php echo base_url(); ?>Work_order_item_list/Work_order_item_list_report">RESET</a>
...
<script type="text/javascript">
    ...
    var storeapproved = "<?php echo $this->input->get('storeapproved') ? $this->input->get('storeapproved') : '';?>";
    </script>
<!-- BEGIN PAGE LEVEL PLUGINS -->
