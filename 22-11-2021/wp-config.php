...
define( 'DB_NAME', 'aavadins_newdata' );
/** MySQL database username */
define( 'DB_USER', 'aavadins_newuser' );
/** MySQL database password */
define( 'DB_PASSWORD', '7u=w=J^]9Z?&' );
/** MySQL hostname */
...
define('WP_HOME','https://www.aavadinstrument.com');
define('WP_SITEURL','https://www.aavadinstrument.com');
