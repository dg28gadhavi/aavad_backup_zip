...
define( 'DB_NAME', 'aavad_website' );
/** MySQL database username */
define( 'DB_USER', 'root' );
/** MySQL database password */
define( 'DB_PASSWORD', 'micon123' );
/** MySQL hostname */
...
define('WP_HOME','http://122.170.109.231/aavad_website');
define('WP_SITEURL','http://122.170.109.231/aavad_website');
