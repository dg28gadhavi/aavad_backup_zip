...
class Admin_users_model extends CI_Model {
	...
	public function get_admin_users()
	{
        ...
        if($this->session->userdata('miconlogin') && is_array($this->session->userdata['miconlogin']) && !empty($this->session->userdata['miconlogin']) && isset($this->session->userdata['miconlogin']['typeid']) && (($this->encrypt_decrypt('decrypt',$this->session->userdata['miconlogin']['typeid']) != 3) && ($this->encrypt_decrypt('decrypt',$this->session->userdata['miconlogin']['dep_id']) != 6)))
		{
