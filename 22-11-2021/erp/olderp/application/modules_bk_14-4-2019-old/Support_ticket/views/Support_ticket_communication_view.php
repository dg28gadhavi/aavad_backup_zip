...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Support_ticket">Solution Report</a>
                            </li>
                        </ol>
                        ...
                        <strong><?php echo $this->session->flashdata('success'); echo validation_errors();?></strong>
                        </div></div>
                        </div>
                        <?php } ?>
                    </div>
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title tabbable-line">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase">Solution Details</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                                <div class="form-group" id="mcna_namegr">
                                                    <label class="control-label col-md-4"><strong>No :</strong></label>
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo $list[0]['st_id']; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                                <div class="form-group" id="mcna_namegr">
                                                    <label class="control-label col-md-4"><strong>Company name :</strong></label>
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo $list[0]['st_coname']; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo $list[0]['st_email']; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo $list[0]['st_subject']; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo date('d-m-Y H:i:s',strtotime($list[0]['st_udate'])); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">                                        
                                        <div class="col-md-4">
                                                <div class="form-group" id="mcna_namegr">
                                                    <label class="control-label col-md-4"><strong>Details :</strong></label>
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo $list[0]['st_details']; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                                <div class="form-group" id="mcna_namegr">
                                                    <label class="control-label col-md-4"><strong>Prodect Details :</strong></label>
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo $list[0]['st_prodetails']; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                                <div class="form-group" id="mcna_namegr">
                                                    <label class="control-label col-md-4"><strong>Ticket No:</strong></label>
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo $list[0]['st_ticketno']; ?></label>
                                                </div>
                                            </div>
                                        </div> 
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group" id="mcna_namegr">
                                                <?php if(isset($list[0]['st_status']) && $list[0]['st_status'] == 1){ ?>
                                                <br/><a href="<?php echo base_url(); ?>Support_ticket/close_sts/<?php echo $this->uri->segment(3); ?>"onclick="return confirm('."'Are you sure you want to Close this record?'".')" class="btn btn-sm btn-outline red"><h4>Click here to Close Ticket <i class="fa fa-times"></i></h4></a>
                                                <?php }else{
                                                echo '<h2 style="color:#F00;">Ticket Status : Close</h2>';
                                                } ?>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-lg-12 col-xs-12 col-sm-12">
                                <div class="portlet light bordered">
                                    <div class="portlet-title tabbable-line">
                                        <div class="caption">
                                            <i class="icon-bubbles font-dark hide"></i>
                                            <span class="caption-subject font-dark bold uppercase">Solution</span>
                                        </div>
                                    ...
                                    <div class="portlet-body">
                                    	 <!-- BEGIN: Comments -->
                                                <div class="mt-comments">
                                                    <?php foreach ($chat_list as $key => $value) {
                                                        # code...
                                                    ?>
                                                    <div class="mt-comment">
                                                        <div class="mt-comment-img">
                                                            <img src="<?php echo base_url(); ?>/uploads/au_photo/<?php echo $value['au_photo']  ?>" width="50px" hight="50px" /> </div>
                                                        <div class="mt-comment-body">
                                                            <div class="mt-comment-info">
                                                                <span class="mt-comment-author"><?php echo $value['au_fname'].' '.$value['au_lname']; ?></span>
                                                                <span class="mt-comment-date"><?php echo date('d-F-Y',strtotime($value['stcomm_udate'])); ?></span>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                     <div class="mt-comment-text"><b>Solution :</b> <?php echo $value['stcomm_solution']; ?> </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="mt-comment-text"><b>Client Feedback :</b>  <?php echo $value['stcomm_feedback']; ?> </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="mt-comment-details">
                                                                ...
                                                                <ul class="mt-comment-actions">
                                                                    <li>
                                                                        <a href="<?php echo base_url(); ?>Support_ticket/delete_chat/<?php echo $this->uri->segment(3); ?>?chatid=<?php echo $value['stcomm_id']; ?>&acttype=delete_chat" onclick="return confirm('Are you sure you want to edit this item?');">Delete</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                            ...
                            <div class="col-xs-12 col-md-12 col-lg-12">
                            	<div class="portlet light bordered">
                                    <div class="portlet-title tabbable-line">
                                        <div class="caption">
                                            <i class="icon-bubbles font-dark hide"></i>
                                            <span class="caption-subject font-dark bold uppercase">Add Solution</span>
                                        </div>
                                        </div>
				                                ...
				                                <div class="row">
				                                    <div class="col-md-10">
				                                        <div class="form-group" id="mcna_namegr">
				                                            ...
				                                            <div class="col-md-12">
				                                                <textarea class="form-control" tabindex="5" name="st_solution" placeholder="Pls.Enter Solution" id="st_solution" rows="3"></textarea>
				                                            </div>
				                                        </div>
				                                    </div>
                                                    <div class="col-md-10">
                                                        <div class="form-group" id="mcna_namegr">
                                                            ...
                                                            <div class="col-md-12">
                                                                <textarea class="form-control" tabindex="5" name="st_clientfeedback" placeholder="Pls.Enter Client Feedback" id="st_clientfeedback" rows="3"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-10">
                                                        <div class="form-group" id="mcna_namegr">
                                                            ...
                                                            <div class="col-md-9">
                                                                <select name="st_sendemail" id="st_sendemail" tabindex="22" class="form-control bs-select">
				                                		...
				                                		<div class="form-actions"> 
    				                                        <div class="row">
    				                                            <div class="col-md-offset-7 col-md-5">
    				                                                <button type="submit" tabindex="24" class="btn green" onclick="return ValidateDetails()" >Send</button>
    				                                            </div>
    				                                        </div>
				                                        </div>
				                                    </div>
