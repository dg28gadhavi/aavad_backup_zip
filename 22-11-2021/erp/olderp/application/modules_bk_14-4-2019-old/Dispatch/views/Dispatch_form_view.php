...
<!-- BEGIN BREADCRUMBS -->
        <div class="breadcrumbs">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url(); ?>Dispatch/add">Dispatch Add</a></li>
            </ol>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-7">
                                               <input type="text" tabindex="2" class="form-control vendor" placeholder="Party Name" name="vendor" maxlength="100" id="vendor" value="<?php echo isset($list[0]['vendor']) ? $list[0]['vendor'] : ""; ?>" required="required">
                                            </div>
                                            <div class="col-md-2">
                                                <a class="btn red" href="<?php echo base_url(); ?>Dispatch/add">RESET</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">                                    
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                 <input type="text" tabindex="7" class="form-control form-control-inline input-medium date-picker" placeholder="Po Date" name="dis_po_date" maxlength="200" id="dis_po_date" value="<?php echo isset($list[0]['dis_po_date']) ? date("d-m-Y", strtotime($list[0]['dis_po_date'])) : ""; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>       
                                <div class="row">                                    
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                 <input type="text" tabindex="9" class="form-control form-control-inline input-medium date-picker" placeholder="Date" name="dis_docket_date" maxlength="200" id="dis_docket_date" value="<?php echo isset($list[0]['dis_docket_date']) ? date("d-m-Y", strtotime($list[0]['dis_docket_date'])) : ""; ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="10" class="form-control" placeholder="W/O Number / Job Card No." name="dis_job_cno" maxlength="100" id="dis_job_cno" value="<?php echo isset($list[0]['dis_job_cno']) ? $list[0]['dis_job_cno'] : ""; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                <button type="submit" tabindex="14" class="btn green" onclick="return ValidateDetails()" ><?php echo $this->input->get('id')?'UPDATE':'Start'; ?></button>
                                            </div>
                                        </div>
                                    </div>
    ...
    $(document).ready(function () {
        ...
        $('#country_change').change(function () {
            //alert($(this).val()+'aaaaaaaaaaaaaaaaaaaaaaa');
                ...
                type:'POST',
                datatype: 'JSON',
                url:'<?php echo base_url(); ?>Dispatch/get_country_to_state',
        ...
        $('#state_change').change(function () {
            //alert($(this).val()+'aaaaaaaaaaaaaaaaaaaaaaa');
                ...
                type:'POST',
                datatype: 'JSON',
                url:'<?php echo base_url(); ?>Dispatch/get_state_to_city',
...
function sub_cat(i)
{
    var data = { 'id': i.value};
        $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>Dispatch/getsub_category",
        data: data,
        dataType:"json",
...
<script>
  $( function() {
    $("#vendor").autocomplete({
            source: base_url+"Dispatch/get_customer_information",
            minLength: 1,
            html: true,
