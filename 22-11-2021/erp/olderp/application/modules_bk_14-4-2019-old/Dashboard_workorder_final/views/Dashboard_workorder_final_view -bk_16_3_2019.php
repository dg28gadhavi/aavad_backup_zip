                ...
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingOne">
                        <h4 class="panel-title">
                            <a class="" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $work_order['wo_id']; ?>" aria-expanded="true" aria-controls="collapse<?php echo $work_order['wo_id']; ?>">
                                <?php echo $work_order['wo_wo_no']; ?>
                            </a>
                        </h4>
                    </div>
                    <div id="collapse<?php echo $work_order['wo_id']; ?>" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
										...
										<tr id="idemo<?php echo $items['woi_id']; ?>" class="collapse idemo<?php echo $items['woi_id']; ?> opennext">
										 	<td colspan="8">
								                ...
								                <ul class="nav nav-tabs" role="tablist">
								                    <li role="presentation" class="active"><a href="#Section1" class="sales-tbg" aria-controls="home" role="tab" data-toggle="tab">1 Sales</a></li>
								                    <li role="presentation"><a href="#Section2" class="admin-tbg" aria-controls="profile" role="tab" data-toggle="tab">2 Admin</a></li>
								                    <li role="presentation"><a href="#Section3" class="sm-tbg" aria-controls="settings" role="tab" data-toggle="tab">3 Sales Manager</a></li>
								                    <li role="presentation"><a href="#Section4" class="pm-tbg" aria-controls="settings" role="tab" data-toggle="tab">4 Production Manager</a></li>
								                    <li role="presentation"><a href="#Section5" class="production-tbg" aria-controls="settings" role="tab" data-toggle="tab">5 Production</a></li>
								                    <li role="presentation"><a href="#Section6" class="account-tbg" aria-controls="settings" role="tab" data-toggle="tab">6 Account</a></li>
								                    <li role="presentation"><a href="#Section7" class="production-tbg" aria-controls="settings" role="tab" data-toggle="tab">7 Production</a></li>
								                    <li role="presentation"><a href="#Section8" class="dispatch-tbg" aria-controls="settings" role="tab" data-toggle="tab">8 Dispatch</a></li>
								                </ul>
								                <!-- Tab panes -->
								                <div class="tab-content">
								                    ...
								                    <div role="tabpanel" class="tab-pane fade" id="Section4">
								                        <p>
								                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus pretium, metus et scelerisque dignissim, ligula est imperdiet nisl, sit amet malesuada nunc felis in nisi.
								                        </p>
								                    </div>
								                    <div role="tabpanel" class="tab-pane fade" id="Section5">
								                        <p>
								                            Phasellus pretium, metus et scelerisque dignissim, ligula est imperdiet nisl, sit amet malesuada nunc felis in nisi. Nullam dapibus ligula dui, in rhoncus purus euismod nec.
								                        </p>
								                    </div>
								                    <div role="tabpanel" class="tab-pane fade" id="Section6">
								                        <p>
								                            Phasellus pretium, metus et scelerisque dignissim, ligula est imperdiet nisl, sit amet malesuada nunc felis in nisi. Nullam dapibus ligula dui, in rhoncus purus euismod nec. Duis in lacinia neque. Etiam tellus.
								                        </p>
								                    </div>
								                    <div role="tabpanel" class="tab-pane fade" id="Section7">
								                        <p>
								                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus pretium, metus et scelerisque dignissim, ligula est imperdiet nisl, sit amet malesuada nunc felis in nisi. Nullam dapibus ligula dui, in rhoncus purus euismod nec.
								                        </p>
								                    </div>
