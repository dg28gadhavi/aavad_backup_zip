...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>Oa/send_mail">mail Add</a>
                            </li>
                        </ol>
                                      ...
                                      <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-9">
                                                           <input type="text" class="form-control"  name="oam_to" maxlength="200" id="oam_to" value="<?php echo isset($lists[0]['oa_email']) ? $lists[0]['oa_email'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
                                         <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-9">
                                                           <input type="text" class="form-control"  name="oam_to_cc" maxlength="200" id="oam_to_cc" value="<?php echo isset($list[0]['oam_to_cc']) ? $list[0]['oam_to_cc'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
                                <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group" id="mcna_namegr">
                                                ...
                                                <div class="col-md-9">
                                                   <input type="text" class="form-control"  name="oam_sub" maxlength="200" id="oam_sub" value="<?php echo isset($list[0]['oam_sub']) ? $list[0]['oam_sub'] : ""; ?>">
                                                </div>
                                            </div>
                                        </div>
                                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-11">
                            <textarea class="form-control" name="oam_body" placeholder="Body" id="summernote_1" rows="3"><?php echo $lists[0]['au_signature']; ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="itmmain1">
                        <div class="col-md-6 col-md-offset-2">
                            <div class="form-group" id="mcna_namegr">
                                ...
                                <div class="col-md-9">
                                   <input type="file" class="form-control-file"  name="files[]" maxlength="200" id="oam_attch" multiple="multiple">
                                </div>
                            </div>
                        </div>
                    </div>
