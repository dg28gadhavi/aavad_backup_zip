...
<div class="row">
    ...
    <div class="breadcrumbs breadcrumbs-header">
        ...
        <?php $id = $this->uri->segment(3); ?>
            <a class="btn green" href="<?php echo base_url(); ?>pdf/po/po<?php echo $this->uri->segment(3); ?>.pdf" target="_blank">View PDF</a>
            <?php $id = $this->uri->segment(3); ?>
                        ...
                        <div class="portlet box blue">     
                            ...
                            <div class="portlet-body">
                                ...
                                <?php //$tabono = $this->session->userdata('tabno') ? $this->session->userdata('tabno') : 0; ?>
                                            ...
                                            <li class="<?php if(isset($tabno) && ($tabno == 3 || $tabno == 0)) { ?> active <?php } ?>">
                                            ...
                                            <div class="tab-pane fade <?php if(isset($tabno) && ($tabno == 3 || $tabno == 3)) { ?> active in <?php } ?>" id="tab_2_3">
