...
class inquiry_type extends CI_Controller {
	...
	public function index()
	{
		...
		{
			$this->session->set_flashdata('rights_error', "You Don't have rights to access Inquiry Type VIew functionality");
			redirect(base_url());
		}
	...
	public function ajax()
	{
		...
		if($right_status == false)
		{
			...
			$editstr = '<a href="'.base_url().'Inquiry_type/edit/'.$idenc.'" class="btn btn-sm btn-outline green"><i class="fa fa-search"></i> Edit</a>';
		}
		...
		if($right_status == false)
		{
			...
			$deletestr = '<a href="'.base_url().'Inquiry_type/delete/'.$idenc.'"onclick="return confirm('."'Are you sure you want to Delete this record?'".')" class="btn btn-sm btn-outline red"><i class=""></i> Delete</a>';
		}
		$records["data"][] = array(
	...
	public function edit($id = FALSE)
	{
		...
		if($right_status == false)
		{
			$this->session->set_flashdata('rights_error', "You Don't have rights to access Inquiry Type Edit functionality");
			redirect(base_url());
		}
	...
	public function delete($id=false)
	{
		...
		if($right_status == false)
		{
			$this->session->set_flashdata('rights_error', "You Don't have rights to access Inquiry Type functionality");
			redirect(base_url());
		}
