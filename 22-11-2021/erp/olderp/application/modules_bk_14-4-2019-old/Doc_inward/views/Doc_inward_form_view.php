                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <select name="doc_inward_partyid" tabindex="18" id="doc_inward_partyid" class="bs-select form-control doc_inward_partyid" data-live-search="true" data-size="8" required="">
                                                    ...
                                                    <?php  foreach($vendors as $vendor) { ?>
                                                      <option value="<?php echo $vendor['master_party_id'];?>" <?php if(isset($list[0]['doc_inward_partyid']) && $list[0]['doc_inward_partyid'] == $vendor['master_party_id']){ echo "selected"; }  ?> > <?php echo $vendor['master_party_name']; ?> 
                                                    </option>
                                                <?php } ?> 
                                                </select>
                                            </div>
