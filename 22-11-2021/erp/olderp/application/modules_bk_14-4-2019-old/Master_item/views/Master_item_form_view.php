                                    ...
                                    <div class="col-md-3">
                                      ...
                                      <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                 ...
                                                 <select multiple="multiple" class="multi-select"  id="my_multi_select1" name="master_item_heads[]"  required >

                                                  <?php foreach($item_heads as $item_head) { ?>

                                                <option value="<?php echo $item_head['item_head_id'];?>"
                                                    <?php

                                                    if(isset($list[0]['master_item_heads']) && $list[0]['master_item_heads'] != '') 
                                                    {

                                                      $aud_homenames = json_decode($list[0]['master_item_heads']); 

                                                    foreach($aud_homenames as $aud_homename){

                                                    if(isset($aud_homename) && $aud_homename == $item_head['item_head_id']){ echo "selected";} } }?>>

                                                    <?php echo $item_head['item_head_name']; ?>
                                                </option>
