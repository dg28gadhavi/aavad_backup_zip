...
class Master_item extends CI_Controller {
	...
	{
		//die;
		//$this->master_item_model->test_product();
		$this->master_item_model->test_product_simple();
		//$this->master_item_model->generate_stock();
	}

	public function test_user()
	{
		die;
		$this->master_item_model->test_user();
		//$this->master_item_model->test_product_simple();
		//$this->master_item_model->generate_stock();
	}
	...
	{
		die;
		$this->master_item_model->test_user_without_email();
		//$this->master_item_model->test_product_simple();
		//$this->master_item_model->generate_stock();
	}
	...
	{
		die;
		$this->master_item_model->test_user_address();
		//$this->master_item_model->test_product_simple();
		//$this->master_item_model->generate_stock();
	}
	...
	{
		//die;
		$this->master_item_model->test_user_address_without_email();
		//$this->master_item_model->test_product_simple();
		//$this->master_item_model->generate_stock();
	}
