...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs bread-title">
                        <h1>Dispatch_mgmt List</h1>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Dispatch_mgmt">Dispatch_mgmt Report</a>
                            </li>
                        </ol>
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <?php
                                    $atr = array("method" => "get");
                                     echo form_open(base_url()."Dispatch_mgmt/Dispatch_mgmttopo",$atr);?>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/dispatch_mgmt_report.js" type="text/javascript"></script>
