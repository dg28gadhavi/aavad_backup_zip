...
<!-- BEGIN BREADCRUMBS -->
            <div class="breadcrumbs bread-title">
                <h1>Production Manager List</h1>
                <ol class="breadcrumb">
                    <li>
                        <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                    </li>
                    <li class="active">
                        <a href="<?php echo base_url(); ?>Production_manager">Production Manager Report</a>
                    </li>
                </ol>
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <?php
                                    $atr = array("method" => "get");
                                     echo form_open(base_url()."Production_manager/Production_managertopo",$atr);?>
...
<script src="<?php echo base_url(); ?>assets/custom/js/production_manager_report.js" type="text/javascript"></script>
