            ...
            <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" id="mcna_namegr">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" tabindex="63" placeholder="PRICES" name="sa_tc_price" maxlength="200" id="sa_tc_price" value="<?php echo isset($list[0]['sa_tc_price']) ? $list[0]['sa_tc_price'] : ""; ?><?php if(isset($list[0]['sa_tc_price']) && $list[0]['sa_tc_price'] == '') { ?>F.O.R. (Ahmedabad)<?php } ?>">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" id="mcna_namegr">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" tabindex="64" placeholder="WARRANTY" name="sa_tc_wrnty" maxlength="200" id="sa_tc_wrnty" value="<?php echo isset($list[0]['sa_tc_wrnty']) ? $list[0]['sa_tc_wrnty'] : ""; ?><?php if(isset($list[0]['sa_tc_wrnty']) && $list[0]['sa_tc_wrnty'] == '') { ?>12 months from the date of supply against any Mfg. Defects.<?php } ?>">
                        </div>
                    </div>
                </div>
            </div>
             <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" id="mcna_namegr">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" tabindex="65" placeholder="P&F" name="sa_tc_pf" maxlength="200" id="sa_tc_pf" value="<?php echo isset($list[0]['sa_tc_pf']) ? $list[0]['sa_tc_pf'] : ""; ?><?php if(isset($list[0]['sa_tc_pf']) && $list[0]['sa_tc_pf'] == '') { ?>NIL<?php } ?>">
                        </div>
                    </div>
                </div>
            </div>
             <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" id="mcna_namegr">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" tabindex="66" placeholder="DELIVERY" name="sa_tc_deli" maxlength="200" id="sa_tc_deli" value="<?php echo isset($list[0]['sa_tc_deli']) ? $list[0]['sa_tc_deli'] : ""; ?><?php if(isset($list[0]['sa_tc_deli']) && $list[0]['sa_tc_deli'] == '') { ?>Within 2-3 days from the date of technically clear and Conﬁrm PO<?php } ?>">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" id="mcna_namegr">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" tabindex="67" placeholder="PAYMENT" name="sa_tc_paynt" maxlength="200" id="sa_tc_paynt" value="<?php echo isset($list[0]['sa_tc_paynt']) ? $list[0]['sa_tc_paynt'] : ""; ?><?php if(isset($list[0]['sa_tc_paynt']) && $list[0]['sa_tc_paynt'] == '') { ?>100% Advance (Against Proforma Invoice)<?php } ?>">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                  <div class="col-md-6">
                    <div class="form-group" id="mcna_namegr">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" tabindex="68" placeholder="OFFER VALIDITY" name="sa_tc_ovali" maxlength="200" id="sa_tc_ovali" value="<?php echo isset($list[0]['sa_tc_ovali']) ? $list[0]['sa_tc_ovali'] : ""; ?><?php if(isset($list[0]['sa_tc_ovali']) && $list[0]['sa_tc_ovali'] == '') { ?>30 days from the date of this quote<?php } ?>">
                        </div>
                    </div>
                </div>
            </div>
