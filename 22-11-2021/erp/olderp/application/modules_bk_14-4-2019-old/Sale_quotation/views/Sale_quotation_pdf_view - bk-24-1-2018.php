...
<?php //******************not in use end *********** ?>
                    <tr>
                        ...
                        <td valign="top" colspan="2" style="border-left: 2px solid #4e80bc;font-size:12px; float:left; letter-spacing: 1px; text-align:left;"><strong><?php echo $item['master_item_name'] ?><?php echo $item['master_item_pno'] ?></strong><br/><?php echo nl2br($item['sai_itm_desc']); ?></td>
                        ...
                        <td valign="top" style="border-left: 2px solid #4e80bc;border-right: 2px solid #4e80bc;font-size:12px; letter-spacing: 1px; text-align:center;"><?php echo number_format($item['sai_itm_ftotal'], 2, '.', ''); ?></td>
                    </tr>
                    <?php foreach($item['taxar'] as $taxd)
					{ ?>
...
<?php //******************not in use start *********** ?>
                    <tr>
                        ...
                        <td style="border-left: 2px solid #4e80bc;border-bottom:2px solid #4e80bc;"></td>
                        <?php /*?><td style="border-left: 2px solid #4e80bc;border-bottom:2px solid #4e80bc;"></td><?php */?>
                        <td colspan="2" style="border-left: 2px solid #4e80bc;border-bottom:2px solid #4e80bc;"></td>
                        <td style="border-left: 2px solid #4e80bc;border-bottom:2px solid #4e80bc;"></td>
                        <td style="border-left: 2px solid #4e80bc;border-bottom:2px solid #4e80bc;"></td>
                        <td style="border-left: 2px solid #4e80bc;border-bottom:2px solid #4e80bc;"></td>
...
<?php //***************************************** BOM start ********************** ?>
                   ...
                   <!-- <tr>
                        <td colspan="5" style="border-right:2px solid #4e80bc;border-left:2px solid #4e80bc;border-bottom:2px solid #4e80bc;font-family: 'Arial Black', Gadget, sans-serif;font-size:14px; text-align:left;"><?php //echo $inv['sa_grd_ttl_words'] ?></td>
