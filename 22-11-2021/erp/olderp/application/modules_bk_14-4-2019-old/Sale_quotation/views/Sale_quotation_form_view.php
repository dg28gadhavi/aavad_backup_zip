                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-9">
                                                        <textarea class="form-control" tabindex="4" name="sa_address" placeholder="Customer Address" id="sa_address" rows="3"><?php echo isset($list[0]['sa_address']) ? $list[0]['sa_address'] : ""; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                           <input type="text" tabindex="9" class="form-control" placeholder="Contact Person" name="sa_con_person" maxlength="100" id="sa_con_person" value="<?php echo isset($list[0]['sa_cont_per']) ? $list[0]['sa_cont_per'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                  <div class="col-md-6">
                                                    <div class="form-group" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-9">
                                                            <input type="text" tabindex="10" class="form-control" placeholder="Mobile No" name="sa_mobile" maxlength="200" id="sa_mobile" value="<?php echo isset($list[0]['sa_mobile']) ? $list[0]['sa_mobile'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-9">
                                                           <input type="text" tabindex="11" class="form-control" placeholder="Email Id" name="sa_email" maxlength="100" id="sa_email" value="<?php echo isset($list[0]['sa_email']) ? $list[0]['sa_email'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <select name="sa_inq_by" id="sa_inq_by" tabindex="17" class="form-control itmchange bs-select" data-live-search="true" data-size="8">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-9">
                                                            <select name="sa_inq_st" id="sa_inq_st" tabindex="21" class="form-control bs-select" data-live-search="true" data-size="8">
