                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                <select name="sq_cust_type" id="sq_cust_type" class="bs-select form-control itmchange" data-live-search="true" data-size="8" tabindex="4">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                            <textarea class="form-control" tabindex="5" name="sq_address" placeholder="Customer Address" id="sq_address" rows="3"><?php echo isset($list[0]['sq_address']) ? $list[0]['sq_address'] : ""; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="10" class="form-control" placeholder="Contact Person" name="sq_con_person" maxlength="100" id="sq_con_person" value="<?php echo isset($list[0]['sq_con_person']) ? $list[0]['sq_con_person'] : ""; ?>">
                                            </div>
                                        </div>
                                    </div>
                                      <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" tabindex="11" class="form-control" placeholder="Mobile No" name="sq_mobile" maxlength="200" id="sq_mobile" value="<?php echo isset($list[0]['sq_mobile']) ? $list[0]['sq_mobile'] : ""; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>                                    
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="12" class="form-control" placeholder="Email Id" name="sq_email" maxlength="100" id="sq_email" value="<?php echo isset($list[0]['sq_email']) ? $list[0]['sq_email'] : ""; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <select name="sq_end_st" tabindex="18" id="sq_end_st" class="bs-select form-control itmchange" data-live-search="true" data-size="8">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                 <select name="sq_inq_sts" id="sq_inq_sts" tabindex="22" class="form-control bs-select">
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                <select name="sq_inq_priority" id="sq_inq_priority" tabindex="23" class="form-control bs-select">
                                ...
                                <div class="row">
                                     <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                <?php $uid = encrypt_decrypt('decrypt', $this->session->userdata['miconlogin']['userid']); ?>
                                                <select name="sq_allotedto" tabindex="26" id="sq_allotedto" class="bs-select form-control itmchange" data-live-search="true" data-size="8">
                                                    <option value="0">Select</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                <button type="submit" tabindex="28" class="btn green" onclick="return ValidateDetails()" ><?php echo $this->input->get('id')?'UPDATE':'Start'; ?></button>
                                            </div>
                                        </div>
                                    </div>
