...
<?php //******************not in use start *********** ?>
                    <tr>
                        ...
                        <td valign="top" style="border-left: 1px solid #e9494f;border-top:1px solid #e9494f;"></td>
                        <?php if(isset($inv['pi_isdiscount']) && !empty($inv['pi_isdiscount']) && $inv['pi_isdiscount'] == 2) { ?>
                        <td colspan="3" valign="top" style="border-top:1px solid #e9494f;"></td>   
                        <?php } else { ?>  
...
<?php //******************not in use end *********** ?>
                    <tr>
                        ...
                        <td valign="middle" colspan="2" style="border-left: 1px solid #e9494f;font-size:12px; float:left; letter-spacing: 1px; text-align:left;padding-left: 5px;"><strong><?php echo $item['pii_itm_title']; ?></strong><br>Part No:<?php echo $item['pii_itm']; ?><br/><?php echo nl2br($item['pii_itm_desc']); ?></td>
                        ...
                        <?php } ?>
                        <?php if(isset($inv['pi_isdiscount']) && !empty($inv['pi_isdiscount']) && $inv['pi_isdiscount'] == 2) { ?>
                        <td colspan="3" valign="middle" style="border-left: 1px solid #e9494f;font-size:12px; float:left; letter-spacing: 1px; text-align:center;"><?php $subttl = $item['pii_itm_qty'] * number_format($item['pii_itm_price'], 2, '.', '');
                         echo ($subttl); ?></td> 
                        ...
                        <td colspan="2" valign="middle" style="border-left: 1px solid #e9494f;font-size:12px; letter-spacing: 1px; text-align:right;"><?php 
...
<?php //***************************************** BOM start ********************** ?>
                    ...
                    <tr>
                            <td valign="top" style="border-top: 1px solid #e9494f;border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; color:#000; "></td>
                            <td colspan="2" valign="top" style="border-top: 1px solid #e9494f;border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:left; color:#000;"><strong>P & F</strong></td>
                            <td valign="top" style="border-top: 1px solid #e9494f;border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; color:#000;"><?php echo $inv['pi_hsncode'] ?></td>
                            <td valign="top" style="border-top: 1px solid #e9494f;border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#000;"></td>
                            <td valign="top" style="border-top: 1px solid #e9494f;border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#000;"></td>
                            <td valign="top" style="border-top: 1px solid #e9494f;border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#000;"></td>
                            <td colspan="2" valign="top" style="border-top: 1px solid #e9494f;border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; color:#000;"><?php echo number_format($inv['pi_taxbleamount'], 2, '.', ''); ?></td>
                            <?php $withouttax = $withouttax + $inv['pi_taxbleamount']; ?>     
                            <td valign="top" style="border-top: 1px solid #e9494f;border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; color:#000;"><?php echo number_format($inv['pi_pfgst'], 2, '.', ''); ?></td>
                            <td valign="top" style="border-top: 1px solid #e9494f;border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:center; color:#000;"><?php echo number_format($inv['pi_taxamount'], 2, '.', ''); ?></td>
                            <?php $onlytax = $onlytax + $inv['pi_taxamount']; ?>
                            <td colspan="2" valign="top" style="border-top: 1px solid #e9494f;border-bottom: 1px solid #e9494f; border-left: 1px solid #e9494f; font-size:12px; float:left; letter-spacing: 1px; text-align:right; color:#000;"><?php echo number_format($inv['pi_grandtotal'], 2, '.', ''); ?></td>
                   ...
                   <!--  <tr>
                    ...
                    <?php  $disc = $finaltotal - (($itm_discount * $finaltotal)/100); } else { $disc = $finaltotal; } */ ?>
                     <tr>
                        ...
                        <td height="25" colspan="2" style="border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:12px; text-align:right;background-color:#fad1d3;"><strong><?php echo number_format($gtotal, 2, '.', ''); ?></strong></td>
                        <?php /*?><td style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;"></td><?php */?>
                    </tr>
                    <tr>
                        <?php// $disc = $finaltotal - (($itm_discount * $finaltotal)/100); ?>
