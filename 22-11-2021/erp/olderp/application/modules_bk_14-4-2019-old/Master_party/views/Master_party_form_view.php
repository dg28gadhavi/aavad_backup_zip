                                            ...
                                            <div class="row">
                                            	<div class="col-md-4">
                                                    <div class="form-group" id="master_party_phonegr">
                                                        ...
                                                        <div class="col-md-8">
                                                           <select name="master_party_country" tabindex="7" id="master_party_country" class="bs-select form-control" data-live-search="true" data-size="8">
                                                ...
                                                <div class="col-md-4">
                                                 ...
                                                 <div class="col-md-4">
                                                    <div class="form-group" id="master_party_stategr">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select name="master_party_state" tabindex="9" class="bs-select form-control" data-live-search="true" data-size="8" id="master_party_state" onchange="get_area(this.value)" >
                                                                <option value="">Select State</option>
                                            ...
                                            <div class="row">
                                            	<div class="col-md-4">
                                                    <div class="form-group" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="text" tabindex="10" class="form-control" placeholder="Area" name="master_party_area" maxlength="70" id="master_party_area" value="<?php echo isset($list[0]['master_party_area']) ? $list[0]['master_party_area'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>      
                                                <div class="col-md-4">
