...
class Admin_type extends CI_Controller {
	...
	public function ajax()
	{
		...
		$records["data"][] = array(
			  ...
			  ''.$user[$i]['adt_name'],
			  '<a href="'.base_url().'Admin_type/edit/'.$idenc.'" class="btn btn-sm btn-outline green"><i class="fa fa-pencil"></i></a>
			  <a href="'.base_url().'Admin_type/delete/'.$idenc.'"onclick="return confirm('."'Are you sure you want to Delete this record?'".')" class="btn btn-sm btn-outline red"><i class="fa fa-times"></i></a>',
		);
		}
