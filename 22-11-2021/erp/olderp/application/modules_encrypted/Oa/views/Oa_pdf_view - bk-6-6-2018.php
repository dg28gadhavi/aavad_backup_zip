                ...
                <div style="width:98%; margin-top:0;">
                    ...
                    <table style="width:100%;border-collapse:collapse;">
                        ...
                        <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:200px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo nl2br($inv['oa_address']); ?></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:10px; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:200px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo $inv['oa_mobile']; ?></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:10px; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:200px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo nl2br($inv['oa_email']); ?></td>
                        </tr>
	   ...
	   <!-- <div style="width:100%;">CH A    :</div></td> -->
            <td valign="top" style="width:5cm;border-top:1px solid #e9494f; border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;border-right:1px solid #e9494f; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;">
                <div style="width:98%; margin-top:0;">
                    ...
                    <table style="width:100%;border-collapse:collapse;">
                        <tr>
                            <td valign="top" style=" width:90px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><strong>PO No.</strong><span style="text-align:right !important;"></span></td>
                            <td valign="top" style=" width:10px; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style=" width:200px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo $inv['oa_no'] ?></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:10px; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:200px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo date("d-m-Y", strtotime($inv['oa_enq_date'])); ?></td>
                        </tr>
                        </table>
                </div>
            </td>
          ...
          <tr>
            <td valign="top" colspan="2" style="width:6cm; border-top:1px solid #e9494f; border-left:1px solid #e41f26; border-right:1px solid #e41f26; border-bottom:1px solid #e41f26; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;">
                <table style="width:100%;border-collapse:collapse;">
                    <tr>
                            <td valign="top" style="width:40px; font-size:11px; float:left; letter-spacing: 1px; text-align:left; padding-top:5px;"><strong>Kind attn</strong><span style="text-align:right !important;"></span></td>
                            <td valign="top" style="padding-top:5px; width:10px; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:540px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php if(isset($inv['oa_con_person']) && $inv['oa_con_person']!=''){echo $inv['oa_con_person'];}else{echo '';} ?></td>
                    </tr>
                    <tr>
                            <td valign="top" style="width:40px; font-size:11px; float:left; letter-spacing: 1px; text-align:left; padding-top:5px;"><strong> Sub</strong><span style="text-align:right !important;"></span></td>
                            <td valign="top" style="padding-top:5px; width:10px; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:540px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php if(isset($inv['oa_subject']) && $inv['oa_subject']!=''){echo $inv['oa_subject'];}else{echo '';} ?></td>
                    </tr>        
                </table>
...
<?php //******************not in use end *********** ?>
                    <tr>
                        <td valign="middle" style="border-left: 1px solid #e9494f;font-size:11.5px; letter-spacing: 1px; text-align:center;"><?php echo $srno; ?></td>
                        <td colspan="2" valign="middle" style="border-left: 1px solid #e9494f;font-size:11.5px; float:left; letter-spacing: 1px; text-align:left;"><strong><u><?php echo $item['master_item_name']; ?></u></strong><br>Part NO:<?php echo $item['master_item_part_no']; ?><br/><?php echo nl2br($item['master_item_description']); ?></td>
                        <td valign="middle" style="border-left: 1px solid #e9494f;font-size:11.5px; float:left; letter-spacing: 1px; text-align:center;"><?php echo $item['oai_itm_qty']; ?></td>
                        <td valign="middle" style="border-left: 1px solid #e9494f;font-size:11.5px; letter-spacing: 2px; text-align:center;"><?php echo number_format($item['oai_itm_price']); ?></td>
                        <td valign="middle" style="border-left: 1px solid #e9494f;font-size:11.5px; float:left; letter-spacing: 1px; text-align:center;"><?php $subttl = $item['oai_itm_qty'] * number_format($item['oai_itm_price']);
                         echo $subttl; ?></td>                         
						<td valign="middle" style="border-left: 1px solid #e9494f;font-size:11.5px; float:left; letter-spacing: 1px; text-align:center;"><?php echo number_format($item['oai_itm_discount']); ?></td>                        
                        <td colspan="2" valign="middle" style="border-left: 1px solid #e9494f;border-right: 1px solid #e9494f;font-size:11.5px; letter-spacing: 1px; text-align:right;"><?php $subtotal =  ($subttl - (($subttl*$item['oai_itm_discount'])/100));
...
<?php //***************************************** BOM start ********************** ?>
                   ...
                   <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="5" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:13px; text-align:left;"><?php //echo $inv['oa_grd_ttl_words'] ?></td>
                        <td colspan="2" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:13px; text-align:right;background-color:#fad1d3;"><strong>TOTAL Discount</strong></td>
                        <td colspan="2" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:13px; text-align:right;background-color:#fad1d3;"><strong><?php echo number_format($totaldisc); ?></strong></td>
                        <?php /*?><td style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;"></td><?php */?>
                    </tr>
                    <?php  $disc = $finaltotal - (($itm_discount * $finaltotal)/100); } else { $disc = $finaltotal; } ?>
                     <tr>
                        <?php// $disc = $finaltotal - (($itm_discount * $finaltotal)/100); ?>
                        <td colspan="5" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:13px; text-align:left;"><?php //echo $inv['oa_grd_ttl_words'] ?></td>
                        <td colspan="2" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:13px; text-align:right;background-color:#fad1d3;"><strong>TOTAL</strong></td>
                        <td colspan="2" style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;font-family: 'Arial Black', Gadget, sans-serif;font-size:13px; text-align:right;background-color:#fad1d3;"><strong><?php echo number_format($disc); ?></strong></td>
                        <?php /*?><td style="border-right:1px solid #e9494f;border-left:1px solid #e9494f;border-bottom:1px solid #e9494f;"></td><?php */?>
                    </tr>
                    <!-- <tr>
                    ...
                    <tr>
                        <td valign="top" colspan="6" rowspan="<?php echo $rowspan; ?>" style="text-align:top; font-size:11.8px;font-family: 'Arial Black', Gadget, sans-serif; padding-right: 1%; padding-left: 1%;border-bottom:1px solid #e9494f; ">
    	...
    	<table style="width:100%;border-collapse:collapse; margin:0; padding:0;">
                    ...
                    <tr>
                        <td valign="top" style="text-align:left; border-left:1px solid #e9494f;border-bottom:1px solid #e9494f; font-size:12px;font-family: 'Tahoma'; height: 70px; width: 38%; padding-right: 1%; padding-left: 1%; padding-top: 1%; padding-bottom: 1%; ">
