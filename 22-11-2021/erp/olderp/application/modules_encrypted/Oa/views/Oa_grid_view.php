                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <div class="portlet-body">
                                    ...
                                    $atr = array("method" => "get");
                                     echo form_open(base_url()."Oa/oatopi",$atr);?>
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                             <thead>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <!-- <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="dtlofitm"> </td>   -->  
                                                   <!--  <td>
                                                    ...
                                                    <td>
                                                        <!-- <input type="text" class="form-control form-filter input-sm" name="remark"> --><select class="form-control form-filter input-sm" name="status">
