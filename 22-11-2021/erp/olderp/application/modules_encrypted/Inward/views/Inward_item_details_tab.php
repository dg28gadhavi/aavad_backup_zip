        ...
        <div class="row">
                ...
                <div class="form-group" id="mcna_namegr">
                    ...
                    <div class="col-md-9">
                       <!--  <input type="text" tabindex="32" class="form-control" placeholder="Unit" name="inwi_unit" maxlength="200" id="inwi_unit" value="<?php echo isset($edit_items['inwi_unit']) ? $edit_items['inwi_unit'] : 0; ?>"> -->
                        <select name="inwi_unit" id="inwi_unit" tabindex="20" class="form-control bs-select" data-live-search="true" data-size="8"  onchange="sub_cat(this)">
                     <option value="0">Select Currency</option>
                    <?php foreach($units as $unit)
                    { ?>
                            <option value="<?php echo $unit['master_item_unit_id']; ?>" <?php if(isset($edit_items['inwi_unit']) && $edit_items['inwi_unit'] == $unit['master_item_unit_id']){ echo "selected";} ?>> <?php echo $unit['master_item_unit_name']; ?>
                            </option>                                                    
                    <?php }?>
                </select>
                    </div>
            ...
            <div class="col-md-12">
                <div class="form-group" id="mcna_namegr">
                    ...
                    <div class="col-md-9">
                    <select name="inwi_curruncy" id="inwi_curruncy" tabindex="20" class="form-control bs-select" data-live-search="true" data-size="8"  onchange="sub_cat(this)">
                     <option value="0">Select Currency</option>
                    <?php foreach($currency as $curre)
                    { ?>
                            <option value="<?php echo $curre['curr_id']; ?>" <?php if(isset($edit_items['inwi_curruncy']) && $edit_items['inwi_curruncy'] == $curre['curr_id']){ echo "selected";} ?>> <?php echo $curre['curr_name']; ?>
                            </option>                                                    
                    <?php }?>
                </select>
                    </div>
