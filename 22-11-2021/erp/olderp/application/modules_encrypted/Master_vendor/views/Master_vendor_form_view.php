...
<div class="container-fluid">
    ...
    <!-- BEGIN BREADCRUMBS -->
        <div class="breadcrumbs">
            <h1>Master Vendor Add</h1>
            <ol class="breadcrumb">
                <li>
                    <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                </li>
                <li class="active">
                    <a href="<?php echo base_url(); ?>Master_vendor">Master Vendor Report</a>
                </li>
                <li>
                    <a href="<?php echo base_url(); ?>Master_vendor/add">Master Vendor Add</a>
                </li>
            </ol>
                                    ...
                                    <div class="col-md-12"> 
                                        <div class="portlet-title">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group required" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-8">
                                                           <input type="text"  class="form-control" placeholder="Company name" name="master_vendor_com_name" tabindex="1" maxlength="200" required="required" id="master_vendor_com_name" value="<?php echo isset($list[0]['master_vendor_com_name']) ? $list[0]['master_vendor_com_name'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>                                                
                                                <div class="col-md-4">
                                                    <div class="form-group required" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select name="master_vendor_cust_type" id="master_vendor_cust_type" class="bs-select form-control itmchange" data-live-search="true" data-size="8" tabindex="2" required="required">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group required" id="master_vendor_namegr">
                                                        <label class="control-label col-md-4">Contact Name</label>
                                                        <div class="col-md-8">
                                                            <input type="text" tabindex="3" class="form-control" placeholder="Contact Name" name="master_vendor_contact" maxlength="70" id="master_vendor_contact" required="required" value="<?php echo isset($list[0]['master_vendor_contact']) ? $list[0]['master_vendor_contact'] : ""; ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group required">
                                                        ...
                                                        <div class="col-md-8">
                                                           <input type="text" tabindex="4" class="form-control" placeholder="Email Id" name="master_vendor_email_address" maxlength="100" id="master_vendor_email_address" required="required" value="<?php echo isset($list[0]['master_vendor_email_address']) ? $list[0]['master_vendor_email_address'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group required">
                                                        ...
                                                        <div class="col-md-8">
                                                           <input type="text" tabindex="5" class="form-control" placeholder="Mobile No" name="master_vendor_mobile_no" maxlength="100" id="master_vendor_mobile_no" required="required" value="<?php echo isset($list[0]['master_vendor_mobile_no']) ? $list[0]['master_vendor_mobile_no'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                            ...
                                            <div class="row">
                                            	<div class="col-md-4">
                                                    <div class="form-group" id="master_vendor_phonegr">
                                                        ...
                                                        <div class="col-md-8">
                                                           <select name="master_vendor_country" tabindex="7" id="master_vendor_country" class="bs-select form-control" data-live-search="true" data-size="8">
                                                ...
                                                <div class="col-md-4">
                                                 ...
                                                 <div class="col-md-4">
                                                    <div class="form-group" id="master_vendor_stategr">
                                                        ...
                                                        <div class="col-md-8">
                                                            <select name="master_vendor_state" tabindex="9" class="bs-select form-control" data-live-search="true" data-size="8" id="master_vendor_state" onchange="get_area(this.value)" >
                                                                <option value="">Select State</option>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group required" id="master_vendor_taxgr">
