...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>State/add">State Add</a>
                            </li>
                        </ol>
            ...
            <div class="page-content-container">
                ...
                <div class="page-content-row">
                    ...
                    <div class="row">
                        ...
                        <?php $states = array('class' => 'form-horizontal');
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="State Name" name="state_name" maxlength="200" id="state_name" value="<?php echo isset($list[0]['state_name']) ? $list[0]['state_name'] : ""; ?>" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                <select name="state_country" id="state_country" class="bs-select form-control" data-live-search="true">
