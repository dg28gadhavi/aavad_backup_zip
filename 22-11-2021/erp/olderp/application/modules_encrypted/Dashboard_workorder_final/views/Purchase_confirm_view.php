...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        <h1>Add Information For PO</h1>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="#">Add Information For PO</a>
                            </li>
                        </ol>
                                ...
                                <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-5">Select Po No.</label>
                                            <div class="col-md-7 text-right">
                                            <select name="po_no" class="form-control">
                                                
                                                 <option value="0">New  </option>
                                                <?php foreach ($polist as $key => $polists) { ?>
                                                    <option value="<?php echo $polists['po_id']; ?>"><?php echo $polists['po_no']; ?></option>
                                                <?php } ?>
                                            </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-5">Select Supplier</label>
                                            <div class="col-md-7 text-right">
                                            <select name="vendor" class="form-control">
                                                <option value="">Select</option>
                                                <?php foreach ($vendorlist as $key => $vendorlists) { ?>
                                                    <option value="<?php echo $vendorlists['master_vendor_id']; ?>"><?php echo $vendorlists['master_vendor_com_name']; ?></option>
                                                <?php } ?>
                                            </select>
                                            </div>
                                        </div>
