...
<!-- BEGIN BREADCRUMBS -->
    <div class="breadcrumbs">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><a href="<?php echo base_url(); ?>Outward/Outward_report">Outward Report</a></li>
            <li><a href="<?php echo base_url(); ?>Outward/add">Outward Add</a></li>
        </ol>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control"  name="otw_no" maxlength="200" id="otw_no" value="<?php echo !$this->uri->segment(3) && isset($otw_no) ? $otw_no : ''; ?><?php echo isset($list[0]['otw_no']) ? $list[0]['otw_no'] : ""; ?>" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                   <input type="text" tabindex="2" class="form-control otw_customer_name" placeholder="Customer" name="otw_customer_name" maxlength="100" id="otw_customer_name" value="<?php echo isset($list[0]['otw_customer_name']) ? $list[0]['otw_customer_name'] : ""; ?>">
                                                </div>
                                            </div>
                                    </div>
                                </div>
