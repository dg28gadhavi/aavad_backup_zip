                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                            <thead>
                                                <tr role="row" class="heading">
                                                    <th width="4%"> Code </th>
                                                    <th width="4%"> Return No </th>
                                                    <th width="6%"> Party Name</th>
                                                    <th width="1%"> R.Challon No </th>
                                                    <th width="1%"> R.Challon Date </th>
                                                    <th width="1%"> Wo No</th>
                                                    <th width="1%"> Part No </th>
                                                    <th width="2%"> Qty</th>
                                                    <th width="2%"> Jobno</th>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/demoreturn.js" type="text/javascript"></script>
