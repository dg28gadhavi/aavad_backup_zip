...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs bread-title">
                        <h1>Wo Indent List</h1>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Indent/Wo_indent_report">Wo Indent Report</a>
                            </li>
                        </ol>
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <?php
                                    $atr = array("method" => "get");
                                     echo form_open(base_url()."Indent/indenttopo",$atr);?>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/wo_indent_report.js" type="text/javascript"></script>
