...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        <h1>Customer/Vendor List</h1>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Master_party">Customer/Vendor List</a>
                            </li>
                            <li>
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                            <thead>
                                                <tr role="row" class="heading">
                                                        <th width="1%">Party Code </th>
                                                        <th width="3%">Party Name </th>
                                                        <th width="5%">Address</th>
                                                        <th width="1%">Contact Person </th>
                                                        <th width="1%">GST </th>
                                                        <th width="1%">Mobile No.</th>
                                                        <th width="1%">Phone No.</th>
                                                        <th width="1%">Email Address </th>
                                                        <th width="1%">State</th>
                                                        <th width="1%">City</th>
                                                        <th width="1%"></th>
                                                </tr>
												<tr role="row" class="filter">
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="party_code"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="party_name"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="address"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="contact_person"> </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="email_address"> </td>
                                                    <td>
