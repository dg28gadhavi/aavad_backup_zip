...
<div class="breadcrumbs">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?php echo base_url(); ?>Brand">Brand List</a></li>
        <li><a href="<?php echo base_url(); ?>Brand/add">Brand Add</a></li>
    </ol>
    ...
    <div class="page-content-row">
        ...
        <div class="row">
            ...
            <div class="portlet box">
                ...
                <div class="form-body">
                    <h3 class="form-section">Brand Name</h3>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group" id="mcna_namegr">
                                <label class="control-label col-md-3">Brand Name</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="Brand Name" name="brand_name" maxlength="200" id="brand_name" value="<?php echo isset($list[0]['brand_name']) ? $list[0]['brand_name'] : ""; ?>" >
                                </div>
                            </div>
                        </div>
                    </div>
