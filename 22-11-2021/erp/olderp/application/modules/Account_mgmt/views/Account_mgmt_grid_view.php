...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs bread-title">
                        <h1>Account_mgmt List</h1>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Account_mgmt">Account_mgmt Report</a>
                            </li>
                        </ol>
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <?php
                                    $atr = array("method" => "get");
                                     echo form_open(base_url()."Account_mgmt/Account_mgmttopo",$atr);?>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/account_mgmt_report.js" type="text/javascript"></script>
