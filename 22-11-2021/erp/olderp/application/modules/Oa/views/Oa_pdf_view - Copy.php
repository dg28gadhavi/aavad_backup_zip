                ...
                <div style="width:98%; margin-top:0;">
                    ...
                    <table style="width:100%;border-collapse:collapse;">
                        ...
                        <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:200px; font-size:12px; float:left; letter-spacing: 1px; text-align:left;"><?php echo nl2br($inv['oa_address']); ?></td>
                        </tr>
                        <tr>
	   ...
	   <!-- <div style="width:100%;">CH A    :</div></td> -->
        ...
        <tr>
            <td valign="top" colspan="2" style="width:18cm; border-left:1px solid #e41f26; border-right:1px solid #e41f26; border-bottom:1px solid #e41f26; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;">
                ...
                <tr>
                    <td valign="top" style="padding-top:10px;padding-bottom:10px;font-size:11.5px; float:left;letter-spacing: 1px;text-align:left;">Thanks for your valued Enquiry in response we have pleasure in submitting our offer for the following items.</td>
...
<?php //******************not in use end *********** ?>
                    <tr>
                        ...
                        <td colspan="2" valign="middle" style="border-left: 1px solid #e9494f;font-size:11.5px; float:left; letter-spacing: 1px; text-align:left;padding-left: 5px;"><strong><u><?php echo $item['master_item_name']; ?></u></strong><br>Part NO:<?php echo $item['master_item_part_no']; ?><br/><?php echo nl2br($item['master_item_description']); ?></td>
                        ...
                        <td valign="middle" style="border-left: 1px solid #e9494f;font-size:11.5px; float:left; letter-spacing: 1px; text-align:center;"><?php $subttl = $item['oai_itm_qty'] * (($item['oai_itm_price']));
                         echo $subttl; ?></td>                         
...
<?php //***************************************** BOM start ********************** ?>
                   ...
                   <!-- <tr>
                    ...
                    <tr>
                        <td colspan="6" style="text-align:top; font-size:12px;font-family:'Tahoma'; padding-top: 1%; padding-right: 1%; padding-left: 1%; ">
                            <strong style="text-transform: uppercase;">Terms & Conditions:</strong>
                        </td>
                        <td colspan="2" style="height:15px;"></td>
                    </tr>
                    <tr>
                        <td valign="top" colspan="6" rowspan="<?php echo $rowspan; ?>" style="padding-bottom: 1%;text-align:top; font-size:11.8px;font-family: 'Arial Black', Gadget, sans-serif; padding-right: 1%; padding-left: 1%;border-bottom:1px solid #e9494f; ">
