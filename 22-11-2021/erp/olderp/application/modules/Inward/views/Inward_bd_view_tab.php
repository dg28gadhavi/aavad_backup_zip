        ...
        <div class="row">                                        
            ...
            <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                           <input type="text" tabindex="4" class="form-control form-control-inline input-medium date-picker" placeholder="Po Date" name="inw_billdate" maxlength="200" id="inw_billdate" value="<?php if($list[0]['inw_billdate'] == "1970-01-01"){ echo ""; }else{ echo isset($list[0]['inw_billdate']) ? date("d-m-Y", strtotime($list[0]['inw_billdate'])) : ""; } ?>">
                        </div>
                    </div>
            </div>
        </div>                                        
        <div class="row">                                    
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                          <input type="text" tabindex="6" class="form-control form-control-inline input-medium date-picker" placeholder="Po Date" name="inw_challan_date" maxlength="200" id="inw_challan_date" value="<?php if($list[0]['inw_challan_date'] == "1970-01-01"){ echo ""; }else{ echo isset($list[0]['inw_challan_date']) ? date("d-m-Y", strtotime($list[0]['inw_challan_date'])) : ""; } ?>">                        
                    </div>
                </div>
            </div>
        </div>     
        <div class="row">                                    
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                         <input type="text" tabindex="8" class="form-control form-control-inline input-medium date-picker" placeholder="Po Date" name="inw_lr_date" maxlength="200" id="inw_lr_date" value="<?php if($list[0]['inw_lr_date'] == "1970-01-01"){ echo ""; }else{ echo isset($list[0]['inw_lr_date']) ? date("d-m-Y", strtotime($list[0]['inw_lr_date'])) : ""; } ?>">
                    </div>
                </div>
            </div>
        </div>    
