                ...
                <div class="page-content-row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <!-- <h3><a class="btn btn-default blue" href="<?php echo base_url().'area/csvimport'; ?>">Import CSV</a></h3> -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                            <thead>
                                                <tr role="row" class="heading">
                                                  ...
                                                  <th width="2%"> Area Name </th>
                                                    <th width="2%"> Pincode No </th>
                                                    <th width="2%"> City Name </th>
                                                    <th width="2%"> State Name </th>
                                                    <th width="2%"> Country Name </th>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="area_name"> </td> 
                                                     <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="pincode"> </td>
                                                     <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="city_name"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="state_name"> </td>
                                                    <td>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/area.js" type="text/javascript"></script>
