<?php //echo '<pre>'; print_r($chat_list); die;?>
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title tabbable-line">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase">B2B Inquiry Details</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo $list['b2binq_id']; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                                <div class="form-group" id="mcna_namegr">
                                                    <label class="control-label col-md-4"><strong>B2B Type :</strong></label>
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php if($list['b2binq_type']==1){echo "India mart"; }else{ echo "Trade India"; }; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                                <div class="form-group" id="mcna_namegr">
                                                    <label class="control-label col-md-4"><strong>Customer Detail:</strong></label>
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo $list['b2binq_cust_name'].",".$list['b2binq_companyname']; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                                <div class="form-group" id="mcna_namegr">
                                                    <label class="control-label col-md-4"><strong>Email & Mobile :</strong></label>
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo $list['b2binq_cust_email'].",".$list['b2binq_cust_mno'].",".$list['b2binq_cust_phone'].",".$list['b2binq_cust_phone_alt']; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo $list['b2binq_subject']; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo date('d-m-Y H:i:s',strtotime($list['b2binq_datetime'])); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">                                        
                                        <div class="col-md-4">
                                                <div class="form-group" id="mcna_namegr">
                                                    <label class="control-label col-md-4"><strong>Message :</strong></label>
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo $list['b2binq_massage']; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                                ...
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo $list['b2binq_address'].",".$list['b2binq_city'].",".$list['b2binq_state'].",".$list['b2binq_country']; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                                <div class="form-group" id="mcna_namegr">
                                                    <label class="control-label col-md-4"><strong>Prodect Name :</strong></label>
                                                <div class="col-md-8">
                                                    <label class="control-label"><?php echo $list['b2binq_product_name']; ?></label>
                                                </div>
                                            </div>
                                        </div>                                    
                                    </div>
                                                    ...
                                                    <div class="mt-comment">
                                                        ...
                                                        <div class="mt-comment-body">
                                                            <div class="mt-comment-info">
                                                                ...
                                                                <span class="mt-comment-date"><?php echo date('d-F-Y',strtotime($value['b2bu_udate'])); ?></span>
                                                            </div>
                                                            <div class="mt-comment-text"> <?php echo $value['b2bu_remark']; ?> </div>
                                                            <div class="mt-comment-details">
                                                                
                                                                <ul class="mt-comment-actions">
                                                                    <li>
                                                                        <a href="<?php echo base_url(); ?>Sales_enq/delete_chat/<?php echo $this->uri->segment(3); ?>?chatid=<?php echo $value['b2bu_id']; ?>&acttype=delete_chat" onclick="return confirm('Are you sure you want to edit this item?');">Delete</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
                            ...
                            <div class="col-xs-12 col-md-12 col-lg-12">
                            	<div class="portlet light bordered">
                                    <div class="portlet-title tabbable-line">
                                        <div class="caption">
                                            <i class="icon-bubbles font-dark hide"></i>
                                            <span class="caption-subject font-dark bold uppercase">Add Comments</span>
                                        </div>
                                        </div>
				                                ...
				                                <div class="row">
				                                    <div class="col-md-10">
				                                        <div class="form-group" id="mcna_namegr">
				                                            ...
				                                            <div class="col-md-12">
				                                                <textarea class="form-control" tabindex="5" name="b2bu_remark" placeholder="" id="b2bu_remark" rows="3"></textarea>
				                                            </div>
				                                        </div>
				                                    </div>
				                                    <div class="col-md-2">				                              
				                                        ...
				                                        <div class="row">
				                                            <div class="col-md-offset-7 col-md-5">
				                                                <button type="submit" tabindex="24" class="btn green" onclick="return ValidateDetails()" >Add</button>
				                                            </div>
				                                        </div>
				                                    </div>
