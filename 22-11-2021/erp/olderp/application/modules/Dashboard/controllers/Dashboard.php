...
class Dashboard extends CI_Controller {
	...
	public function index()
	{
		...
		if($dep_id == 11 || $dep_id == 5 || $dep_id == 9 || $dep_id == 2 || $dep_id == 6)
		{
			...
			{
				if($this->session->flashdata('rights_error') != '')
				{
					$msg = $this->session->flashdata('rights_error');
					$this->session->set_flashdata('rights_error', $msg);
				}
			...
			$data['statics'] = $this->dashboard_model->get_statics();
