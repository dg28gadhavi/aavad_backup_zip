...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        <h1>Add Information For DemoReturn</h1>
                        <ol class="breadcrumb">
                            <li>
                                ...
                                <div class="row">
                                     <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Return No</label>
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control" placeholder="Challan No"  name="return_no" maxlength="200" id="return_no" value="<?php echo isset($demo_no) ? $demo_no : ''; ?>">
                                            </div>
                                        </div>
                                    </div>
                                   <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control" placeholder="Challan No"  name="challan_no" maxlength="200" id="challan_no" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" class="form-control form-control-inline date-picker" placeholder="Challan Date" name="challan_date" maxlength="200" id="challan_date" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
