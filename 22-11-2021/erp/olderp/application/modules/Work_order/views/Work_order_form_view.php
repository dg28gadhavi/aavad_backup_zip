<?php //echo '<pre>'; print_r($wo_type); die;?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                 <input type="text" tabindex="2" class="form-control form-control-inline input-medium" placeholder="OLD WO No." name="wo_old_wo_no" maxlength="100" id="wo_old_wo_no" value="<?php echo isset($list[0]['wo_old_wo_no']) ? $list[0]['wo_old_wo_no'] : ""; ?>">
                                ...
                                <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group required">
                                                ...
                                                <div class="col-md-7">
                                                   <input type="text" tabindex="5" class="form-control vendor required" placeholder="Customer Name" name="vendor" maxlength="100" id="vendor" value="<?php echo isset($list[0]['vendor']) ? $list[0]['vendor'] : ""; ?>" required="required">
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group required" id="mcna_namegr">
                                                    ...
                                                    <div class="col-md-9">
                                                    <textarea class="form-control" tabindex="6" name="wo_address" placeholder="Customer Address" id="wo_address" required="required" rows="3"><?php echo isset($list[0]['wo_address']) ? $list[0]['wo_address'] : ""; ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                  </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group required" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                <?php $uid = encrypt_decrypt('decrypt', $this->session->userdata['miconlogin']['userid']); ?>
                                                <select name="wo_type" tabindex="14" id="wo_type" class="bs-select form-control itmchange" data-live-search="true" data-size="8" required="required">
