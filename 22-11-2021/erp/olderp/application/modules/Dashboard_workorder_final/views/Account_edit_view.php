                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control"  name="inv_no" maxlength="200" id="inv_no" value="<?php echo isset($invoice_details['invoice_no']) ? $invoice_details['invoice_no'] : ''; ?>" required="required">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="2" class="form-control form-control-inline input-medium date-picker" placeholder="Date" name="inv_date" maxlength="200" id="inv_date" value="<?php echo date('d-m-Y'); ?>" required="required">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control"  name="otw_challan_no" maxlength="200" id="otw_challan_no" value="<?php echo isset($invoice_details['challan_no']) ? $invoice_details['challan_no'] : ''; ?>" required="required">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="2" class="form-control form-control-inline input-medium date-picker" placeholder="Date" name="otw_challan_date" maxlength="200" id="otw_challan_date" value="<?php echo date('d-m-Y'); ?>" required="required">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                   <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Final Amount(With GST)</label>
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control"  name="inv_withgst_amount" maxlength="200" id="inv_withgst_amount" value="" required="required">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="file" class="form-control-file"  name="invoice_file" maxlength="200" id="invoice_file" multiple="multiple"  required="required">
