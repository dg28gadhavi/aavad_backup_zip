                        ...
                        <div class="col-md-12">
                            <select name="production" id="production" class="form-control itmchange" data-size="8" tabindex="4">
                              ...
                              <?php  foreach($executive as $exe) {
                                if(isset($exe['au_dep_id']) && ($exe['au_dep_id'] == 9)){
...
.production-two-lbg{background: #772120; color: #F00000;}
									 	...
									 	<tr class="<?php echo $classclr; ?>" data-toggle="collapse" data-target="#idemo<?php echo $items['woi_id']; ?>">
                                              ...
                                              <?php if($items['woi_store_approve'] == '0' && $items['woi_promanager_approve'] == '0'){ ?>
                                     ...
                                     <?php if(isset($work_order['wo_charges']) && ($work_order['wo_charges'] != '')){
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><?php echo $chargevalue->ftotal ?></td>
                                            <td colspan=2" style="text-align: center;"></td>
                                        </tr>
                                        <?php } } } } ?>
									</table>
