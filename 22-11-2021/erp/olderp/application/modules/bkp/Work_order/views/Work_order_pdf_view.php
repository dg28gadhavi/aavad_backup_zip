                ...
                <div style="width:98%; margin-top:0;">
                    ...
                    <table style="width:100%;border-collapse:collapse;">
                        <tr>
                            ...
                            <td valign="top" style=" width:57.5%; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php if(isset($inv['wo_customer_name']) && $inv['wo_customer_name']!=''){echo $inv['wo_customer_name'].",<br>".$inv['wo_address'];}else{echo '';} ?></td>
                        </tr>
                        <tr>
    ...
    <table style="width: 18cm; border-collapse:collapse;background: #f8f8f8;" autosize="0">                 
                   ...
                   <?php  $itm_discount = 0;
                    ...
                    <tr>
                        ...
                        <td valign="top" style="border-left: 1px solid #e41f26;border-bottom:1px solid #e41f26;font-size:12px; float:left; letter-spacing: 1px; text-align:center;border-right:1px solid #e41f26;"><?php if(isset($item['woi_discount']) && $item['woi_discount']!=''){echo number_format($item['woi_discount']);} ?></td>
                        <td valign="top" style="border-left: 1px solid #e41f26;border-bottom:1px solid #e41f26;font-size:12px; float:left; letter-spacing: 1px; text-align:center;border-right:1px solid #e41f26;"><?php if(isset($item['woi_gst']) && $item['woi_gst']!=''){echo number_format($item['woi_gst']);} ?></td>
                     ...
                     <tr>
                        ...
                        <td valign="middle" height="35" style="border-left: 1px solid #e41f26; border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;font-size:11px;text-align: center;"><?php if(isset($inv['wo_taxbleamount']) && $inv['wo_taxbleamount']!=''){echo number_format($inv['wo_taxbleamount']);} ?></td>
                        <td valign="middle" height="35" style="border-left: 1px solid #e41f26; border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;font-size:11px;"></td>
                        <td valign="middle"  height="35" style="border-left: 1px solid #e41f26; border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;font-size:11px;text-align: center;"><?php if(isset($inv['wo_pfgst']) && $inv['wo_pfgst']!=''){echo number_format($inv['wo_pfgst']);} ?></td>
                        <td valign="middle" height="35" colspan="2" style="border-left: 1px solid #e41f26; border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;border-right:1px solid #e41f26;text-align: center;font-size:12px;"><?php if(isset($inv['wo_pf_grandtotal']) && $inv['wo_pf_grandtotal']!=''){echo number_format($inv['wo_pf_grandtotal']);} ?></td>
                     ...
                     <tr>
                        ...
                        <td valign="middle" height="35" style="border-left: 1px solid #e41f26; border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;font-size:11px;"></td>
                        <td valign="middle" height="35" style="border-left: 1px solid #e41f26; border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;font-size:11px;text-align: center;"><?php if(isset($inv['wo_fright_taxbleamount']) && $inv['wo_fright_taxbleamount']!=''){echo number_format($inv['wo_fright_taxbleamount']);} ?></td>
                        <td valign="middle" height="35" style="border-left: 1px solid #e41f26; border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;font-size:11px;"></td> 
                        <td valign="middle" height="35" style="border-left: 1px solid #e41f26; border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;font-size:11px;text-align: center;"><?php if(isset($inv['wo_fright_pfgst']) && $inv['wo_fright_pfgst']!=''){echo number_format($inv['wo_fright_pfgst']);} ?></td>                        
                        <td valign="middle" height="35" colspan="2" style="border-left: 1px solid #e41f26; border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;border-right:1px solid #e41f26;text-align: center;font-size:12px; "><?php if(isset($inv['wo_fright_grandtotal']) && $inv['wo_fright_grandtotal']!=''){echo number_format($inv['wo_fright_grandtotal']);} ?></td>
                    </tr>
                    <tr>
                        <td valign="middle" height="35" style="border-left:1px solid #e41f26;border-top:1px solid #e41f26;border-bottom:1px solid #e41f26;font-size:11px;"></td>
                        ...
                        <td valign="middle" height="35" colspan="2" style="border-left: 1px solid #e41f26; border-bottom:1px solid #e41f26; border-top:1px solid #e41f26;border-right:1px solid #e41f26;text-align: center;font-size:12px;"><strong><?php echo $finaltotal = $finaltotal + $inv['wo_pf_grandtotal'] + $inv['wo_fright_grandtotal']; ?></strong></td>
