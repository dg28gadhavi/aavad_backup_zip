...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        <h1>Edit Description For WO No. : <?php echo $items['wo_wo_no']; ?> AND ITEM <?php echo $items['woi_part_no']; ?></h1>
                        <ol class="breadcrumb">
                            <li>
                                ...
                                <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                <textarea class="form-control"  name="item_desc" required="required"><?php echo isset($items['woi_itm_desc']) ? $items['woi_itm_desc'] : ''; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <textarea class="form-control"  name="comment" required="required"><?php echo isset($items['woi_comment']) ? $items['woi_comment'] : ''; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <textarea class="form-control"  name="remark" required="required"><?php echo isset($items['woi_itm_remark']) ? $items['woi_itm_remark'] : ''; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
