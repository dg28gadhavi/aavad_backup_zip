...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        <h1>Add Information For WO</h1>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="#">Add Information For WO</a>
                            </li>
                        </ol>
                        ...
                        <div class="portlet box">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control"  name="wo_famount" maxlength="200" id="wo_famount" value="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control"  name="wo_productweight" maxlength="200" id="wo_productweight" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Payment Info</label>
                                            <div class="col-md-9">
                                               <textarea class="form-control" id="wo_paymentinfo" name="wo_paymentinfo" rows="5"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Payment Receive</label>
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control"  name="wo_payment_receive" maxlength="200" id="wo_payment_receive" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" id="master_party_namegr">
                                            ...
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                <img src="<?php if(isset($list[0]['wo_payment_img']) && ($list[0]['wo_payment_img'] != '')) {?><?php echo base_url();?>uploads/wo_payment_img/<?php echo $list[0]['wo_payment_img']; ?><?php } else{ ?>http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image<?php } ?>" alt=""> </div>
                                            <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"> </div>
                                            <div>
                                                <span class="btn default btn-file">
                                                    <span class="fileinput-new" tabindex="13"> Select image </span>
                                                    <span class="fileinput-exists"> Change </span>
                                                   <input type="file"  name="wo_payment_img"  />
