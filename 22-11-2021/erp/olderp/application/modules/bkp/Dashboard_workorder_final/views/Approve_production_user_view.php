...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        <h1>Assign User For WO</h1>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="#">Assign User For WO</a>
                            </li>
                        </ol>
                                        ...
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <select name="select_admin" class="form-control">
                                                ...
                                                <?php foreach ($admin_users as $key => $admin_user) { ?>
                                                    <option value="<?php echo $admin_user['au_id']; ?>"><?php echo $admin_user['au_fname'].' '.$admin_user['au_lname']; ?></option>
                                                <?php } ?>
                                            </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-6 text-right">
                                                <textarea class="form-control" id="woi_itm_remark" name="woi_itm_remark" rows="5"></textarea>
                                            </div>
                                        </div>
                                    </div>
