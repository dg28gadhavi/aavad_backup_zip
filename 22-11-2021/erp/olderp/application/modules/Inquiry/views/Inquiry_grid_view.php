                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <form method="post" accept-charset="utf-8" action="<?php echo base_url(); ?>Inquiry">
                                    <div class="table-container">
                                        <div class="table-actions-wrapper" style="display:none;">
                                            <span> </span>
                                            <select class="table-group-action-input form-control input-inline input-small input-sm" id="dropdownHolder" name="inq_status_o">
                                                ...
                                                <option value="5">Challan Date.</option>
                                                <option value="6">Recieved Amount.</option>
                                            </select>
...
<td><input type="text" class="form-control form-filter input-sm" name="companyname" value="<?php 
echo isset($this->session->userdata['inq_forn']['companyname']) ? $this->session->userdata['inq_forn']['companyname'] : '';?>"> </td>
...
echo isset($this->session->userdata['inq_forn']['executive']) ? $this->session->userdata['inq_forn']['executive'] : '';?>"> </td>
<td><input type="text" class="form-control form-filter input-sm" name="age" value="<?php 
echo isset($this->session->userdata['inq_forn']['source']) ? $this->session->userdata['inq_forn']['source'] : '';?>"> </td>
<td><input type="text" class="form-control form-filter input-sm" name="subsource" value="<?php 
echo isset($this->session->userdata['inq_forn']['subsource']) ? $this->session->userdata['inq_forn']['subsource'] : '';?>"> </td>
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($inq_lists as $key => $inq_list) { ?>
                                                    <tr class="odd" role="row">
                                                        ...
                                                        <td><?php echo $inq_list['bd_lname']; ?></td>
                                                        <td><?php echo $inq_list['bd_fullname']; ?></td>
                                                        <td><?php echo $inq_list['bd_company_name']; ?></td>
                                                        ...
                                                        <td><?php echo $inq_list['au_fname']; ?></td>
                                                        <td><?php echo $inq_list['source_name']; ?></td>
                                                        <td><?php echo $inq_list['subsource_name']; ?></td>
                                                       ...
                                                       <?php  $idenc = encrypt_decrypt('encrypt',$inq_list['inq_id']); ?>
                                                        ...
                                                        <?php } ?>
                                                        <?php if(isset($editrights) && ($editrights != false)){ ?>
                                                        <a class="btn btn-default green" onclick="return confirm('Are you sure you want to Delete this record?');" href="<?php echo base_url().'Inquiry/create_visa/'.$idenc ?>">Create Visa file</a>
                                                        <?php } ?>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
