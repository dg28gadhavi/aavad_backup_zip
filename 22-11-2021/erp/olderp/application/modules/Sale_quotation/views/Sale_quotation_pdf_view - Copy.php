                ...
                <div style="width:98%; margin-top:0;">
                    ...
                    <table style="width:100%;border-collapse:collapse;">
                        <tr>
                            ...
                            <td valign="top" style=" width:45.5%; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo $inv['vendor']; ?></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:45.5%; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo isset($inv['city_name']) ? nl2br($inv['city_name']) : '' ; ?></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:5%; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:45.5%; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo $inv['sa_mobile']; ?></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:5%; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:45.5%; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo nl2br($inv['sa_email']); ?></td>
                        </tr>
	...
	<!-- <div style="width:100%;">CH A    :</div></td> -->
            <td valign="top" style="width:5cm;border-top:1px solid #e41f26; border-left:1px solid #e41f26;border-bottom:1px solid #e41f26;border-right:1px solid #e41f26; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;">
                <div style="width:98%; margin-top:0;">
                    ...
                    <table style="width:100%;border-collapse:collapse;">
                        <tr>
                            <td valign="top" style=" width:25%; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><strong>Quotation No.</strong><span style="text-align:right !important;"></span></td>
                            <td valign="top" style=" width:5%; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
          ...
          <tr>
            <td valign="top" colspan="2" style="width:6cm; border-top:1px solid #e9494f; border-left:1px solid #e41f26; border-right:1px solid #e41f26; border-bottom:1px solid #e41f26; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;">
                <table style="width:100%;border-collapse:collapse;">
                    <tr>
                            <td valign="top" style="width:10.5%; font-size:11px; float:left; letter-spacing: 1px; text-align:left; padding-top:5px;"><strong>Kind attn</strong><span style="text-align:right !important;"></span></td>
                            <td valign="top" style="padding-top:5px; width:5%; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:80%; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php if(isset($inv['sq_con_person']) && $inv['sq_con_person']!=''){echo $inv['sq_con_person'];}else{echo '';} ?></td>
                    </tr>
                    <tr>
                            <td valign="top" style="width:10.5%; font-size:11px; float:left; letter-spacing: 1px; text-align:left; padding-top:5px;"><strong> Sub</strong><span style="text-align:right !important;"></span></td>
                            <td valign="top" style="padding-top:5px; width:5%; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style="padding-top:5px; width:80%; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php if(isset($inv['sales_enq_sub']) && $inv['sales_enq_sub']!=''){echo $inv['sales_enq_sub'];}else{echo '';} ?></td>
                    </tr>        
                </table>
        ...
        <table style="width:100%;border-collapse:collapse; margin:0; padding:0;">
                    ...
                    <tr>
                        <td valign="top" style="text-align:left; border-left:1px solid #e9494f;border-bottom:1px solid #e9494f; font-size:11px;font-family: 'Tahoma'; height: 25px; width: 46.2%; padding-right: 1%; padding-left: 1%; padding-top: 1%; padding-bottom: 1%; ">
                            ...
                            <div  style="">Feel Free to Contact Us On wecon2@miconindia.com.</div>
                            <div  style="">Ankit Doshi</div>
                            <div  style=""><strong>M :</strong>9723462390</div>
                            <div  style="">Email : wecon2@miconindia.com</div>
