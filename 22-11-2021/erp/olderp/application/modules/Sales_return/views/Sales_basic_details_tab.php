...
<div class="row">
    ...
    <div class="breadcrumbs breadcrumbs-header">
        ...
        <?php $id = $this->uri->segment(3); ?>
              <!-- <a class="btn green" href="<?php echo base_url(); ?>pdf/outward/outward<?php echo $id; ?>.pdf" target="_blank">View PDF</a>
    ...
    <div class="col-md-6 breadcrumbs breadcrumbs-header">
        ...
        <a class="bread-space" href="<?php echo base_url(); ?>Sales_return/Sales_return_report">Sales_return Report</a>
        <a class="bread-space" href="<?php echo base_url(); ?>Sales_return/add">Create New Sales_return</a>
                    ...
                    <?php //echo '<pre>';print_r($emails);//die; ?>
                        ...
                        <div class="portlet box blue">     
                             <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Process </div>
                                    <div class="tools">
                            ...
                            <div class="portlet-body">
                                ...
                                <?php //$tabono = $this->session->userdata('tabno') ? $this->session->userdata('tabno') : 0; ?>
                                            ...
                                            <?php if($this->input->get() != '' && $this->input->get('acttype') == 'serial') {?>
                                             <li class="<?php if(isset($tabno) && ($tabno == 4)) { ?> active <?php } ?>">
                                                <a href="#tab_2_4" data-toggle="tab" aria-expanded="false">Serial Key</a>
                                            </li>
                                            <?php } ?>
                                            <!-- <li class="<?php if(isset($tabno) && ($tabno == 4)) { ?> active <?php } ?>">
...
<script type="text/javascript">
 ...
 <script>
  ...
  <script>
  $( function() {
    $(".outward_serial_keyname").autocomplete({
            source: base_url+"Sales_return/get_item_serialkey/<?php echo $this->uri->segment(3) ? $this->uri->segment(3) : 0; ?>?itemid=<?php echo $this->input->get('itemid') ? $this->input->get('itemid') : 0; ?>",
            minLength: 1,
            html: true,
            select: function( event, ui )
            {
                ...
                res = res.split("outward_serial_keyname");
                $('#outward_serial_keyid'+res[1]).val(ui.item.keyid);
...
<script type="text/javascript">
$(document).on('blur', '.otwi_qty,.otwi_price,.otwi_discount', function() {
        var idd = $(this).attr('id');
        //ert(idd);
        var total =($("#otwi_qty").val() * $("#otwi_price").val());
        var totaldisc = ((($("#otwi_qty").val() * $("#otwi_price").val()) * $("#otwi_discount").val()) / 100);
        var ftotal = (($("#otwi_qty").val() * $("#otwi_price").val()) - totaldisc);
        $("#otwi_total ").val(parseFloat(total).toFixed(2));
        $("#otwi_ftotal").val(parseFloat(ftotal).toFixed(2));
        //ert(totaldisc);
