                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control"  name="woi_productweight" maxlength="200" id="woi_productweight" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <textarea class="form-control" id="woi_remark_production" name="woi_item_remark_production" rows="5"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-md-9">
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                        <img src="<?php if(isset($list[0]['woi_product_drawing']) && ($list[0]['woi_product_drawing'] != '')) {?><?php echo base_url();?>uploads/woi_product_drawing/<?php echo $list[0]['woi_product_drawing']; ?><?php } else{ ?>http://www.placehold.it/200x150/EFEFEF/AAAAAA&amp;text=no+image<?php } ?>" alt=""> </div>
                                                    <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 200px; max-height: 150px;"> </div>
                                                    <div>
                                                        <span class="btn default btn-file">
                                                            <span class="fileinput-new" tabindex="13"> Select image </span>
                                                            <span class="fileinput-exists"> Change </span>
                                                           <input type="file"  name="woi_product_drawing"  />
