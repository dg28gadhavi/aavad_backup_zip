...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Quatation_status">Quatation_status List</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>Quatation_status/add">Quatation_status Add</a>
                            </li>
                        </ol>
            ...
            <div class="page-content-container">
                ...
                <div class="page-content-row">
                    ...
                    <div class="row">
                        ...
                        <?php $Quatation_statuss = array('class' => 'form-horizontal');
                        echo form_open_multipart($action,$Quatation_statuss); ?>
                            <div class="form-body">
                                <div class="col-md-12">
                            ...
                            <div class="space-2"></div>
                                ...
                                <h3 class="form-section">Quatation Status</h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3"> Name</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="Name" name="qs_name" maxlength="200" id="qs_name" value="<?php echo isset($list[0]['qs_name']) ? $list[0]['qs_name'] : ""; ?>" >
                                            </div>
                                        </div>
                                    </div>
                                    </div>
...
function ValidateDetails()
{
    var fields;
    fields = "";
    document.getElementById('Quatation_status_name').className = 'form-control';
    $('#Quatation_status_name').parent().parent().removeClass('has-error');
    
    if (DoTrim(document.getElementById('Quatation_status_name').value).length == 0) {
        if(fields != 1){
        document.getElementById("Quatation_status_name").focus();
        }
        fields = '1';
        document.getElementById('Quatation_status_name').className = 'form-control error';
        if($('#Quatation_status_name').parent().parent().attr('class') == 'form-group')
        {
            $('#Quatation_status_name').parent().parent().addClass('has-error');
        }
        //return false;
    }
