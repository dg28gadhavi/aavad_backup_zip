                                    ...
                                    <div class="display">
                                        <div class="number">
                                            <h3 class="font-green-sharp">
                                                <span data-counter="counterup" data-value="<?php echo isset($dis_sts['totalpending']['count']) ? number_format($dis_sts['totalpending']['count']) : 0;?>"></span>
                                                <small class="font-green-sharp"></small>
                                            </h3>
                                            <a href="<?php echo base_url(); ?>Dispatch/dispatch_report?status=1"><small>TOTAL Pending</small></a>
                                        </div>
                                        <div class="icon">
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="dashboard-stat2 bordered">
                                    <div class="display">
                                        <div class="number">
                                            <h3 class="font-green-sharp">
                                                <span data-counter="counterup" data-value="<?php echo isset($dis_sts['totalcomplete']['count']) ? number_format($dis_sts['totalcomplete']['count']) : 0;?>"></span>
                                                <small class="font-green-sharp"></small>
                                            </h3>
                                            <a href="<?php echo base_url(); ?>Dispatch/dispatch_report?status=2"><small>TOTAL Completed</small></a>
                                        </div>
                                        <div class="icon">
                                            <i class="icon-pie-chart"></i>
                                        </div>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                            <thead>
                                                <tr role="row" class="heading">
                                                    <th width="4%"> Code </th>
                                                    <th width="6%"> Party Name</th>
                                                    <th width="1%"> P.O. No.</th>
                                                    <th width="1%"> P.O. Date </th>
                                                    <th width="1%"> Docket No </th>
                                                    <th width="1%"> Wo No</th>
                                                    <th width="1%"> Wo Date </th>
                                                    <th width="2%"> Courier</th>
                                                    <th width="2%"> Type </th>
                                                    <th width="2%"> Remark </th>
                                                    <th width="2%"> Created </th>
                                                    <th width="7%">  P.No./Price/Disc./Qty </th>
                                                    <th width="1%"> Inv. No </th>                                                    
                                                    <th width="2%"> Date  </th>
                                                    <th width="2%"> C.Date  </th>
                                                    <th width="1%"> Status </th>
                                                    <th width="2%"></th>
                                                </tr>
                                                <tr role="row" class="filter">
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="dis_no"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="dis_vendor"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="wo_po_no"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="dis_po_date"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="dis_docket_no"> </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="dis_courier_name">
                                                        </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="dis_courier_type"> </td>   
                                                    <td>
                                                         <input type="text" class="form-control form-filter input-sm" name="dis_remark">
                                                        </td>
                                                    <td>
                                                         <input type="text" class="form-control form-filter input-sm" name="au_fname">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control form-filter input-sm" name="disi_partno">
                                                        </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_invno"> </td>
                                                
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="dis_docket_date"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="dis_created_date"> </td>
                                                        <td></td>                                                    
                                                    <td>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/dispatch_report.js" type="text/javascript"></script>
