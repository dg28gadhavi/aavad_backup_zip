...
<!-- BEGIN BREADCRUMBS -->
                ...
                <!-- <h3><a class="btn btn-default blue" href="<?php echo base_url().'tax/csvimport'; ?>">Import CSV</a></h3> -->
            </div>
        </div>
<!-- END BREADCRUMBS -->
            <!-- BEGIN CONTENT -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <form method="get" accept-charset="utf-8" action="<?php echo base_url(); ?>Tax/delete_all">
                                    <div class="table-container">
                                        <!-- <div class="table-actions-wrapper">
                                            <span> </span>
                                            <select class="table-group-action-input form-control input-inline input-small input-sm" id="dropdownHolder"  name="tax_isdelete">
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/tax.js" type="text/javascript"></script>
