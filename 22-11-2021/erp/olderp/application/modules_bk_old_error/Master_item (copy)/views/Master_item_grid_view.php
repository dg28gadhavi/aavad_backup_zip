                                    ...
                                    <div class="table-container">
                                        ...
                                        <thead>
                                                <tr role="row" class="heading">
                                                    ...
                                                    <th width="8%"> Details Of Item </th>
                                                    <th width="4%"> Price </th>
                                                    <!-- <th width="8%"> Unit </th> -->
                                                    <th width="4%"> Stock </th>
                                                    <!-- <th width="8%"> Hold Stock </th> -->
                                                    <!-- <th width="8%"> Indent Qty </th> -->
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td></td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="inw_suppiler"> </td>
                                                    <!-- <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="item_no"> </td> -->
                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="hsn_code"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="item_name"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="pno"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="detail_of_item"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="price"> </td>
                                                  
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="stock"> </td>
                                                    <!-- <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="hold_stock"> </td> -->
                                                    <!-- <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="open_stock"> </td> -->
                                                    <!-- <td>
