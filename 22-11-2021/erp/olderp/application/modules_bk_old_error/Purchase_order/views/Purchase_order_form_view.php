                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group required">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="10" class="form-control" placeholder="Contact Person" name="sq_con_person" maxlength="100" id="sq_con_person" required="required" value="<?php echo isset($list[0]['po_con_person']) ? $list[0]['po_con_person'] : ""; ?>">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                <select name="po_mode_delivary" id="po_mode_delivary" tabindex="20" class="form-control bs-select" data-live-search="true" data-size="8"  onchange="sub_cat(this)">
                                                     <option value="0">Select Delivary</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6"  style="display: none;">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" tabindex="2" class="form-control" placeholder="Mode of PO : " name="po_mode" maxlength="100" id="po_mode" value="<?php echo isset($list[0]['po_mode']) ? $list[0]['po_mode'] : ""; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
