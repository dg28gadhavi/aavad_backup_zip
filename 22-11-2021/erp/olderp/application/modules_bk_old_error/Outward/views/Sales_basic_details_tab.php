...
<div class="row">
    ...
    <div class="col-md-6 breadcrumbs breadcrumbs-header">
        ...
        <a class="bread-space" href="<?php echo base_url(); ?>Outward/outward_report">Outward Report</a>
        <a class="bread-space" href="<?php echo base_url(); ?>Outward/add">Create New Outward</a>
                    ...
                    <?php //echo '<pre>';print_r($emails);//die; ?>
                        ...
                        <div class="portlet box blue">     
                             <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Outward Process </div>
                                    <div class="tools">
                            ...
                            <div class="portlet-body">
                                ...
                                <?php //$tabono = $this->session->userdata('tabno') ? $this->session->userdata('tabno') : 0; ?>
                                            ...
                                            <li class="<?php if(isset($tabno) && ($tabno == 3)) { ?> active <?php } ?>">
                                                <a href="#tab_2_3" data-toggle="tab" aria-expanded="false">Wo Item</a>
                                            </li>
