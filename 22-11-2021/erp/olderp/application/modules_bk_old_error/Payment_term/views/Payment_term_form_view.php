...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        <h1>Payment Term Add</h1>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url(); ?>Dashborad">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Payment Term">Payment_term List</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>Payment Term/add">Payment_term Add</a>
                            </li>
                        </ol>
            ...
            <div class="page-content-container">
                ...
                <div class="page-content-row">
                    ...
                    <div class="row">
                        ...
                        <?php $Payment_terms = array('class' => 'form-horizontal');
                        echo form_open_multipart($action,$Payment_terms); ?>
                            <div class="form-body">
                                <div class="col-md-12">
                            ...
                            <div class="space-2"></div>
                                ...
                                <h3 class="form-section">Payment Term Name</h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Payment Term Name</label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="Payment Term Name" name="payment_term_name" maxlength="200" id="payment_term_name" value="<?php echo isset($list[0]['payment_term_name']) ? $list[0]['payment_term_name'] : ""; ?>" >
                                            </div>
                                        </div>
                                    </div>
                                    </div>
...
function ValidateDetails()
{
    var fields;
    fields = "";
    document.getElementById('payment_term_name').className = 'form-control';
    $('#payment_term_name').parent().parent().removeClass('has-error');
    
    if (DoTrim(document.getElementById('payment_term_name').value).length == 0) {
        if(fields != 1){
        document.getElementById("payment_term_name").focus();
        }
        fields = '1';
        document.getElementById('payment_term_name').className = 'form-control error';
        if($('#payment_term_name').parent().parent().attr('class') == 'form-group')
        {
            $('#payment_term_name').parent().parent().addClass('has-error');
        }
        //return false;
    }
