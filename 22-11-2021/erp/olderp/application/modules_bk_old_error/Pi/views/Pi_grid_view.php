                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <div class="portlet-body">
                                    ...
                                    $atr = array("method" => "get");
                                     echo form_open(base_url()."Pi/test",$atr);?>
                                             ...
                                             <thead>
                                                ...
                                                <tr role="row" class="filter">
                                                   ...
                                                   <!--  <td>
                                                    ...
                                                    <td>
                                                        <!-- <input type="text" class="form-control form-filter input-sm" name="remark"> --> 
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/Pi.js" type="text/javascript"></script>
