...
class Admin_users extends CI_Controller {
	...
	public function ajax()
	{
		...
		$records["data"][] = array(
			 ...
			 // ''.date("m-d-Y", strtotime($user[$i]['au_cdate'])),
			  ...
			  '<a href="'.base_url().'Admin_users/edit/'.$idenc.'" class="btn btn-sm btn-outline green"><i class="fa fa-search"></i> Edit</a>
			  <a href="'.base_url().'Admin_users/retype_password/'.$idenc.'" class="btn btn-sm btn-outline green"><i class="fa fa-search"></i>Reset Password</a> 
			  <a href="'.base_url().'Admin_users/delete/'.$idenc.'"onclick="return confirm('."'Are you sure you want to Delete this record?'".')" class="btn btn-sm btn-outline red"><i class=""></i> Delete</a>',
		);
		}
	...
	public function get_form()
	{
		...
		$this->data['countries'] = $this->admin_users_model->get_country();
		$this->data['cities'] = $this->admin_users_model->get_city();
		//$this->data['admintypes'] = $this->admin_users_model->get_admintype();
		$this->data['main_content'] = 'Admin_users_form_view';
