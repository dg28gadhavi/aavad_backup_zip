...
class Mode_inquiry extends CI_Controller {
	...
	public function ajax()
	{
		...
		if($right_status == false)
		{
			...
			$editstr = '<a href="'.base_url().'Mode_inquiry/edit/'.$idenc.'" class="btn btn-sm btn-outline green"><i class="fa fa-search"></i> Edit</a>';
		}
		...
		if($right_status == false)
		{
			...
			$deletestr = '<a href="'.base_url().'Mode_inquiry/delete/'.$idenc.'"onclick="return confirm('."'Are you sure you want to Delete this record?'".')" class="btn btn-sm btn-outline red"><i class=""></i> Delete</a>';
		}
		$records["data"][] = array(
