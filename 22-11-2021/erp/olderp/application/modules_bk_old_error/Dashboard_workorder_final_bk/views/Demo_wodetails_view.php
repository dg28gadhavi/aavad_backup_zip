<?php //echo "<pre>";print_r($dis_details);die; ?>
...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        <h1><?php if($this->input->get('type') == 'edit'){echo "Edit Demo WO Details";}else{ echo "Add Demo WO Details";} ?></h1>
                        <ol class="breadcrumb">
                            <li>
                        ...
                        <div class="portlet box">
                            ...
                            <div class="form-body">
                                ...
                                <div class="row">
                                   <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control"  name="challan_no" maxlength="200" id="challan_no" value="<?php echo isset($dis_details['dis_challan_no']) ? $dis_details['dis_challan_no'] : $chal_no; ?>" required="required">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="2" class="form-control form-control-inline input-medium date-picker" placeholder="Date" name="challan_date" maxlength="200" id="challan_date" value="<?php echo isset($dis_details['dis_challan_date']) ? $dis_details['dis_challan_date'] : date('d-m-Y'); ?>" required="required">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control"  name="docket_no" maxlength="200" id="docket_no" value="<?php echo isset($dis_details['dis_docket_no']) ? $dis_details['dis_docket_no'] : ''; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Docket Date</label>
                                            <div class="col-md-9">
                                               <input type="text" tabindex="2" class="form-control form-control-inline input-medium date-picker" placeholder="Date" name="docket_date" maxlength="200" id="docket_date" value="<?php echo isset($dis_details['dis_docket_date']) ? $dis_details['dis_docket_date'] : date('d-m-Y'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Dispatched/Collected by</label>
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control"  name="dis_collected_by" maxlength="200" id="dis_collected_by" value="<?php echo isset($dis_details['dis_collected_by']) ? $dis_details['dis_collected_by'] : ''; ?>" required="required">
                                            </div>
                                        </div>
                                    </div>
                                   <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-3">Note/Remark</label>
                                            <div class="col-md-9">
                                               <textarea class="form-control" id="remark" name="remark" rows="5"><?php echo isset($dis_details['dis_wodemo_note']) ? $dis_details['dis_wodemo_note'] : ''; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
