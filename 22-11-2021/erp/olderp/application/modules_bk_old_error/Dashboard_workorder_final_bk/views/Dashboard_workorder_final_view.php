									 ...
									 <table class="table table-bordered">
										<tr>
											<td class="wotdark">Name:</td>
										  	<td class="wotc" colspan="3"><strong><?php echo $work_order['wo_customer_name']; ?> <span style=color:#F00000;>[ Master Name: <?php echo $work_order['master_party_name']; ?> ] </span> </strong></td>
                                    ...
                                    $work_orders['completed_wo'][$key]['jkey'] = $j;
                                        ...
                                        new<?php echo $work_order['wo_id']; ?>input<?php echo $j; ?>.hours, new<?php echo $work_order['wo_id']; ?>input<?php echo $j; ?>.minutes, new<?php echo $work_order['wo_id']; ?>input<?php echo $j; ?>.seconds);
											  ...
											  <?php 	
													...
													{
														if($items['woi_purchase_approve'] == '0')
														{ 
																$date1 = strtotime($items['woi_manager_approve_date']);
                                                    			$date2 = strtotime(date("Y-m-d H:i:s"));
							                                    $diff = abs($date2 - $date1);
													...
													else if($dep_id == 11)
													{
														...
														{ 
															...
															if(isset($items['woi_production_cid']) && ($items['woi_production_cid'] == 0))
																{ ?>
