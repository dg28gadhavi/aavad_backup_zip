                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                               <textarea rows="10" cols="50" tabindex="34" class="ckeditor form-control sa_itm_desc" name="sa_itm_desc" id="sa_itm_desc"><?php echo isset($edit_items['sai_itm_desc']) ? $edit_items['sai_itm_desc'] : ""; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-12">
                     ...
                     <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            <label class="control-label col-md-3">DILIVERY TIME</label>
                            <div class="col-md-9">
                                <input type="text"  tabindex="42" class="form-control" placeholder="DILIVERY TIME" name="sai_itm_diliverytime" maxlength="200" id="sai_itm_diliverytime" value="<?php echo isset($edit_items['sai_itm_diliverytime']) ? $edit_items['sai_itm_diliverytime'] : ""; ?>">
                            </div>
                        </div>
                    </div>
                </div>
