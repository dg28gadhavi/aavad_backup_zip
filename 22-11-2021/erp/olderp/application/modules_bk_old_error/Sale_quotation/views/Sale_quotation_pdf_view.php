...
<?php //***************************************** BOM start ********************** ?>
        ...
        <table style="width:100%;border-collapse:collapse; margin:0; padding:0;">
                    ...
                    <table style="width:100%;border-collapse:collapse;">
                        ...
                        <tr>
                            <td valign="top" style=" width:5px; font-size:10px; float:left; letter-spacing: 1px; text-align:left;"><strong>Packing & Forwarding</strong><span style="text-align:right !important;"></span></td>
                            <td valign="top" style=" width:10px; font-size:10px; float:left; letter-spacing: 1px; text-align:center;">:</td>
