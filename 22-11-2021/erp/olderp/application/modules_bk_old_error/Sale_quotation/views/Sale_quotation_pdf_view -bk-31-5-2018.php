...
<div style="width:98%; margin:0 auto;padding-top:50px; font-family: 'Arial Black', Gadget, sans-serif">
    ...
    <table style="width:100%;border-collapse:collapse;">
        ...
        <tr>
            <td valign="top" style="width:6cm; border-top:1px solid #e9494f; border-left:1px solid #e41f26; border-bottom:1px solid #e41f26; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;">
            <div style="width:98%;font-size:11px;"><strong>M/s. Customer name : </strong><?php echo $inv['vendor']; ?></div>
           
	<div style="width:98%; font-size:11px;"><strong>Address : </strong><?php echo isset($inv['city_name']) ? nl2br($inv['city_name']) : '' ; ?></div>
	<div style="width:98%; font-size:11px;"><strong>Phone : </strong><?php echo $inv['sa_mobile']; ?></div>
	<div style="width:98%; font-size:11px;"><strong>Email : </strong><?php echo nl2br($inv['sa_email']); ?></div>
	<!-- <div style="width:100%;">CH A    :</div></td> -->
            <td valign="top" style="width:6cm;border-top:1px solid #e41f26; border-left:1px solid #e41f26;border-bottom:1px solid #e41f26;border-right:1px solid #e41f26; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;">
                <div style="width:98%; margin-top:0;">
                    ...
                    <table style="width:100%;border-collapse:collapse;">
                        <tr>
                            <td valign="top" style=" width:35.5%; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><strong>Quotation No.</strong><span style="text-align:right !important;"></span></td>
                            <td valign="top" style=" width:5%; font-size:11px; float:left; letter-spacing: 1px; text-align:center;">:</td>
                            <td valign="top" style=" width:47.5%; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo $inv['sa_no'] ?></td>
                        </tr>
                        <tr>
                            ...
                            <td valign="top" style="padding-top:5px; width:47.5%; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><?php echo date("d-m-Y", strtotime($inv['sa_enq_date'])); ?></td>
                        </tr>
                        </table>
                </div>
            </td>
         ...
         <tr>
            <td colspan="2" valign="top" style="width:6cm;border-bottom:1px solid #e41f26;border-left:1px solid #e41f26;border-right:1px solid #e41f26; padding-top:0.2cm; padding-bottom:0.2cm; padding-left:0.1cm; padding-right:0.1cm;" >
                <div style="width:100%; margin:0;">
                    <div style="width:100%; margin:0;">
                        <table style="width:100%;border-collapse:collapse;">
                                <tr>
                                <td valign="top" style="padding-top:5px;  font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><strong>Kind attn:</strong><?php echo $inv['vendor']; ?></td>
                                <td valign="top" style=" padding-top:5px;  font-size:11px; float:left; letter-spacing: 1px; text-align:left;"></td>
                            </tr>
                                <tr>
                                <td valign="top" style="padding-top:5px;  font-size:11px; float:left; letter-spacing: 1px; text-align:left;"><strong> Sub :</strong><?php echo $inv['sa_subject'] ?></td>
                                <td valign="top" style=" padding-top:5px; font-size:11px; float:left; letter-spacing: 1px; text-align:left;"></td>
                            </tr>
    ...
    <table border="0" style="width:100%; border-collapse:collapse; margin:0; padding:0; background-color:#fce8e9;border-left:1px solid #e41f26;border-right:1px solid #e41f26; border-bottom:1px solid #e41f26;" autosize="0">
                    ...
                    <tr>
                        <td valign="middle" style="border-left: 1px solid #e41f26; font-size:11px; letter-spacing: 1px; text-align:center; font-weight:bold;background-color:#f7bbbd;border-bottom:1px solid #e41f26;">Sr.No</td>
                        <td colspan="2" valign="middle" style="border-left: 1px solid #e41f26; font-size:11px; float:left; letter-spacing: 1px; text-align:center; font-weight:bold;background-color:#f7bbbd;border-bottom:1px solid #e41f26;">Item Description</td>
                        <td colspan="2" valign="middle" style="border-left: 1px solid #e41f26; font-size:11px; float:left; letter-spacing: 1px; text-align:center; font-weight:bold;border-bottom:1px solid #e41f26;background-color:#f7bbbd;">Qty</td>
                        <td  valign="middle" style="border-left: 1px solid #e41f26; font-size:11px; float:left; letter-spacing: 1px; text-align:center; font-weight:bold;background-color:#f7bbbd;border-bottom:1px solid #e41f26;">PRICE</td>
                        <td  valign="middle" style="border-left: 1px solid #e41f26; font-size:11px; float:left; letter-spacing: 1px; text-align:center; font-weight:bold;background-color:#f7bbbd;border-bottom:1px solid #e41f26;">Total</td>
                        <?php if(isset($inv['sa_isdiscount']) && !empty($inv['sa_isdiscount']) && $inv['sa_isdiscount'] == 1) { ?>
                        <td  valign="middle" style="border-left: 1px solid #e41f26; font-size:11px; float:left; letter-spacing: 1px; text-align:center; font-weight:bold;background-color:#f7bbbd;border-bottom:1px solid #e41f26;">Dsc%</td>
                        <?php } ?>
                        <?php if(isset($inv['sa_isdiscount']) && !empty($inv['sa_isdiscount']) && $inv['sa_isdiscount'] == 2) { ?>
                        <td  colspan="2" valign="middle" style="border-left: 1px solid #e41f26; border-right: 1px solid #e41f26; font-size:11px; float:left; letter-spacing: 1px; text-align:center; font-weight:bold;background-color:#f7bbbd;border-bottom:1px solid #e41f26;"> Final Total</td>
                         <?php } else { ?>
                         <td valign="middle" style="border-left: 1px solid #e41f26; border-right: 1px solid #e41f26; font-size:11px; float:left; letter-spacing: 1px; text-align:center; font-weight:bold;background-color:#f7bbbd;border-bottom:1px solid #e41f26;"> Final Total</td>
                         <?php } ?>
                    </tr>
<?php //************************** top start *********************************
                    $itm_discount = 0;
...
<?php //***************************************** BOM start ********************** ?>
    	  ...
    	  <table style="width:100%;border-collapse:collapse; margin:0; padding:0;">
                    ...
                    <tr>
                        ...
                        <td valign="top" style="border-left:1px solid #e41f26;border-bottom:1px solid #e41f26; border-right: 1px solid #e41f26;font-size:12.5px;font-family: 'Tahoma';  width: 100%; padding-right: 1%;  padding-top: 1%; padding-bottom: 1%; text-align:LEFT;">
