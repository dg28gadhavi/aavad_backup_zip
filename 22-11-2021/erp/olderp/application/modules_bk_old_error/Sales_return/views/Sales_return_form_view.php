...
<!-- BEGIN BREADCRUMBS -->
    <div class="breadcrumbs">
        <h1>Sales_return Add</h1>
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>Dashboard">Dashboard</a></li>
            <li class="active"><a href="<?php echo base_url(); ?>Sales_return/Sales_return_report">Sales_return Report</a></li>
            <li><a href="<?php echo base_url(); ?>Sales_return/add">Sales_return Add</a></li>
        </ol>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control"  name="otw_no" maxlength="200" id="otw_no" value="<?php echo !$this->uri->segment(3) && isset($sr_no) ? $sr_no : ''; ?><?php echo isset($list[0]['otw_no']) ? $list[0]['otw_no'] : ""; ?>" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row">                                    
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" tabindex="12" class="form-control" placeholder="Material Return" name="sales_return_materail_return" maxlength="200" id="sales_return_materail_return" value="<?php echo isset($list[0]['sales_return_materail_return']) ? $list[0]['sales_return_materail_return'] : ""; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>                                     
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <button type="submit" tabindex="9" class="btn green" onclick="return ValidateDetails()" ><?php echo $this->input->get('id')?'UPDATE':'Start'; ?></button>
                                                </div>
                                            </div>
                                        </div>
    ...
    $(document).ready(function () {
        ...
        $('#country_change').change(function () {
            //alert($(this).val()+'aaaaaaaaaaaaaaaaaaaaaaa');
                ...
                type:'POST',
                datatype: 'JSON',
                url:'<?php echo base_url(); ?>Outward/get_country_to_state',
        ...
        $('#state_change').change(function () {
            //alert($(this).val()+'aaaaaaaaaaaaaaaaaaaaaaa');
                ...
                type:'POST',
                datatype: 'JSON',
                url:'<?php echo base_url(); ?>Outward/get_state_to_city',
...
function sub_cat(i)
{
    var data = { 'id': i.value};
        $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>Outward/getsub_category",
        data: data,
        dataType:"json",
...
<script>
  $( function() {
    $("#otw_customer_name").autocomplete({
            source: base_url+"Outward/get_customer_information",
            minLength: 1,
            html: true,
            select: function( event, ui )
            {
               ...
               $("#sales_return_master_party_id").val(ui.item.cust_id);
