...
function pa_billaddrs_call(id,type,suffix,encid)
{
   ...
   $.ajax({
      url: base_url+'Ajax_add_more_vendor/party_billaddr_more/'+id+''+urlprms,
      cache: false,
      type: "POST",
...
function pa_shipaddrs_call(id,type,suffix,encid)
{
   ...
   $.ajax({
      url: base_url+'Ajax_add_more_vendor/party_shipaddr_more/'+id+''+urlprms,
      cache: false,
      type: "POST",
      data: {'mtype' : type,'id' : 1 , 'suffix' : suffix , 'inqid' : encid},
      dataType: "json",
      success: function(result){
         for (inc = 0; inc < result.no_of_result; inc++) {
            if(id == 0)
            {
              //alert(result.result[inc].ajax_main_id);
               $('#'+result.result[inc].ajax_main_id+'').html(result.result[inc].string);
               var hidid = parseInt($('#'+result.result[inc].hidinputid).val());
               $('#'+result.result[inc].hidinputid).val(hidid);
            }else{
...
function pa_contact_add(id,type,suffix,encid)
{
   ...
   $.ajax({
      url: base_url+'Ajax_add_more_vendor/party_contact_add_more/'+id+''+urlprms,
      cache: false,
      type: "POST",
      data: {'mtype' : type,'id' : 1 , 'suffix' : suffix , 'inqid' : encid},
      dataType: "json",
      success: function(result){
         for (inc = 0; inc < result.no_of_result; inc++) {
            if(id == 0)
            {
              //alert('hii - '+result.result[inc].ajax_main_id);
               $('#'+result.result[inc].ajax_main_id+'').html(result.result[inc].string);
               var hidid = parseInt($('#'+result.result[inc].hidinputid).val());
               $('#'+result.result[inc].hidinputid).val(hidid);
            }else{
        ...
        $(document).on('change', '.country', function() {
          if($(this).attr('id') != '' && $(this).attr('id') != undefined)
          {
            ...
            $.ajax({
                        type:'POST',
                        datatype: 'HTML',
                        url:base_url+"Ajax_add_more_vendor/get_state",
        ...
        $(document).on('change', '.state', function() {
          if($(this).attr('id') != '' && $(this).attr('id') != undefined)
          {
            ...
            $.ajax({
                        type:'POST',
                        datatype: 'HTML',
                        url:base_url+"Ajax_add_more_vendor/get_city",
        ...
        $(document).on('change', '.city', function() {
          if($(this).attr('id') != '' && $(this).attr('id') != undefined)
          {
            ...
            $.ajax({
                        type:'POST',
                        datatype: 'HTML',
                        url:base_url+"Ajax_add_more_vendor/get_area",
        ...
        $(document).on('change', '.area', function() {
          if($(this).attr('id') != '' && $(this).attr('id') != undefined)
          {
            ...
            $.ajax({
                        type:'POST',
                        datatype: 'HTML',
                        url:base_url+"Ajax_add_more_vendor/get_pincode",
