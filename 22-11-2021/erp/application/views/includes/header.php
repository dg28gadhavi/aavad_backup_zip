                               ...
                               <div class="btn-group-notification btn-group btn-notify" id="header_notification_bar">
                                ...
                                <div class="btn-group-img btn-group">
                                    ...
                                    <ul class="dropdown-menu-v2" role="menu">
                                        ...
                                        <?php  $tid = encrypt_decrypt('decrypt',$this->session->userdata['miconlogin']['typeid']);
                                        if(isset($tid) && $tid == 3){ ?>
                                        <li>
                                            <a target="blank" href="<?php echo base_url();?>Login/db_download">
                                                <i class="icon-key"></i> Database backup </a>
                                        </li>
                                        <?php } ?>
                                         <li>
