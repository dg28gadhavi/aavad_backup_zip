...
<!-- BEGIN BREADCRUMBS -->
        <div class="breadcrumbs">
            <h1>Payment Customer Wise Report</h1>
            <ol class="breadcrumb">
    ...
    <!-- BEGIN CONTENT -->
        <?php echo form_open(base_url().'Payment_report/inv_wise', array('method'=>'get', 'class' => 'form-horizontal','autocomplete' => 'off')); ?>            
            <div class="page-content-container">
                <!-- BEGIN CONTENT BODY -->
                                    ...
                                    <div class="portlet box">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 col-sm-12">
                                                    <div class="form-group" id="mcna_namegr">
                                                        <div class="col-md-12">
                                                            ...
                                                            <?php } */ ?> -->
                                                            <input type="text" tabindex="4" class="form-control" placeholder="Customer" name="vendor" maxlength="100" id="vendor" value="<?php echo $this->input->get('vendor') ? $this->input->get('vendor') : ''; ?>"required>
                                                        </div>
                                                    </div>
                                            </div>
                                            ...
                                            <div class="col-md-2 col-sm-12">
                                                <div class="form-group" id="mcna_namegr">                                                
                                                    <div class="col-md-12">
                                                       <input type="text" tabindex="6" class="form-control" placeholder="TO" name="sq_emailTO" maxlength="100" id="sq_emailTO" value="<?php echo $this->input->get('sq_emailTO') ? $this->input->get('sq_emailTO') : ''; ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-2 col-sm-12">
                                                <div class="form-group" id="mcna_namegr">                                                
                                                    <div class="col-md-12">
                                                       <input type="text" tabindex="6" class="form-control" placeholder="CC" name="sq_emailcc" maxlength="100" id="sq_emailcc" value="<?php echo $this->input->get('sq_emailcc') ? $this->input->get('sq_emailcc') : ''; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-1 col-sm-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <button type="submit" tabindex="10" class="btn green" ><?php echo $this->input->get('id')?'Submit':'SUBMIT'; ?></button>
                                                         <a class="btn red" tabindex="11" href="<?php echo base_url(); ?>Payment_report/inv_wise">RESET</a>
                                        ...
                                        <?php /* $crud->display_as('master_party_code','Party Code')->display_as('master_party_name','Party Name')->display_as('master_party_state','State')->display_as('master_party_Payment_report','Payment_report')->display_as('master_party_area','Area')->display_as('master_party_pincode','Pincode')->display_as('master_party_category','Category')->display_as('master_party_contact_person','Contact Person')->display_as('master_party_contact_no','Contact No')->display_as('master_party_created_date','Created Date')->display_as('master_party_updated_date','Updated Date')->display_as('master_party_email_address','Email Address')->display_as('master_party_fax','Fax')->display_as('master_party_phone','Office Number')->display_as('master_party_webpage','Website'); */ ?>
                                            <thead>
                                                <tr role="row" class="heading">
                                                    ...
                                                    <th width="2%"> Invoice Date</th>
                                                    <th width="2%"> Amount </th>
                                                    <th width="2%"> Recived Amount </th>
                                                    <th width="2%"> PO Number </th>
                                                    <th width="2%"> PO Date </th>
                                                    <th width="2%"> Payment Term </th>
                                                    <th width="5%"></th>
                                                </tr>
                                                <tr role="row" class="filter">
                                                    <td></td>
                                                   <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_customer_name"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_invno"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_invdate"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_invftotal_withgst"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_paymentrecive"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="wo_po_no"> </td>
                                                   <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="wo_po_date"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="wo_paymentterms"> </td>
                                                    <td>
...
<!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="<?php echo base_url(); ?>assets/custom/js/Payment_inv_wise.js" type="text/javascript"></script>
