...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <a href="<?php echo base_url(); ?>qoutation-followup">Follow up List</a>
                            </li>
                            <li>
                                                ...
                                                <tbody>
                                                  ...
                                                  <tr style="color:<?php echo  $color;?>;">
                                                   ...
                                                   <?php echo $sub['name']; ?>
                                                    ...
                                                    <td><?php
                                                        echo '<a class="btn" target="_blank" href="'.base_url().'Sale_quotation/quatation_tab/'.encrypt_decrypt('encrypt',$sub['id'])
                                                        ?>
                                                        ">View </a>
                                                       </td>
                                                       ...
                                                       <td>
                                                        ...
                                                        <?php
                                                        echo '<a class="btn" href="'.base_url().'Sale_quotation/status_act/'.encrypt_decrypt('encrypt',$sub['fuid'])
                                                        ?>
                                                        ">Activate </a>
                                                        <?php } ?>
                                                        <?php if(isset($sub['folst']) && $sub['folst'] == 5) { ?>
                                                        <?php
                                                        echo '<a class="btn" href="'.base_url().'Sale_quotation/status_deact/'.encrypt_decrypt('encrypt',$sub['fuid'])
                                                        ?>
                                                        ">Deactivate </a>
                                                        <?php } ?>
                                                       </td>
