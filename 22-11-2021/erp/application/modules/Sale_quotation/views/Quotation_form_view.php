    ...
    <div class="col-md-6">
        <div class="breadcrumbs breadcrumbs-header">
            ...
            <?php $id = $this->uri->segment(3); ?>
                <a class="btn green" href="<?php echo base_url(); ?>Sale_quotation/load_pdf/<?php echo $this->uri->segment(3); ?>" target="_blank">View PDF</a>
  ...
  $( function() {
    $("#sa_itm_pno").autocomplete({
            ...
            select: function( event, ui )
            {
                ...
                CKEDITOR.instances['sa_itm_desc'].setData(nl2br(ui.item.description))
