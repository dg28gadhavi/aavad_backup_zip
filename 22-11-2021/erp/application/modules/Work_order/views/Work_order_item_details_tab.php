                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-9">
                                 <textarea rows="10" cols="50" tabindex="17" class="ckeditor form-control sqi_itm_desc" name="sqi_itm_desc" id="sqi_itm_desc"><?php echo isset($edit_items['woi_itm_desc']) ? $edit_items['woi_itm_desc'] : ""; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
