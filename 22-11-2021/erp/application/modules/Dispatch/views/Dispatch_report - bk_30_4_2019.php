                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                            <thead>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="dis_po_no"> </td>
                                                    <td>
                                                        ...
                                                        <input type="text" class="form-control form-filter input-sm" name="dis_po_date"> </td>
                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="dis_wo_no"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="dis_wo_date"> </td>
