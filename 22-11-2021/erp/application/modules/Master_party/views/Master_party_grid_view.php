...
<!-- BEGIN BREADCRUMBS -->
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-right">
                            ...
                            <h3><a class="btn btn-default blue" href="<?php echo base_url().'Master_party/store_excel'; ?>">Export CSV</a></h3>
                        </div>
                    </div>
                    <?php } ?>
<!-- END BREADCRUMBS -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                             <thead>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                         <input type="text" class="form-control form-filter input-sm" name="master_party_cpersondata">
                                                        </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="master_party_email_address"> </td>
                                                    <td>
