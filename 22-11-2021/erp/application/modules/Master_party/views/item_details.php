...
<!-- <h4>Some Input</h4> -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group" id="mcna_namegr">
                                ...
                                <div class="col-md-9">
                                    <input type="text" tabindex="17" class="form-control" placeholder="Department" name="contact_department" maxlength="200" id="contact_department" value="<?php echo isset($edit_items['contact_department']) ? $edit_items['contact_department'] : ""; ?>" autofocus>
                                </div>
                            </div>
                         </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group" id="mcna_namegr">
                                ...
                                <div class="col-md-9">
                                    <input type="text" tabindex="17" class="form-control" placeholder="Location" name="contact_location" maxlength="200" id="contact_location" value="<?php echo isset($edit_items['contact_location']) ? $edit_items['contact_location'] : ""; ?>" autofocus>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group" id="mcna_namegr">
                                ...
                                <div class="col-md-9">
                                    <input type="text" tabindex="17" class="form-control" placeholder="Phone" name="contact_phone" maxlength="200" id="contact_phone" value="<?php echo isset($edit_items['contact_phone']) ? $edit_items['contact_phone'] : ""; ?>" autofocus>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group" id="mcna_namegr">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" tabindex="13" name="contact_address" placeholder="Address" id="contact_address" rows="3"><?php echo isset($edit_items['contact_address']) ? $edit_items['contact_address'] : ""; ?></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group" id="mcna_namegr">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" tabindex="13" name="contact_remark" placeholder="Remark" id="contact_remark" rows="3"><?php echo isset($edit_items['contact_remark']) ? $edit_items['contact_remark'] : ""; ?></textarea>
                                </div>
                            </div>
                        </div>
        ...
        <div class="portlet-body">
            <table id="item_grid" class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                <thead>
                    <tr>
                        <th  width="2%">Sr.No</th>
                        <th  width="2%">Name</th> 
                ...
                <tr>
                    ...
                    <td><?php echo $row['contact_location'];?></td>
                    <td><?php echo $row['contact_address'];?></td>
                    <td><?php echo $row['contact_remark'];?></td>
                    <td><?php echo $row['contact_remarkdtlog'];?></td>
                    <td><?php echo $row['contact_udate'];?></td>
