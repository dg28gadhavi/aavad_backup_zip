...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        <h1>Otwserialkey List</h1>
                        <ol class="breadcrumb">
                            <li>
                                <a href="<?php echo base_url(); ?>Dashboard">Dashboard</a>
                            </li>
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Otwserialkey">Otwserialkey List</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url(); ?>Otwserialkey/add">Otwserialkey Add</a>
                            </li>
                        </ol>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <form method="get" accept-charset="utf-8" action="<?php echo base_url(); ?>Otwserialkey/delete_all">
                                    <div class="table-container">
                                        <div class="table-actions-wrapper">
                                            <span> </span>
                                            <select class="table-group-action-input form-control input-inline input-small input-sm" id="dropdownHolder"  name="otwserialkey_isdelete">
                                            ...
                                            <thead>
                                                <tr role="row" class="heading">
                                                   <!-- <th width="2%">
                                                    ...
                                                    <th width="2%"> Outward code </th>
                                                    <th width="2%">Item Name </th>
                                                    <th width="2%"> Serial Key </th>
                                                   <th width="2%"> Created Price </th>
                                                ...
                                                <tr role="row" class="filter">
                                                  <!--  <td> </td>-->
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="ouw_code"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_item"> </td>
                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="otw_serial"> </td>
                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="cdate"> </td>
                                                    <!--<td>
                                                        <input type="text" class="form-control form-filter input-sm" name="udate"> </td>-->
                                                    <td>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/otwserialkey.js" type="text/javascript"></script>
