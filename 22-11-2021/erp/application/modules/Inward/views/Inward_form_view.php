                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                               <input type="text" tabindex="1" class="form-control"  name="inw_no" maxlength="200" id="inw_no" value="<?php echo !$this->uri->segment(3) && isset($inw_no) ? $inw_no : ''; ?><?php echo isset($list[0]['inw_no']) ? $list[0]['inw_no'] : ""; ?>" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                   <input type="text" tabindex="2" class="form-control inw_suppiler" placeholder="Supplier" name="inw_suppiler" maxlength="100" id="inw_suppiler" value="<?php echo isset($list[0]['inw_suppiler']) ? $list[0]['inw_suppiler'] : ""; ?>">
                                                </div>
                                            </div>
                                    </div>
                                </div>
