...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>Pi/send_mail">mail Add</a>
                            </li>
                        </ol>
                                      ...
                                      <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-9">
                                                           <input type="text" class="form-control"  name="pim_to" maxlength="200" id="pim_to" value="<?php echo isset($lists[0]['pi_email']) ? $lists[0]['pi_email'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
                                         <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group" id="mcna_namegr">
                                                        ...
                                                        <div class="col-md-9">
                                                           <input type="text" class="form-control"  name="pim_to_cc" maxlength="200" id="pim_to_cc" value="<?php echo isset($list[0]['pim_to_cc']) ? $list[0]['pim_to_cc'] : ""; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                        </div>
                                <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group" id="mcna_namegr">
                                                ...
                                                <div class="col-md-9">
                                                   <input type="text" class="form-control"  name="pim_sub" maxlength="200" id="pim_sub" value="PROFORMA INVOICE-<?php echo isset($lists[0]['pi_no']) ? $lists[0]['pi_no'] : ""; ?>">
                                                </div>
                                            </div>
                                        </div>
                                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group" id="mcna_namegr">
                            ...
                            <div class="col-md-11">
                            <textarea class="form-control ckeditor" name="pim_body" placeholder="Body" rows="3"><?php echo isset($lists[0]['au_signature']) ? $lists[0]['au_signature'] : ""; ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="itmmain1">
                        <div class="col-md-6 col-md-offset-2">
                            <div class="form-group" id="mcna_namegr">
                                ...
                                <div class="col-md-9">
                                   <input type="file" class="form-control-file"  name="files[]" maxlength="200" id="pim_attch" multiple="multiple">
                                </div>
                            </div>
                        </div>
                        </div>
                         <a class="btn green" href="<?php echo base_url(); ?>Pi/load_pdf/<?php echo $this->uri->segment(3); ?>" target="_blank">View PDF</a>
                    </div>
                     <div id="Devices_add_div"></div>
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group" id="mcna_namegr">
                                            <div class="col-md-12">
                                               <button id="add_more_itm" class="btn btn-default green" onclick="return add_more_item()">
                                                 <i class="fa fa-plus">Add More Item</i>
                                                 <input type="hidden" name="prohid" id="prohid" value="1">
                                            </div>
                                        </div>
                                    </div>
                                </div>  
