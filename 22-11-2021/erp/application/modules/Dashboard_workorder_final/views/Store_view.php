                                    ...
                                    <div class="display">
                                        <div class="number">
                                            <h3 class="font-green-sharp">
                                             ...
                                             <a href="<?php echo base_url(); ?>Work_order_item_list/Work_order_item_list_report?storeapproved=2"><small>PENDING</small></a>
                                        </div>
                                        <div class="icon">
                                ...
                                <div class="dashboard-stat2 bordered sales-dashbg">
                                    <div class="display">
                                        <div class="number">
                                            ...
                                            <a href="<?php echo base_url(); ?>Work_order_item_list/Work_order_item_list_report?storeapproved=1"><small>Approved</small></a>
                                        </div>
                                        <div class="icon">
                                            <i class="icon-pie-chart"></i>
                                        </div>
                           ...
                           <td><?php echo $row['wo_customer_name'];?></td>
                            ...
                            <td>
                                <?php if($row['woi_store_approve'] == '0') {
                                    $temp_str = '';
                                    if((encrypt_decrypt('decrypt',$this->session->userdata['miconlogin']['dep_id']) == 9)){
                                        $temp_str = '&show_store=1';
                                    }
                                 ?>
                                <a href="<?php echo base_url(); ?>Dashboard_workorder_final/check_qty?wo_itemid=<?php echo $row['woi_id']; ?>&itemid=<?php echo $row['woi_item_id']; ?>&wo_id=<?php echo $row['woi_wo_id']; ?><?php echo $temp_str; ?>" class="btn btn-success"><i class="fa fa-check"></i></a>
