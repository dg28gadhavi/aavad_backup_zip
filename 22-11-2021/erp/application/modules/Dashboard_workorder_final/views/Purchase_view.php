                    ...
                    <div class="row">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url(); ?>Dashboard_workorder_final/purchase_approve?wo_itemid=<?php echo $row['woi_id']; ?>&itemid=<?php echo $row['woi_item_id']; ?>&wo_id=<?php echo $row['woi_wo_id']; ?>" class="btn btn-success"><i class="fa fa-check"></i></a>
