...
class Master_party_model extends CI_Model {
	...
	public function get_Master_party_report()
	{
        ...
        {
           $this->db->like('master_party_location', $this->input->post('master_party_location'));   
        }
        ...
        {
           $this->db->like('master_party_remark', $this->input->post('master_party_remark'));   
        }
	...
	{
		$this->db->select('master_party_id,master_party_com_name,contact_pname,contact_department,contact_designation,master_party_co_ai,master_party_pastcomment,master_party_docdone,master_party_typeindustries,contact_email,contact_mobile,contact_phone,contact_location,contact_address,master_party_remark');//sum(tbl_sales_enq.inv_grand_total) as grand_total_view
		$this->db->from('tbl_master_party');
