                ...
                <!-- BEGIN CONTENT BODY -->
                    ...
                    <div class="breadcrumbs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <a href="<?php echo base_url(); ?>Oa">OA List</a>
                            </li>
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <div class="portlet-body">
                                    ...
                                    $atr = array("method" => "get");
                                     echo form_open(base_url()."Oa/oatopo",$atr);?>
                                    <div class="table-container">
                                        <div class="table-actions-wrapper">
                                            ...
                                            <select class="form-control" name="supplier">
                                                ...
                                                <option value="<?php// echo $vendor['vendor_id'];?>"><?php// echo $vendor['master_party_name'];?></option>
                                                <?php// } ?>
                                            </select>
                                            <span> </span>
                                                ...
                                                <tr role="row" class="heading">
                                                 ...
                                                 <input type="checkbox" class="group-checkable"> </th>
                                                   <th width="2%"> Record&nbsp;# </th>
                                                    ...
                                                    <th width="2%"> Concerned Person</th>
                                                    <th width="2%"> Reference No. </th>
                                                    <th width="1%"> Item Name </th>
                                                    <th width="1%"> Open Quantity </th>
                                                    <!--<th width="5%"></th>-->
                                                </tr>
                                                <tr role="row" class="filter">
                                                   <td> </td>
                                                   <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="record"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="pono"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="podate"> </td>
                                                         <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="conc_pers"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="ref_no"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="item"> </td> 
                                                 
                                                        <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="openqty"> </td>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/Oa.js" type="text/javascript"></script>
