                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" placeholder="Country Name" name="country_name" maxlength="200" id="country_name" value="<?php echo isset($list[0]['country_name']) ? $list[0]['country_name'] : ""; ?>" >
                                            </div>
                                        </div>
                                    </div>
                                </div>
