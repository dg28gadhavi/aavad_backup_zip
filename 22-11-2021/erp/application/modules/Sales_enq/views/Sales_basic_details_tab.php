...
<div class="row">
    ...
    <div class="breadcrumbs breadcrumbs-header">
        ...
        <?php $id = $this->uri->segment(3); ?>
            <a class="btn green" href="<?php echo base_url(); ?>Sales_enq/load_pdf/<?php echo $this->uri->segment(3); ?>" target="_blank">View PDF</a>
           <a title="Create Quotation" href="<?php echo base_url() ?>Sales_enq/create_quote/<?php echo $this->uri->segment(3); ?>"onclick="return confirm('."'Are you sure you want to Create Quotation?'".')" class="btn btn-sm btn-outline red"><i class="fa fa-plus-circle"></i>Create Quotation</a>
    ...
    <div class="col-md-6 breadcrumbs breadcrumbs-header">
        ...
        <a class="bread-space" href="<?php echo base_url(); ?>Sales_enq/sales_inq_report">Inquiry Report</a>
        <a class="bread-space" href="<?php echo base_url(); ?>Sales_enq/add">Create New Inquiry</a>
                    ...
                    <?php //echo '<pre>';print_r($emails);//die; ?>
                        ...
                        <div class="portlet box blue">     
                             <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>Sales Inquiry  Process </div>
                                    <div class="tools">
                            ...
                            <div class="portlet-body">
                                ...
                                <?php //$tabono = $this->session->userdata('tabno') ? $this->session->userdata('tabno') : 0; ?>
                                            ...
                                            <li class="<?php if(isset($tabno) && ($tabno == 3)) { ?> active <?php } ?>">
                                                <a href="#tab_2_3" data-toggle="tab" aria-expanded="false">Followup</a>
                                            </li>
  ...
  $( function() {
    $("#sqi_itm_pno").autocomplete({
            ...
            select: function( event, ui )
            {
                ...
                CKEDITOR.instances['sqi_itm_desc'].setData(nl2br(ui.item.description))
