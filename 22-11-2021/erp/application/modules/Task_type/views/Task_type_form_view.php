...
<!-- BEGIN BREADCRUMBS -->
                    <div class="breadcrumbs">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>Task_type/add">Task Type Add</a>
                            </li>
                        </ol>
            ...
            <div class="page-content-container">
                ...
                <div class="page-content-row">
                    ...
                    <div class="row">
                        ...
                        <?php $Task_types = array('class' => 'form-horizontal');
                        echo form_open_multipart($action,$Task_types); ?>
                            <div class="form-body">
                                <h3 class="form-section">Task Type Name</h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group" id="mcna_namegr">
                                            <label class="control-label col-md-6">Task Type Name</label>
                                            <div class="col-md-6">
                                                <input type="text" class="form-control" placeholder="Task_type Name" name="type_of_work_name" maxlength="200" id="type_of_work_name" value="<?php echo isset($list[0]['type_of_work_name']) ? $list[0]['type_of_work_name'] : ""; ?>" >
                                            </div>
                                        </div>
                                    </div>
                                    </div>
