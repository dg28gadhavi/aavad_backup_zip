			   ...
			   if($typeid == 3) {  ?>
                    <div class="row">
                        <div class="col-md-12 col-sm-12 text-right">
                            <h3><a class="btn btn-default blue" href="<?php echo base_url().'Master_vendor/csvimport'; ?>">Import CSV</a></h3>
                        </div>
                    </div>
                    <?php } ?>
<!-- END BREADCRUMBS -->
                                        ...
                                        <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                                             <thead>
                                                ...
                                                <tr role="row" class="filter">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="Master_vendor_com_name"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="Master_vendor_office_address"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="Master_vendor_email_address"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="Master_vendor_office_no"> </td>
                                                    <td>
                                                        <input type="text" class="form-control form-filter input-sm" name="Master_vendor_mobile_no"> </td>
                                                    <td>
                                                        </td>
                                                    <td>
...
<![endif]-->
        ...
        <script src="<?php echo base_url(); ?>assets/custom/js/master_vendor.js" type="text/javascript"></script>
