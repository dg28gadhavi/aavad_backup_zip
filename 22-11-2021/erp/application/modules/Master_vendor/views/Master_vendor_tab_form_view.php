...
<div class="space-2"></div>
    ...
    <div class="row">
          ...
          <div class="col-md-6 breadcrumbs breadcrumbs-header">
              ...
              <a class="bread-space" href="<?php echo base_url(); ?>Master_vendor">Master vendor Report</a>
              <a class="bread-space" href="<?php echo base_url(); ?>Master_vendor/add">Create New Master vendor</a>
              </li>
              </ol>
          </div>
                    ...
                    <?php //echo '<pre>';print_r($emails);//die; ?>
                        ...
                        <div class="portlet box blue">     
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-cogs"></i>Master vendor Process </div>
                                <div class="tools">
