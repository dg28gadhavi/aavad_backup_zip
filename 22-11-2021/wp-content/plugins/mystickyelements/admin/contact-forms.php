	...
	<div class="">
		...
		<div class="mystickyelements-disable-wrap">
						...
						switch ( $val ) {
							...
							?>
								<div class="mystickyelements-option-field contact-form-option myStickyelements-icon-wrap mystickyelements-dropdown_enable <?php echo $enable_class; ?> hide_field" >
									<p class="mystickyelement-field-hide-content upgrade-myStickyelements"><a href="<?php echo esc_url($upgarde_url); ?>" target="_blank"><i class="fas fa-lock"></i><?php _e('UPGRADE NOW', 'mystickyelements'); ?></a></p>
			...
			<div class="myStickyelements-contact-form-field-hide myStickyelements-contact-form-field-option">
				...
				<!--	<span class="upgrade-myStickyelements"><a href="<?php //echo esc_url($upgarde_url); ?>" target="_blank"><i class="fas fa-lock"></i><?php //_e('UPGRADE NOW', 'mystickyelements'); ?></a></span> -->
					<a href="#" class="mystickyelements-add-custom-fields"> <?php esc_html_e( 'Add new field', 'mystickyelements'); ?><i class="fas fa-plus"></i></a>
				</div>
			</div>
									...
									<div class="multiselect">
										...
										<div id="checkboxes">
											<label>
												...
												<input type="checkbox" name="contact-form[send_leads][]" id="send_leads_database" value="database" <?php if ( !empty($contact_form['send_leads']) && in_array( 'database', $contact_form['send_leads']) ) { echo 'checked="checked"'; } ?> checked="checked"  />&nbsp;<?php _e( 'Send Leads to Local database', 'mystickyelements' );?>
											</label>
