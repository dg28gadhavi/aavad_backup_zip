		...
		<?php } else {
			...
			<table class='fca_pc_integrations_table'>
				...
				<tr class='fca-pc-woo-feed-settings fca-pc-woo-advanced-feed-settings' style='display:none;'>
					...
					<span class='fca_pc_hint'><?php esc_attr_e("Set how to identify your product using the Facebook Pixel (content_id) and the feed (g:id)", 'facebook-conversion-pixel' ) ?></span></td>
				</tr>
				<tr class='fca-pc-woo-feed-settings fca-pc-woo-advanced-feed-settings' style='display:none;'>
...
function fca_pc_marketing_metabox() {
	...
	<div id='fca-pc-marketing-metabox' style='display: none;'>
		...
		<ul>
			<li><div class="dashicons dashicons-yes"></div> <?php esc_attr_e( 'Dynamic Events, so you can build <strong>powerful custom audiences</strong>', 'facebook-conversion-pixel' ); ?></li>
