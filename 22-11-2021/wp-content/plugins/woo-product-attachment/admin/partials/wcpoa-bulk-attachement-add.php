...
<div class="wcpoa-field wcpoa-field-repeater" data-name="attachments" data-type="repeater" data-key="attachments">
    <div class="wcpoa-label">
        <span><?php esc_html_e('With these options, Assign attachment to products and categories. ', $plugin_txt_domain) ?></span><br>

        <ul class="wcpoa-top-desc">
            <li><?php esc_html_e('It will downloadable/viewable in the Order details and/or Product pages.', $plugin_txt_domain) ?></li>
            <li><?php esc_html_e('Each attachment can be visible for different order statuses. ', $plugin_txt_domain) ?></li>
            <li><?php esc_html_e('Attachments assign to parent category with subcategories (parent category is higher precedence)', $plugin_txt_domain) ?></li>
        </ul>
                ...
                <tbody class="wcpoa-ui-sortable" id='wcpoa-ui-tbody'>
                    <tr>
                        <th>
                            <div class="wcpoa-label top-heading">
                                <label for="attchment_order"><?php esc_html_e('No.', $plugin_txt_domain) ?></label>
                            </div>
                            <div class="wcpoa-label top-heading">
                                <label for="attchment_name"><?php esc_html_e('Name', $plugin_txt_domain) ?></label>
                            </div>
                            <div class="wcpoa-label top-heading not-mobile">
                                <label for="attchment_type"><?php esc_html_e('Type', $plugin_txt_domain) ?></label>
                            </div>
                            <div class="wcpoa-label top-heading not-mobile">
                                <label for="attchment_visibility"><?php esc_html_e('Visibility', $plugin_txt_domain) ?></label>
                            </div>
                            <div class="wcpoa-label top-heading not-mobile">
                                <label for="attchment_remove"><?php esc_html_e('Expire', $plugin_txt_domain) ?></label>
                            </div>
                        </th>
                    </tr>
                    <?php
                    ...
                    if($wcpoa_bulk_att_data) {
                                ...
                                <tr  class="wcpoa-row wcpoa-has-value -collapsed" id="<?php echo esc_attr($wcpoa_attachments_id) ?>" data-id="<?php echo esc_attr($wcpoa_attachments_id) ?>">
                                    ...
                                    <div class="wcpoa-field -collapsed-target group-title" data-name="_name" data-type="text" data-key="">
                                        ...
                                        <div class="wcpoa-label attachment_name">
                                            <label for="attchment_name"><?php esc_html_e($attachment_name ,$plugin_txt_domain); ?></label>
                                            <ul class="attachment_action">
                                                <li><a class="edit_bulk_attach"href="#"><?php esc_html_e('Edit' ,$plugin_txt_domain); ?></a></li>
                                                <li><a class="-minus small wcpoa-js-tooltip" href="#" data-event="remove-row" title="<?php esc_attr_e('Remove',$plugin_txt_domain); ?>"><?php esc_html_e('Delete' ,$plugin_txt_domain); ?></a></li>
                                            </ul>
                                        </div>
                                        <div class="wcpoa-label not-mobile">
                                            ...
                                            ?>
                                            <label for="attchment_type"><?php ($wcpoa_attach_type === "file_upload") ? esc_html_e($file_upload_text, $plugin_txt_domain) : esc_html_e('External URL', $plugin_txt_domain);  ?></label>
                                        </div>
                                        <div class="wcpoa-label not-mobile">
                                            <label for="attchment_visibility">
                                                <?php
                                                    if("order_details_page" === $wcpoa_visibility){
                                                        esc_html_e('Order Details Page',$plugin_txt_domain);
                                                    }elseif("product_details_page" === $wcpoa_visibility){
                                                        esc_html_e('Product Details Page',$plugin_txt_domain);
                                                    }else{
                                                        esc_html_e('Order/ Product Details Page',$plugin_txt_domain);
                                                    }
                                                ?>
                                            </label>
                                        </div>
                                            ...
                                            <label for="attchment_expire">
                                                <?php
                                                    if("no" === $wcpoa_product_date_enable){
                                                        ...
                                                        esc_html_e('Specific Time',$plugin_txt_domain);
                                                    }
                                                ?>
                                            </label>
                                        </div>
                                    ...
                                    <div class="wcpoa-field wcpoa-field-text wcpoa-field-id" data-name="id" data-type="text" data-key="">
                                        ...
                                        <div class="wcpoa-input">
                                            <div class="wcpoa-input-wrap">
                                                ...
                                                <p class="wcpoa-description"><?php esc_html_e('Attachments Id used to identify each product attachment.This value is automatically generated.',$plugin_txt_domain) ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="wcpoa-field" data-name="_name" data-type="text" data-key="">
                                        <div class="wcpoa-label">
                                            <label for="attchment_name"><?php esc_html_e('Name',$plugin_txt_domain); ?><span class="wcpoa-required"> *</span></label>
                                        </div>
                                        <div class="wcpoa-input wcpoa-att-name-parent">
                                            ...
                                            <p class="wcpoa-description"><?php esc_html_e('Add a name for the attachment. It will be displayed on the front end next download/view button.', $plugin_txt_domain) ?></p>
                                        </div>
                                    </div>
                                    <div class="wcpoa-field wcpoa-field-select">
                                        <div class="wcpoa-label"> 
                                            <label for="wcpoa_attach_view"><?php esc_html_e('Status',$plugin_txt_domain); ?></label>
                                        </div>

                                        <div class="wcpoa-input wcpoa_attach_view">
                                            <select name="wcpoa_attach_view[]" class="wcpoa_attach_view" data-type="" data-key="">
                                                <option name="enable" <?php echo ($wcpoa_attach_view === "enable") ? 'selected' : '';  ?> value="enable"><?php esc_html_e('Enable', $plugin_txt_domain) ?></option>
                                                <option name="disable" <?php echo ($wcpoa_attach_view === "disable") ? 'selected' : '';  ?> value="disable" class=""><?php esc_html_e('Disable', $plugin_txt_domain) ?></option>
                                            </select>
                                            <span class="wcpoa-description-tooltip-icon"></span>
                                            <p class="wcpoa-description"><?php esc_html_e('Enable or Disable attachment using this option (This attachment will be visible to customers only if it is enabled).',$plugin_txt_domain); ?></p>
                                        </div> 
                                    </div>
                                    <div class="wcpoa-field wcpoa-field-textarea " data-name="description" data-type="textarea" data-key="" data-required="1">
                                        <div class="wcpoa-label">
                                            <label for="attchment_desc"><?php esc_html_e('Description',$plugin_txt_domain); ?></label>
                                        ...
                                        <div class="wcpoa-input">
                                            ...
                                            <span class="wcpoa-description-tooltip-icon"></span>
                                            <p class="wcpoa-description"><?php esc_html_e('You can type a short description of the attachment file. So customers will get details about the attachment file.', $plugin_txt_domain) ?></p>
                                        </div>
                                    </div>
                                    <div class="wcpoa-field wcpoa-field-select">
                                        <div class="wcpoa-label"> 
                                        ...
                                        <div class="wcpoa-input wcpoa_attach_type">
                                            <select name="wcpoa_attach_type[]" class="wcpoa_attach_type_list" data-type="" data-key="">
                                                ...
                                                <option name="" value="" disabled=""><?php esc_html_e('External URL ( Pro Version )', $plugin_txt_domain) ?></option>
                                            </select>
                                            <span class="wcpoa-description-tooltip-icon"></span>
                                            <p class="wcpoa-description"><?php esc_html_e('Select the attachment type. Like Upload file / External URL',$plugin_txt_domain); ?></p>
                                        </div> 
                                    </div>

                                    <div class="wcpoa-field file_upload wcpoa-field-file required" data-name="file" data-type="file" data-key="" data-required="1">
                                        <div class="wcpoa-label">
                                            <label for=""><?php esc_html_e('Upload Attachment File',$plugin_txt_domain); ?>
                                        ...
                                        <div class="wcpoa-input">
                                            <div <?php $this->wcpoa_esc_attr_e($filediv); ?> data-id="<?php echo esc_attr($wcpoa_attachments_id) ?>">
                                                ...
                                                <p  class="wcpoa-description"><?php esc_html_e('Select upload attachment File.', $plugin_txt_domain) ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="wcpoa-field">
                                        <div class="wcpoa-label">
                                            <label for="product_page_enable"><?php esc_html_e('Open in new window', $plugin_txt_domain); ?></label>
                                        </div>
                                        <div class="wcpoa-input">
                                            ...
                                            <span class="wcpoa-description-tooltip-icon"></span>
                                            <p class="wcpoa-description"><?php esc_html_e('On Product Details page show attachment.', $plugin_txt_domain) ?></p> 
                                        </div>
                                    </div>
                                    <!-- nirav code start --> 
                                    <div class="wcpoa-field wcpoa-field-select" data-type="select">
                                        <div class="wcpoa-label">
                                            <label for="wcpoa_sel_product"><?php esc_html_e('Attachment For', $plugin_txt_domain); ?></label>
                                        </div>
                                        <div class="wcpoa-input">
                                            <select name="wcpoa_is_condition[]" class="is_condition_select" >
                                                <option value="no" <?php echo $wcpoa_is_condition==='no'?"selected":'' ?>><?php esc_html_e('All Product', $plugin_txt_domain); ?></option>
                                                <option  name="" value="" disabled=""><?php esc_html_e('Specific Product, Category, Tags ( Pro Version )', $plugin_txt_domain); ?></option>
                                            </select>
                                            <span class="wcpoa-description-tooltip-icon"></span>
                                            <p class="wcpoa-description"><?php esc_html_e('Assign attachment for All products. Also, you can assign attachment for specific Product, Specific Category or a specific tags.', $plugin_txt_domain) ?></p>
                                        </div>
                                    </div> 
                                    <div class="wcpoa-field">
                                        <div class="wcpoa-label">
                                        <label for="product_page_enable">
                                            <?php esc_html_e('Attachment Visibility Pages',$plugin_txt_domain); ?></label>
                                        </div>
                                        <div class="wcpoa-input">
                                            ...
                                            <span class="wcpoa-description-tooltip-icon"></span>
                                            <p class="wcpoa-description"><?php esc_html_e('A select page where you want to showcase attachment like Product Page, Order page or Both.',$plugin_txt_domain); ?></p>
                                        </div>
                                    </div>
                                    <div class="wcpoa-field">
                                        <div class="wcpoa-label">
                                            <label for="product_page_enable"><?php esc_html_e('Show only for logged in users', $plugin_txt_domain); ?></label>
                                        </div>
                                        <div class="wcpoa-input">
                                    ...
                                    <div class="wcpoa-field">
                                        ...
                                        <div class="wcpoa-input">
                                            <p class="description"><?php esc_html_e('Select order status, where you want to showcase attachment. Leave unselected then apply to all.',$plugin_txt_domain); ?></p>
                                    ...
                                    <div class="wcpoa-field">
                                        ...
                                        <div class="wcpoa-input enable_expire_date">
                                            <select name="wcpoa_expired_date_enable[]" class="enable_date_time" data-type="enable_date_<?php echo esc_attr($wcpoa_attachments_id); ?>" data-key="">                       
                                                ...
                                                <option  name="" value="" disabled=""><?php esc_html_e('Selected time period after purchase ( Pro Version )', $plugin_txt_domain); ?></option>
                                            </select>
                                            <span class="wcpoa-description-tooltip-icon"></span>
                                            <p class="wcpoa-description"><?php esc_html_e('Set a specific date and specific time to access the attachment.',$plugin_txt_domain); ?></p>
                                        </div>
                                    </div>
                                        ...
                                        <div class="wcpoa-label">
                                            <label for="wcpoa_expired_date"><?php esc_html_e('Specific Date',$plugin_txt_domain); ?></label>
                                        </div>
                                        <div class="wcpoa-input">
                                            <div class="wcpoa-date-picker wcpoa-input-wrap" data-date_format="yy/mm/dd">
                                                
                                                <input name="wcpoa_expired_date[]" class="input wcpoa-php-date-picker" autocomplete="off" value="<?php echo esc_attr(($wcpoa_product_date_enable === "yes") ? $wcpoa_expired_dates : ''); ?>" type="text">
                                                <span class="wcpoa-description-tooltip-icon"></span>
                                            <p class="wcpoa-description"><?php esc_html_e('If an order is placed after the selected date, the attachments will be no longer visible for download. ( Date format: yy/mm/dd )',$plugin_txt_domain) ?></p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="wcpoa-input">
                                            ...
                                            <span class="wcpoa-description-tooltip-icon"></span>
                                            <p class="wcpoa-description"><?php esc_html_e('Set time period, After that Attachment will not accessible.',$plugin_txt_domain) ?></p>
                                        </div>
                                    </div>
                                    <?php echo wp_kses($after_fields,$this->allowed_html_tags()); ?>
                                    <?php if ($show_remove): ?>
                                        <td class="wcpoa-row-handle remove">
                                            <a class="wcpoa-icon -plus small wcpoa-js-tooltip" href="#" data-event="add-row" title="<?php esc_attr_e('Add row',$plugin_txt_domain); ?>"></a>
                                            <a class="wcpoa-icon -minus small wcpoa-js-tooltip" href="#" data-event="remove-row" title="<?php esc_attr_e('Remove row',$plugin_txt_domain); ?>"></a>
                                        </td>
                                    <?php endif; ?>
                        ...
                        <tr class="wcpoa-not-found-bulk-attach">
                            <td><?php esc_html_e('No Attachment Found !', $plugin_txt_domain) ?></td>
                        </tr>
                    <?php }  ?>
                    <tr  class="hidden trr wcpoa-row wcpoa-has-value" data-id="">
                        ...
                        <div class="wcpoa-field -collapsed-target group-title" data-name="_name" data-type="text" data-key="">
                            ...
                            <div class="wcpoa-label attachment_name">
                                <label for="attchment_name"><?php esc_html_e('No Attachment Name' ,$plugin_txt_domain); ?></label>
                                <ul class="attachment_action">
                                    <li><a class="edit_bulk_attach"href="#"><?php esc_html_e('Edit' ,$plugin_txt_domain); ?></a></li>
                                    <li><a class="-minus small wcpoa-js-tooltip" href="#" data-event="remove-row" title="<?php esc_attr_e('Remove',$plugin_txt_domain); ?>"><?php esc_html_e('Delete' ,$plugin_txt_domain); ?></a></li>
                                </ul>
                            ...
                            <div class="wcpoa-label not-mobile">
                                <label for="attchment_type"><?php esc_html_e('-', $plugin_txt_domain);  ?></label>
                            </div>
                            <div class="wcpoa-label not-mobile">
                                <label for="attchment_visibility"><?php esc_html_e('-', $plugin_txt_domain);  ?></label>
                            </div>
                            <div class="wcpoa-label not-mobile">
                                <label for="attchment_visibility"><?php esc_html_e('-', $plugin_txt_domain);  ?></label>
                            </div>
                        ...
                        <div class="wcpoa-field wcpoa-field-select">
                            ...
                            <div class="wcpoa-input wcpoa_attach_view">
                                <select name="wcpoa_attach_view[]" class="wcpoa_attach_view" data-type="" data-key="">
                                    <option name="enable"  value="enable"><?php esc_html_e('Enable', $plugin_txt_domain) ?></option>
                                    <option name="disable"  value="disable" class=""><?php esc_html_e('Disable', $plugin_txt_domain) ?></option>
                                </select>
                                <span class="wcpoa-description-tooltip-icon"></span>
                                <p class="wcpoa-description"><?php esc_html_e('Enable or Disable attachment using this option (This attachment will be visible to customers only if it is enabled).',$plugin_txt_domain); ?></p>
                            </div> 
                        ...
                        <div class="wcpoa-field file_upload wcpoa-field-file required" data-name="file" data-type="file" data-key="" data-required="1">
                            ...
                            <div class="wcpoa-input">
                                ...
                                <div class="wcpoa-file-uploader wcpoa-cf">
                                    ...
                                    <p  class="description"><?php esc_html_e('Select upload attachment File.', $plugin_txt_domain) ?></p>
                                </div>
                            </div>
                        </div>
                        <div class="wcpoa-field">
                        ...
                        <div class="wcpoa-field wcpoa-field-select" data-type="select">
                            ...
                            <div class="wcpoa-input">
                                <select name="wcpoa_is_condition[]" class="is_condition_select" >
                                    <option value="no" ><?php esc_html_e('All Product ', $plugin_txt_domain); ?></option>
                                    <option name="" value="" disabled=""><?php esc_html_e('For Specific Product, Category, Tags ( Pro Version )', $plugin_txt_domain); ?></option>
                                </select>
                                <span class="wcpoa-description-tooltip-icon"></span>
                                <p class="wcpoa-description"><?php esc_html_e('Assign attachment for All products. Also, you can assign attachment for specific Product, Specific Category or a specific tags', $plugin_txt_domain) ?></p>
                            </div>
                        ...
                        <div class="wcpoa-field">
                            ...
                            <div class="wcpoa-input">
                                <select id="wcpoa_product_logged_in_flag"
                                        name="wcpoa_product_logged_in_flag[]">
                                    <option name="no" value="no"><?php esc_html_e('No',$plugin_txt_domain) ?></option>
                                    <option name="yes" value="yes"><?php esc_html_e('Yes',$plugin_txt_domain) ?></option>
                                </select>
                                <span class="wcpoa-description-tooltip-icon"></span>
                                <p class="wcpoa-description"><?php esc_html_e('On Product Details page show attachment.', $plugin_txt_domain) ?></p> 
                        ...
                        <div style="display: none;" class="wcpoa-field enable_date enable_date_<?php echo esc_attr($wcpoa_attachments_id); ?> wcpoa-field-date-picker" data-name="date" data-type="date_picker" data-key="" data-required="1" style=''>
                            ...
                            <div class="wcpoa-input">
                                <div class="wcpoa-date-picker wcpoa-input-wrap" data-date_format="yy/mm/dd">
                                    <input class="input wcpoa-php-date-picker" name="wcpoa_expired_date[]"  type="text" autocomplete="off">
                                    <span class="wcpoa-description-tooltip-icon"></span>
                                    <p class="wcpoa-description"><?php esc_html_e('If an order is placed after the selected date, the attachments will be no longer visible for download. ( Date format: yy/mm/dd )',$plugin_txt_domain) ?></p>
                                </div>
                            </div>
                ...
                <ul class="wcpoa-actions wcpoa-hl">
                    ...
                    if($wcpoa_bulk_att_data) { ?>
                        <li class="wcpoa-add-bulk-attach wcpoa-in-pro-button">
                            <a class="button-primary"><?php esc_html_e('Add Unlimited Attachment ( In Pro )', $plugin_txt_domain) ?></a>
                        </li>
                    <?php    
                    }else{ ?>
                        <li class="wcpoa-add-bulk-attach">
                            <a class="wcpoa-button button button-primary"data-event="add-row"><?php esc_html_e('Add New Attachment', $plugin_txt_domain) ?></a>
                        </li>
                    <?php    
                    }
                    ?>
                    <div class="product_attachment_help">
                        ...
                        <a href="<?php echo esc_url('https://docs.thedotstore.com/article/378-bulk-attachment-for-woocommerce'); ?>" target="_blank"><?php esc_html_e( 'View Documentation', $plugin_txt_domain ); ?></a>
                    </div>
                </ul>
            <?php endif; ?>
        </div>
