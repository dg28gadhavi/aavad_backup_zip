...
?></div>
                        <div class="desc"><?php 
esc_html_e( 'Enhance your customer experience of product pages with downloadable files, such as technical descriptions, certificates, and licenses, user guides, and manuals, etc.', $plugin_text_domain );
?></div>
                    </div>
                </div>
...
?>">
                                        ...
                                        <strong><?php 
esc_html_e( 'Upgrade To Pro', $plugin_text_domain );
?></strong>
                                    </a>
                                </span>
                            </div>
...
?>"><?php 
esc_html_e( 'Bulk Attachment', $plugin_text_domain );
?></a></li>
