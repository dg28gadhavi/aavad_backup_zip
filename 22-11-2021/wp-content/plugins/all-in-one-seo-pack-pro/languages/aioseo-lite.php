...
$generated_i18n_strings = array(
	...
	// Reference: src/vue/pages/local-business-seo/blocks/LocationMap.js:114
	// Reference: src/vue/pages/local-business-seo/blocks/OpeningHours.js:136
	__( 'Loading...', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/local-business-seo/blocks/LocationMap.js:104
	// Reference: src/vue/pages/local-business-seo/blocks/OpeningHours.js:126
	...
	// Reference: src/vue/pages/local-business-seo/blocks/OpeningHours.js:146
	...
	// Reference: src/vue/pages/local-business-seo/blocks/OpeningHours.js:234
	...
	// Reference: src/vue/pages/local-business-seo/blocks/LocationMap.js:45
	/* Translators: 1 - AIOSEO. */
	...
	// Reference: src/vue/pages/local-business-seo/blocks/BusinessInfo.js:60
	...
	// Reference: src/vue/pages/local-business-seo/blocks/BusinessInfo.js:72
	__( 'Phone:', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/local-business-seo/blocks/BusinessInfo.js:76
	...
	// Reference: src/vue/pages/post-settings/views/Main.vue:58
	...
	// Reference: src/vue/pages/redirects/views/pro/Settings.vue:395
	...
	// Reference: src/vue/mixins/Image.js:11
	__( 'Default Image (Set Below)', 'all-in-one-seo-pack' ),

	// Reference: src/vue/mixins/Image.js:12
	__( 'Featured Image', 'all-in-one-seo-pack' ),

	// Reference: src/vue/mixins/Image.js:13
	__( 'Attached Image', 'all-in-one-seo-pack' ),

	// Reference: src/vue/mixins/Image.js:14
	...
	// Reference: src/vue/mixins/Image.js:75
	...
	// Reference: src/vue/mixins/TruSeoScore.js:40
	/* Translators: 1 - The amount of errors. */
	_n_noop( '%1$s Error', '%1$s Errors', 'all-in-one-seo-pack' ),
	...
	// Reference: src/vue/pages/search-appearance/views/GlobalSettings.vue:414
	...
	// Reference: src/vue/pages/post-settings/views/partialsGeneral/pageAnalysis.vue:32
	...
	// Reference: src/vue/pages/post-settings/views/Twitter.vue:210
	__( 'Twitter Preview', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/post-settings/views/Twitter.vue:211
	__( 'Use Data from Facebook Tab', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/post-settings/views/Twitter.vue:212
	...
	// Reference: src/vue/pages/local-business-seo/blocks/LocationMapSidebar.vue:99
	...
	// Reference: src/vue/pages/local-business-seo/blocks/LocationMapSidebar.vue:102
	...
	// Reference: src/vue/pages/post-settings/views/Twitter.vue:231
	__( 'Default (Set under Social Networks)', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/post-settings/views/Twitter.vue:232
	__( 'Summary', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/post-settings/views/Twitter.vue:233
	...
	// Reference: src/vue/pages/post-settings/views/Facebook.vue:235
	...
	// Reference: src/vue/pages/post-settings/views/Facebook.vue:261
	__( 'Default', 'all-in-one-seo-pack' ),
	...
	// Reference: src/vue/pages/redirects/views/pro/partials/ServerConfigReloadWarning.vue:27
	...
	// Reference: src/vue/pages/redirects/views/pro/partials/ServerConfigReloadWarning.vue:28
	__( 'If you don\'t know how to do that please revert your Redirect Method to PHP.', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/partials/ServerConfigReloadWarning.vue:29
	...
	// Reference: src/vue/pages/redirects/views/pro/RedirectsActivate.vue:116
	__( 'Type', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/RedirectsActivate.vue:121
	__( 'Group', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/RedirectsActivate.vue:143
	__( 'Filter by Group', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/RedirectsActivate.vue:145
	...
	// Reference: src/vue/pages/redirects/views/pro/RedirectsActivate.vue:85
	__( 'Site Aliases', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/RedirectsActivate.vue:86
	...
	// Reference: src/vue/pages/redirects/views/pro/RedirectsActivate.vue:103
	__( 'Source URL', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/AddRedirection.vue:232
	// Reference: src/vue/pages/redirects/views/pro/RedirectsActivate.vue:107
	__( 'Target URL', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/RedirectsActivate.vue:111
	...
	// Reference: src/vue/pages/redirects/views/pro/Settings.vue:377
	...
	// Reference: src/vue/pages/redirects/views/pro/Settings.vue:430
	...
	// Reference: src/vue/pages/setup-wizard/views/AdditionalInformation.vue:312
	__( 'Name', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/setup-wizard/views/AdditionalInformation.vue:313
	__( 'Organization Name', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/search-appearance/views/GlobalSettings.vue:423
	// Reference: src/vue/pages/setup-wizard/views/AdditionalInformation.vue:314
	...
	// Reference: src/vue/pages/redirects/views/pro/RedirectsActivate.vue:184
	...
	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:346
	__( 'Check Redirect', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:348
	__( 'Are you sure you want to delete this redirect?', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:349
	__( 'Are you sure you want to delete these redirects?', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:351
	__( 'Yes, I want to delete this redirect', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:352
	__( 'Yes, I want to delete these redirects', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:354
	...
	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:357
	__( 'Check redirect for', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:360
	__( 'Response Code', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:363
	__( 'Redirected By', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:364
	__( 'Custom URL', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:365
	__( 'Test Redirect', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:366
	__( 'Woohoo! Your redirect worked perfectly!', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:367
	__( 'Whoops! Your URL failed to redirect properly.', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:368
	__( 'Expected', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:369
	__( 'Result', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:371
	...
	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:374
	__( 'Enable', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:375
	__( 'Disable', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:376
	__( 'Reset Hits', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/redirects/views/pro/Redirects.vue:656
	...
	// Reference: src/vue/pages/local-business-seo/blocks/OpeningHoursSidebar.vue:95
	...
	// Reference: src/vue/pages/local-business-seo/blocks/OpeningHoursSidebar.vue:96
	...
	// Reference: src/vue/pages/local-business-seo/blocks/OpeningHoursSidebar.vue:97
	...
	// Reference: src/vue/pages/local-business-seo/blocks/OpeningHoursSidebar.vue:98
	...
	// Reference: src/vue/components/common/core/SocialProfiles.vue:126
	...
	// Reference: src/vue/components/common/core/SocialProfiles.vue:148
	...
	// Reference: src/vue/pages/search-appearance/views/GlobalSettings.vue:410
	...
	// Reference: src/vue/pages/posts-table/TermApp.vue:113
	__( 'Title:', 'all-in-one-seo-pack' ),
	...
	// Reference: src/vue/components/common/core/AddRedirection.vue:423
	__( 'A redirect already exists for this source URL. To make changes, edit the original instead.', 'all-in-one-seo-pack' ),

	// Reference: src/vue/components/common/core/AddRedirection.vue:465
	...
	// Reference: src/vue/components/common/core/AddRedirection.vue:480
	...
	// Reference: src/vue/store/actions.js:168
	...
	// Reference: src/vue/pages/social-networks/views/Facebook.vue:669
	...
	// Reference: src/vue/pages/social-networks/views/Twitter.vue:430
	__( 'Default Post Image Source', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/social-networks/views/Twitter.vue:431
	...
	// Reference: src/vue/pages/social-networks/views/Twitter.vue:423
	...
	// Reference: src/vue/pages/social-networks/views/Twitter.vue:426
	__( 'Enable Twitter Card', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/social-networks/views/Twitter.vue:427
	...
	// Reference: src/vue/plugins/truSEO/analysis/sentenceLength.js:51
	__( 'Sentence length is looking great!', 'all-in-one-seo-pack' ),

	// Reference: src/vue/plugins/truSEO/analysis/sentenceLength.js:59
	__( 'Sentences Length', 'all-in-one-seo-pack' ),

	// Reference: src/vue/plugins/truSEO/analysis/sentenceLength.js:61
	...
	// Reference: src/vue/pages/search-appearance/views/GlobalSettings.vue:406
	__( 'Title Separator', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/search-appearance/views/GlobalSettings.vue:407
	__( 'Separator Character', 'all-in-one-seo-pack' ),

	// Reference: src/vue/pages/search-appearance/views/GlobalSettings.vue:409
	/* Translators: 1 - Opening HTML link tag, 2 - Closing HTML link tag. */
	...
	// Reference: src/vue/pages/search-appearance/views/GlobalSettings.vue:411
